...
<!-- Mirrored from themesflat.co/html/proty/faq by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:14:29 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
    <!--[if IE ]><meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/><![endif]-->
    <title>FAQ - Randhawa Marketing</title>
    ...
    <!-- Font Awesome Icons -->
    <link rel="stylesheet" type="text/css" href="{{ url('assets-admin/fonts/webfonts/fa-solid-900.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ url('assets-admin/fonts/webfonts/fa-regular-400.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ url('assets-admin/fonts/webfonts/fa-brands-400.css') }}" />
                        ...
                        <div class="col-xl-8 col-lg-7">
                            ...
                            <div class="tf-faq mb-49">
                                <ul class="box-faq" id="wrapper-faq">
                                    <li class="faq-item">
                                        <a href="#accordion-faq-1" class="faq-header h6 collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accordion-faq-1">
                                            Who is Randhawa Marketing (Pvt) Ltd? <i class="icon-CaretDown"></i>
                                        </a>
                                        <div id="accordion-faq-1" class="collapse" data-bs-parent="#wrapper-faq">
                                            <p class="faq-body">Randhawa Marketing (Pvt)Ltd is an Islamabad-based real estate company helping buyers, sellers, and investors with property deals.</p>
                                        </div>
                                    </li>
                                    <li class="faq-item">
                                        <a href="#accordion-faq-2" class="faq-header h6 collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accordion-faq-2">
                                            Since when has Randhawa Marketing (Pvt)Ltd been working? <i class="icon-CaretDown"></i>
                                        </a>
                                        <div id="accordion-faq-2" class="collapse" data-bs-parent="#wrapper-faq">
                                            <p class="faq-body">Randhawa Marketing (Pvt)Ltd has been operating since 2007.</p>
                                        </div>
                                    </li>
                                    <li class="faq-item">
                                        <a href="#accordion-faq-3" class="faq-header h6 collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accordion-faq-3">
                                            What are the office locations of Randhawa Marketing (Pvt)Ltd and the areas they serve? <i class="icon-CaretDown"></i>
                                        </a>
                                        <div id="accordion-faq-3" class="collapse" data-bs-parent="#wrapper-faq">
                                            <p class="faq-body">Randhawa Marketing’s head office is in I 8 Markaz, Islamabad, with a second office in Multan, and they offer services in all major cities.</p>
                                        </div>
                                    </li>
                                    <li class="faq-item">
                                        <a href="#accordion-faq-4" class="faq-header h6 collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accordion-faq-4">
                                            What services does Randhawa Marketing (Pvt)Ltd offer? <i class="icon-CaretDown"></i>
                                        </a>
                                        <div id="accordion-faq-4" class="collapse" data-bs-parent="#wrapper-faq">
                                            <p class="faq-body">They assist with buying, selling, renting, investment advice, and legal support.</p>
                                        </div>
                                    </li>
                                    <li class="faq-item">
                                        <a href="#accordion-faq-5" class="faq-header h6 collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accordion-faq-5">
                                            Do they handle both local and overseas clients? <i class="icon-CaretDown"></i>
                                        </a>
                                        <div id="accordion-faq-5" class="collapse" data-bs-parent="#wrapper-faq">
                                            <p class="faq-body">Yes, they serve both local and overseas clients, helping them invest safely from abroad.</p>
                                        </div>
                                    </li>
                                    <li class="faq-item">
                                        <a href="#accordion-faq-6" class="faq-header h6 collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accordion-faq-6">
                                            Which housing societies does Randhawa Marketing (Pvt)Ltd deal in? <i class="icon-CaretDown"></i>
                                        </a>
                                        <div id="accordion-faq-6" class="collapse" data-bs-parent="#wrapper-faq">
                                            <p class="faq-body">They deal only in legal CDA-approved societies.</p>
                                        </div>
                                    </li>
                                    <li class="faq-item">
                                        <a href="#accordion-faq-7" class="faq-header h6 collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accordion-faq-7">
                                            Does Randhawa Marketing (Pvt)Ltd work with approved or unapproved societies? <i class="icon-CaretDown"></i>
                                        </a>
                                        <div id="accordion-faq-7" class="collapse" data-bs-parent="#wrapper-faq">
                                            <p class="faq-body">They work only with approved societies.</p>
                                        </div>
                                    </li>
                                    <li class="faq-item">
                                        <a href="#accordion-faq-8" class="faq-header h6 collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accordion-faq-8">
                                            Do they deal in vertical and high-rise properties? <i class="icon-CaretDown"></i>
                                        </a>
                                        <div id="accordion-faq-8" class="collapse" data-bs-parent="#wrapper-faq">
                                            <p class="faq-body">Yes, they handle both vertical and high-rise developments.</p>
                                        </div>
                                    </li>
                                    <li class="faq-item">
                                        <a href="#accordion-faq-9" class="faq-header h6 collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accordion-faq-9">
                                            What types of properties does Randhawa Marketing (Pvt)Ltd sell? <i class="icon-CaretDown"></i>
                                        </a>
                                        <div id="accordion-faq-9" class="collapse" data-bs-parent="#wrapper-faq">
                                            <p class="faq-body">You can buy homes, apartments, high-rises, plazas, shops, offices, warehouses, factories, or plots of land.</p>
                                        </div>
                                    </li>
                                    <li class="faq-item">
                                        <a href="#accordion-faq-10" class="faq-header h6 collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accordion-faq-10">
                                            Do Randhawa Marketing (Pvt)Ltd projects include both residential and commercial properties? <i class="icon-CaretDown"></i>
                                        </a>
                                        <div id="accordion-faq-10" class="collapse" data-bs-parent="#wrapper-faq">
                                            <p class="faq-body">Yes, their projects offer a mix of residential apartments and commercial spaces.</p>
                                        </div>
                                    </li>
                                    <li class="faq-item">
                                        <a href="#accordion-faq-11" class="faq-header h6 collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accordion-faq-11">
                                            What projects does Randhawa Marketing (Pvt) Ltd promote? <i class="icon-CaretDown"></i>
                                        </a>
                                        <div id="accordion-faq-11" class="collapse" data-bs-parent="#wrapper-faq">
                                            <p class="faq-body">They promote projects like Randhawa Heights in Bahria Enclave Islamabad, Randhawa Heights 02 in Multan offering apartments, shops, and commercial spaces.</p>
                                        </div>
                                    </li>
                                    <li class="faq-item">
                                        <a href="#accordion-faq-12" class="faq-header h6 collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accordion-faq-12">
                                            What makes Randhawa Marketing (Pvt)Ltd different? <i class="icon-CaretDown"></i>
                                        </a>
                                        <div id="accordion-faq-12" class="collapse" data-bs-parent="#wrapper-faq">
                                            <p class="faq-body">They stand out for transparent deals, proper legal documentation, and a client-focused approach.</p>
                                        </div>
                                    </li>
                                    <li class="faq-item">
                                        <a href="#accordion-faq-13" class="faq-header h6 collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accordion-faq-13">
                                            Does Randhawa Marketing (Pvt)Ltd have its own projects? <i class="icon-CaretDown"></i>
                                        </a>
                                        <div id="accordion-faq-13" class="collapse" data-bs-parent="#wrapper-faq">
                                            <div class="faq-body">
                                                <ul class="list-disc pl-4">
                                                    <li>Randhawa Heights Bahria Enclave Islamabad</li>
                                                    <li>Housing project on installment Faisal Hill</li>
                                                    <li>Farm houses project in Islamabad</li>
                                                    <li>Randhawa heights - 2 Multan</li>
                                                    <li>Randhawa Mart</li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <li class="faq-item">
                                        <a href="#accordion-faq-14" class="faq-header h6 collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accordion-faq-14">
                                            Is Randhawa Marketing (Pvt)Ltd also a construction company? <i class="icon-CaretDown"></i>
                                        </a>
                                        <div id="accordion-faq-14" class="collapse" data-bs-parent="#wrapper-faq">
                                            <p class="faq-body">Yes, they are involved in developing and constructing their own real estate projects.</p>
                                        </div>
                                    </li>
                                    <li class="faq-item">
                                        <a href="#accordion-faq-15" class="faq-header h6 collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accordion-faq-15">
                                            Is it possible to invest with Randhawa Marketing (Pvt)Ltd? <i class="icon-CaretDown"></i>
                                        </a>
                                        <div id="accordion-faq-15" class="collapse" data-bs-parent="#wrapper-faq">
                                            <p class="faq-body">Yes, you can invest in their projects and developments with proper guidance and payment plans.</p>
                                        </div>
                                    </li>
                                    <li class="faq-item">
                                        <a href="#accordion-faq-16" class="faq-header h6 collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accordion-faq-16">
                                            Are Randhawa Marketing (Pvt)Ltd projects suitable for long-term investment? <i class="icon-CaretDown"></i>
                                        </a>
                                        <div id="accordion-faq-16" class="collapse" data-bs-parent="#wrapper-faq">
                                            <p class="faq-body">Yes, their projects are designed for long-term growth and stable returns.</p>
                                        </div>
                                    </li>
                                    <li class="faq-item">
                                        <a href="#accordion-faq-17" class="faq-header h6 collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accordion-faq-17">
                                            Do you offer a down payment option? <i class="icon-CaretDown"></i>
                                        </a>
                                        <div id="accordion-faq-17" class="collapse" data-bs-parent="#wrapper-faq">
                                            <p class="faq-body">Yes, flexible down payment options are available to make buying property easier.</p>
                                        </div>
                                    </li>
                                    <li class="faq-item">
                                        <a href="#accordion-faq-18" class="faq-header h6 collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accordion-faq-18">
                                            What does the Randhawa Marketing (Pvt)Ltd team consist of? <i class="icon-CaretDown"></i>
                                        </a>
                                        <div id="accordion-faq-18" class="collapse" data-bs-parent="#wrapper-faq">
                                            <p class="faq-body">The team consists of experienced real estate professionals, sales experts, and client support specialists.</p>
                                        </div>
                                    </li>
                                    <li class="faq-item">
                                        <a href="#accordion-faq-19" class="faq-header h6 collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accordion-faq-19">
                                            Does Randhawa Marketing (Pvt)Ltd have job vacancies? <i class="icon-CaretDown"></i>
                                        </a>
                                        <div id="accordion-faq-19" class="collapse" data-bs-parent="#wrapper-faq">
                                            <p class="faq-body">Yes, they offer vacancies in sales, marketing, operations, and client support.</p>
                                        </div>
                                    </li>
                                    <li class="faq-item">
                                        <a href="#accordion-faq-20" class="faq-header h6 collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accordion-faq-20">
                                            Does Randhawa Marketing (Pvt)Ltd offer online facilities? <i class="icon-CaretDown"></i>
                                        </a>
                                        <div id="accordion-faq-20" class="collapse" data-bs-parent="#wrapper-faq">
                                            <p class="faq-body">Yes, they provide online services for property listings, inquiries, and client support.</p>
                                        </div>
                                    </li>
                                    <li class="faq-item">
                                        <a href="#accordion-faq-21" class="faq-header h6 collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accordion-faq-21">
                                            Does Randhawa Marketing (Pvt) Ltd offer rental management services? <i class="icon-CaretDown"></i>
                                        </a>
                                        <div id="accordion-faq-21" class="collapse" data-bs-parent="#wrapper-faq">
                                            <p class="faq-body">Yes, they provide rental management and tenant support for their properties.</p>
                                        </div>
                                    </li>
                                    <li class="faq-item">
                                        <a href="#accordion-faq-22" class="faq-header h6 collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accordion-faq-22">
                                            What is the mission of Randhawa Marketing (Pvt) Ltd? <i class="icon-CaretDown"></i>
                                        </a>
                                        <div id="accordion-faq-22" class="collapse" data-bs-parent="#wrapper-faq">
                                            <p class="faq-body">To provide transparent, trustworthy, and client-focused real estate services.</p>
                                        </div>
                                    </li>
                                    <li class="faq-item">
                                        <a href="#accordion-faq-23" class="faq-header h6 collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="accordion-faq-23">
                                            How can I contact Randhawa Marketing (Pvt)Ltd for inquiries? <i class="icon-CaretDown"></i>
                                        </a>
                                        <div id="accordion-faq-23" class="collapse" data-bs-parent="#wrapper-faq">
                                            <p class="faq-body">You can contact them via phone, email, or by visiting their offices in Islamabad or Multan.</p>
                                        </div>
                                    </li>
                                </ul>

                                <div class="mt-49 faq-contact-block">
                                    <h4 class="h6 mb-24">Contact Us</h4>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="contact-card h-100">
                                                ...
                                                <div class="card-content">
                                                    <h5 class="title mb-1">Call Us Today</h5>
                                                    <a href="tel:03331929762" class="contact-link">0333-1929762</a>
                                                    <div class="sub-text small mt-1">Available 9 AM - 6 PM</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="contact-card h-100">
                                                ...
                                                <div class="card-content">
                                                    <h5 class="title mb-1">Email Us</h5>
                                                    <a href="mailto:info@randhawamarketing.com" class="contact-link">info@randhawamarketing.com</a>
                                                    <div class="sub-text small mt-1">We reply within 24 hours</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="faq-body p-4 bg-light rounded-3">
                                        <p>Reach out to Randhawa Marketing for all your real estate needs. Call us, email us, or fill out our website form to get in touch. Our team is ready to provide guidance on buying, selling, renting, property management, or investment opportunities, and we respond quickly to ensure you get clear, personalized support every time. We are committed to making your property journey smooth, transparent, and stress-free. Whether you have questions, need advice, or want to schedule a consultation, we are here to help.</p>
                                    </div>
                                </div>

                                <style>
                                    .faq-contact-block .contact-card {
                                        display: flex;
                                        align-items: center;
                                        gap: 16px;
                                    ...
                                    .faq-contact-block .contact-card .icon {
                                        width: 44px;
                                        height: 44px;
                                    ...
                                    .faq-contact-block .contact-card .title {
                                        color: var(--heading-color);
                                        font-weight: 600;
                                    }
                                    .faq-contact-block .contact-link {
                                        color: var(--heading-color);
                                        font-weight: 600;
                                        text-decoration: none;
                                    }
                                    .faq-contact-block .contact-link:hover {
                                        color: var(--primary-color);
                                        text-decoration: underline;
                                    }
                                    .faq-contact-block .sub-text {
                            ...
                            <div class=" tf-sidebar sticky-sidebar ">
                                    ...
                                    <div class="seller-info">
                                        ...
                                        <div class="content">
                                            ...
                                            <ul class="contact">
                                                ...
                                                <li><i class="icon-mail"></i><a href="#">info@randhawamarketing.com</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class=" sidebar-ads">
                                    ...
                                    <div class="logo relative z-5">
                                        <img src="{{ url('images/logo/logo-2@2x.png') }}" alt="">
                                    </div>
                    ...
                    <div class="row ">
                        <div class="col-12 ">
                            <div class="relative">
                                ...
                                <div class="image-wrap">
                                    <img class="lazyload" data-src="{{ url('images/section/section-contact.jpg') }}"
                                        src="{{ url('images/section/section-contact.jpg') }}" alt="">
                                </div>
                    ...
                    <li class="menu-item menu-item-has-children-mobile current-menu-item">
                        ...
                        <div id="dropdown-menu-four" class="collapse" data-bs-parent="#menu-mobile-menu">
                            <ul class="sub-mobile">
                                ...
                                <li class="menu-item current-item"><a href="faq">Faq's</a></li>
