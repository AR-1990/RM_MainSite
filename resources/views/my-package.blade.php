...
<!-- Mirrored from themesflat.co/html/proty/my-package by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:14:42 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
                            ...
                            <a class="nav-menu-link" href="index">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                    ...
                                    <path d="M13.332 14.1667L17.4987 10L13.332 5.83337" stroke="#A8ABAE"
                                        stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M17.5 10H7.5" stroke="#A8ABAE" stroke-width="1.4" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                </svg>
                                Logout
                            </a>
                        ...
                        <div class="flat-pricing">
                            <div class="box box-style">
                                ...
                                <div class="button-pricing">
                                    <a class="tf-btn bg-color-primary pd-20" href="pricing">
                                        <span>Upgrade</span>
                                    </a>
                                </div>
                            </div>
...
<!-- Mirrored from themesflat.co/html/proty/my-package by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:14:44 GMT -->
</html>