...
<!-- Mirrored from themesflat.co/html/proty/home02 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:13:21 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('css/odometer.min.css') }}" />
...
<body class="counter-scroll theme-color-1">
    <!-- wrapper -->
    <div id="wrapper">
            ...
            <div id="loading-center">
                <div class="loader-container">
                    <div class="wrap-loader">
                        ...
                        <div class="icon">
                            <img src="{{ url('images/logo/loading-2.png') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- .header -->
        <header id="header-main" class="header style-2  header-fixed">
                            ...
                            <div class="header-inner-wrap">
                                <div class="header-logo">
                                    <a href="index" class="site-logo">
                                        <img class="img-default" alt="" src="{{ url('images/logo/logo-3%402x.png') }}">
                                        <img class="img-is-fixed" alt="" src="{{ url('images/logo/logo-3.1%402x.png') }}">
                                    </a>
                                </div>
                                <nav class="main-menu">
                                    <ul class="navigation ">
                                        <li class="has-child current-menu "><a href="#">Home</a>
                                            <ul class="submenu">
                                                ...
                                                <li class="current-item "><a href="home02">Home Page 02</a></li>
                                        ...
                                        <li class="has-child style-2"><a href="#">Listing</a>
                                            <ul class="submenu">
                                                <li>
                                                    ...
                                                    <ul class="submenu2">
                                                        <li>
                                                            <a href="property-grid-full-width">Grid Style -
                                                                Full Width </a>
                                                        </li>
                                                        <li>
                                                        ...
                                                        <li>
                                                            <a href="property-gird-left-sidebar">Grid Style -
                                                                Sidebar Left </a>
                                                        </li>
                                                        <li>
                                                            <a href="property-gird-right-sidebar">Grid Style -
                                                                Sidebar Right </a>
                                                        </li>
                                                        <li>
                                                            <a href="property-list-full-width">List Style -
                                                                Full
                                                                Width </a>
                                                        </li>
                                                        <li>
                                                        ...
                                                        <li>
                                                            <a href="property-list-left-sidebar">List Style -
                                                                Sidebar
                                                                Left </a>
                                                        </li>
                                                        <li>
                                                            <a href="property-list-right-sidebar">List Style -
                                                                Sidebar
                                                                Right </a>
                                                        </li>
                                                    </ul>
                                                ...
                                                <li>
                                                    ...
                                                    <ul class="submenu2">
                                                        <li>
                                                            <a href="property-half-map-grid">Property Half Map Grid
                                                            </a>
                                                        <li>
                                                            <a href="property-half-map-list">Property Half Map List
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="property-half-top-map">Property Half Map Top
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="property-filter-popup">Property Filter Popup
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="property-filter-popup-left">Property Filter
                                                                Popup Left </a>
                                                        </li>
                                                        <li>
                                                            <a href="property-filter-popup-right">Property Filter
                                                                Popup Right </a>
                                                        </li>
                                                ...
                                                <li>
                                                    ...
                                                    <ul class="submenu2">
                                                        ...
                                                        <li><a href="property-detail-v3">Property Details 3</a>
                                                        </li>
                                                        <li><a href="property-detail-v4">Property Details 4</a>
                                                        </li>
                                                        <li><a href="property-detail-v5">Property Details 5</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
                                            ...
                                            <ul class="submenu">
                                                <li class="has-child"><a href="#">Agents</a>
                                                    <ul class="submenu">
                                                        ...
                                                        <li>
                                                            <a href="agents-details">Agents Details</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li class="has-child"><a href="#">Agencies</a>
                                                    <ul class="submenu">
                                                        <li><a href="agency-grid">Agencies
                                                                Grid</a></li>
                                                        <li><a href="agency-list">Agencies
                                                                List</a></li>
                                                        <li><a href="agency-details">Agencies
                                                                Detail</a></li>
                                                    </ul>
                                                </li>
                                                <li><a href="home-loan-process">Home Loan Process</a></li>
                                ...
                                <div class="header-right">
                                    ...
                                    <div class="box-user tf-action-btns">
                                        ...
                                        <div class=" menu-user">
                                            ...
                                            <a class="dropdown-item" href="my-profile">
                                                ...
                                                My profile</a>
                                            <a class="dropdown-item" href="my-package">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                ...
                                                My package</a>
                                            <a class="dropdown-item" href="my-favorites">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                ...
                                                My favorites (1)</a>
                                            <a class="dropdown-item" href="my-save-search">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                            ...
                                            <a class="dropdown-item" href="review">
                                                ...
                                                Reviews</a>
                                            <a class="dropdown-item" href="my-property">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                            ...
                                            <a class="dropdown-item " href="add-property">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                    ...
                                    <div class="btn-add">
                                        <a class="tf-btn style-border pd-23" href="add-property">Add property</a>
                                    </div>
        ...
        <div class="main-content">
                        ...
                        <div class="col-12">
                            <div class="heading-section text-center mb-48">
                                ...
                                <p class="text-1 wow animate__fadeInUp animate__animated" data-wow-duration="1.5s"
                                    data-wow-delay="0s">Thousands of luxury home enthusiasts just like you visit our
                                    website.
                                </p>
                            </div>
                            <div class="swiper style-pagination tf-sw-mobile-1" data-screen="576" data-preview="1"
                                data-space="15">
                                <div class="swiper-wrapper tf-layout-mobile-sm sm-col-2  xl-col-4 lg-col-3">
                                    <div class="swiper-slide">
                                        <a href="#" class="categories-item style-2">
                                            <div class="icon-box">
                                                <i class="icon icon-apartment1">
                                                </i>
                                            </div>
                                            <div class="content ">
                                                <h5 class="mb-10">Apartment</h5>
                                                <p><svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#5C5E61" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path
                                                            d="M10.5 1.5V4.5C10.5 4.89782 10.658 5.27936 10.9393 5.56066C11.2206 5.84196 11.6022 6 12 6H15"
                                                            stroke="#5C5E61" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path d="M7.5 6.75H6" stroke="#5C5E61" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path d="M12 9.75H6" stroke="#5C5E61" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path d="M12 12.75H6" stroke="#5C5E61" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                    </svg>
                                                    476 listings for sale
                                                </p>
                                            </div>
                                        </a>
                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <a href="#" class="categories-item style-2">
                                            <div class="icon-box">
                                                <i class="icon icon-commercial-line">
                                                </i>
                                            </div>
                                            <div class="content ">
                                                <h5 class="mb-10">Commercial</h5>
                                                <p><svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                            d="M11.25 1.5H4.5C4.10218 1.5 3.72064 1.65804 3.43934 1.93934C3.15804 2.22064 3 2.60218 3 3V15C3 15.3978 3.15804 15.7794 3.43934 16.0607C3.72064 16.342 4.10218 16.5 4.5 16.5H13.5C13.8978 16.5 14.2794 16.342 14.5607 16.0607C14.842 15.7794 15 15.3978 15 15V5.25L11.25 1.5Z"
                                    ...
                                    <div class="swiper-slide">
                                        <a href="#" class="categories-item style-2">
                                            <div class="icon-box">
                                                <i class="icon icon-penhouse">
                                                </i>
                                            </div>
                                            <div class="content ">
                                                <h5 class="mb-10">Penthouse</h5>
                                                <p><svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                            d="M11.25 1.5H4.5C4.10218 1.5 3.72064 1.65804 3.43934 1.93934C3.15804 2.22064 3 2.60218 3 3V15C3 15.3978 3.15804 15.7794 3.43934 16.0607C3.72064 16.342 4.10218 16.5 4.5 16.5H13.5C13.8978 16.5 14.2794 16.342 14.5607 16.0607C14.842 15.7794 15 15.3978 15 15V5.25L11.25 1.5Z"
            ...
            <!-- .section-trusted -->
            <section class="section-trusted  tf-spacing-1">
                <div class="tf-container">
                    <div class="row relative">
                        <div class="col-xl-6">
                            <div class="content relative z-5">
                                <div class="heading-section mb-48">
                                    <h2 class="title text-anime-wave">Trusted By <span>100</span> Million Buyers</h2>
                                    <p class="text-1 wow animate__fadeInUp animate__animated" data-wow-duration="1.5s"
                                        data-wow-delay="0s">We connect you directly to the person that knows
                                        the most about a
                                        property for sale, the listing agent
                                    </p>
                                </div>
                                <div class="tf-grid-layout sm-col-2">
                                    <div class="icons-box style-1 effec-icon ">
                                        <div class="heading">
                                            <div class="tf-icon ">
                                                <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="M7.10223 29.5784C6.92637 29.4883 6.72196 29.4716 6.53381 29.532C6.34567 29.5923 6.18914 29.7249 6.09856 29.9005C6.03123 30.0315 6.00428 30.1797 6.02111 30.3261C6.03795 30.4725 6.09781 30.6106 6.19313 30.723C6.28845 30.8354 6.41495 30.917 6.55664 30.9575C6.69833 30.998 6.84884 30.9955 6.98915 30.9505C7.12945 30.9055 7.25326 30.8198 7.3449 30.7044C7.43655 30.589 7.49193 30.4491 7.50403 30.3022C7.51613 30.1553 7.48442 30.0082 7.4129 29.8793C7.34138 29.7505 7.23327 29.6458 7.10223 29.5784ZM9.00184 30.802C8.8615 30.8471 8.73768 30.9328 8.64603 31.0482C8.55438 31.1637 8.49901 31.3037 8.48691 31.4506C8.47482 31.5975 8.50655 31.7447 8.57809 31.8736C8.64963 32.0025 8.75777 32.1072 8.88884 32.1747C9.01992 32.2421 9.16804 32.2691 9.31449 32.2524C9.46093 32.2357 9.59914 32.1759 9.71162 32.0807C9.82411 31.9854 9.90583 31.8589 9.94646 31.7172C
.0344 32.3568C10.9968 32.4301 10.974 32.5102 10.9674 32.5924C10.9608 32.6746 10.9705 32.7573 10.9961 32.8357C11.0216 32.9142 11.0624 32.9867 11.1161 33.0493C11.1698 33.1119 11.2353 33.1633 11.309 33.2004L19.5437 37.4309C19.6314 37.4753 19.7282 37.4987 19.8265 37.4992C19.9248 37.4996 20.0218 37.4771 20.1098 37.4334L35.4784 29.7135C35.582 29.6615 35.669 29.5818 35.7299 29.4831C35.7907 29.3845 35.8229 29.2709 35.8229 29.1551V24.7223C35.8223 24.5994 35.7857 24.4794 35.7177 24.377C35.6497 24.2747 35.5533 24.1944 35.4403 24.1461ZM19.8325 31.7412L16.28 29.9162L20.0151 27.9973L23.6019 29.8478L19.8325 31.7412ZM11.3329 27.3747L15.0784 25.4505L18.6503 27.2933L14.9123 29.2136L11.3329 27.3747ZM24.4697 20.6258L28.3033 22.3341L24.9524 24.0557L21.3729 22.2167L24.4697 20.6258ZM20.0052 22.9194L23.5847 24.7583L20.0163 26.5915L16.4444 24.7487L20.0052 22.9194ZM24.9832 29.154L21.3811 27.2956L24.9524 25.4609L28.6022 27.3359L24.9832 29.154ZM29.9853 26.6412L26.3201 24.7583L29.7681 22.987L33.7383 24.7561L29.9853 26.6412ZM18.6376 22.2168L15.0797 24.0446L11.6594 22.2801L15.4201 20.5639L18.6376 22.2168ZM10.2128 22.9402L13.7136 24.7463L9.96514 26.6721L6.23467 24.7556L10.2128 22.9402ZM20.4543 35.8616V32.8277L34.5729 25.7357V28.7695L20.4543 35.8616ZM20.0001 11.5539C20.5161 11.5539 21.0205 11.4009 21.4496 11.1142C21.8786 10.8275 22.2131 10.42 22.4105 9.94327C22.608 9.46652 22.6597 8.94192 22.559 8.43581C22.4583 7.9297 22.2098 7.46481 21.8449 7.09993C21.48 6.73505 21.0151 6.48656 20.509 6.3859C20.0029 6.28524 19.4783 6.33692 19.0016 6.5344C18.5248 6.73189 18.1173 7.06631 17.8307 7.49538C17.544 7.92445 17.391 8.42889 17.391 8.94492C17.3918 9.63663 17.6669 10.2998 18.1561 10.7889C18.6452 11.278 19.3083 11.5531 20.0001 11.5539ZM20.0001 7.58586C20.2689 7.58586 20.5316 7.66556 20.7551 7.8149C20.9786 7.96424 21.1528 8.17649 21.2557 8.42483C21.3585 8.67316 21.3854 8.94643 21.333 9.21006C21.2806 9.47369 21.1511 9.71585 20.9611 9.90592C20.771 10.096 20.5288 10.2254 20.2652 10.2779C20.0016 10.3303 19.7283 10.3034 19.48 10.2005C19.2316 10.0977 19.0194 9.92347 18.87 9.69997C18.7207 9.47648 18.641 9.21372 18.641 8.94492C18.6414 8.58459 18.7847 8.23914 19.0395 7.98435C19.2943 7.72956 19.6397 7.58625 20.0001 7.58586Z"
                                                        fill="#06A788" />
                                                </svg>
                                        ...
                                        <p class=" text-1">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut
                                            sollicitudin
                                            ipsum eu massa</p>
                                        <a href="#" class="tf-btn-link color-1">
                                            <span>
                                                Learn More
                                            </span>
                                        </a>
                                        ...
                                        <div class="heading">
                                            <div class="tf-icon ">
                                                <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    
                                                        fill="#06A788" />
                                                </svg>
                                            </div>
                                    ...
                                    <div class="icons-box style-1 effec-icon ">
                                        <div class="heading">
                                            <div class="tf-icon ">
                                                <svg class="stroke" width="40" height="40" viewBox="0 0 40 40"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <mask id="mask0_2303_3339" style="mask-type:luminance"
                                                        maskUnits="userSpaceOnUse" x="3" y="4" width="34" height="33">
                                                        <path d="M35.4501 35.4502V4.54993H4.54976V35.4502H35.4501Z"
                                                            fill="white" stroke="white" stroke-width="1.1" />
                                                    </mask>
                                                    <g mask="url(#mask0_2303_3339)">
                                                        <path d="M19.999 5.03118V11.5561" stroke="#06A788"
                                                            stroke-width="1.1" stroke-miterlimit="10"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path
                                                            d="M17.1732 32.8914H22.8248V26.8323C22.8247 26.7445 22.7897 26.6604 22.7276 26.5983C22.6655 26.5362 22.5813 26.5013 22.4935 26.5011H17.5063C17.3238 26.5011 17.1732 26.6499 17.1732 26.8323V32.8914Z"
                                                            stroke="#06A788" stroke-width="1.1" stroke-miterlimit="10"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path d="M19.999 26.5011V32.8914" stroke="#06A788"
                                                            stroke-width="1.1" stroke-miterlimit="10"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path d="M21.0443 19.9815H19.999V18.2476" stroke="#06A788"
                                                            stroke-width="1.1" stroke-miterlimit="10"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path
                                                            d="M7.63992 21.3187H11.9717C12.094 21.3187 12.1949 21.4197 12.1949 21.5419V23.6991C12.1949 23.8214 12.094 23.9223 11.9717 23.9223H7.63992C7.51592 23.9223 7.41492 23.8214 7.41492 23.6991V21.5419C7.41492 21.4197 7.51592 21.3187 7.63992 21.3187Z"
                                                            stroke="#06A788" stroke-width="1.1" stroke-miterlimit="10"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path d="M9.80481 21.3187V23.9223" stroke="#06A788"
                                                            stroke-width="1.1" stroke-miterlimit="10"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path
                                                            d="M7.63992 26.0051H11.9717C12.094 26.0051 12.1949 26.1061 12.1949 26.2301V28.3855C12.1949 28.5095 12.094 28.6105 11.9717 28.6105H7.63992C7.58027 28.6105 7.52309 28.5867 7.48091 28.5445C7.43873 28.5024 7.415 28.4452 7.41492 28.3855V26.2301C7.41502 26.1704 7.43876 26.1133 7.48093 26.0711C7.52311 26.0289 7.58028 26.0052 7.63992 26.0051Z"
                                                            stroke="#06A788" stroke-width="1.1" stroke-miterlimit="10"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path d="M9.80481 26.0051V28.6105" stroke="#06A788"
                                                            stroke-width="1.1" stroke-miterlimit="10"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path
                                                            d="M32.3601 21.3187H28.0283C27.9043 21.3187 27.8033 21.4197 27.8033 21.5419V23.6991C27.8033 23.8214 27.9043 23.9223 28.0283 23.9223H32.3601C32.4823 23.9223 32.5833 23.8214 32.5833 23.6991V21.5419C32.5833 21.4197 32.4823 21.3187 32.3601 21.3187Z"
                                                            stroke="#06A788" stroke-width="1.1" stroke-miterlimit="10"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path d="M30.1932 21.3187V23.9223" stroke="#06A788"
                                                            stroke-width="1.1" stroke-miterlimit="10"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path
                                                            d="M32.3601 26.0051H28.0283C27.9687 26.0052 27.9115 26.0289 27.8693 26.0711C27.8272 26.1133 27.8034 26.1704 27.8033 26.2301V28.3855C27.8033 28.5095 27.9043 28.6105 28.0283 28.6105H32.3601C32.4823 28.6105 32.5833 28.5095 32.5833 28.3855V26.2301C32.5833 26.1061 32.4823 26.0051 32.3601 26.0051Z"
                                                            stroke="#06A788" stroke-width="1.1" stroke-miterlimit="10"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path d="M30.1932 26.0051V28.6105" stroke="#06A788"
                                                            stroke-width="1.1" stroke-miterlimit="10"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path
                                                            d="M19.9991 22.9908C21.9001 22.9908 23.4504 21.4322 23.4504 19.5228C23.4504 17.6135 21.9001 16.0549 19.9991 16.0549C18.0981 16.0549 16.5479 17.6135 16.5479 19.5228C16.5479 21.4322 18.0981 22.9908 19.9991 22.9908Z"
                                                            stroke="#06A788" stroke-width="1.1" stroke-miterlimit="10"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path
                                                            d="M19.999 5.78041H24.1838C24.391 5.78041 24.5611 5.95047 24.5611 6.15941V8.86044C24.5611 9.06944 24.391 9.2395 24.1838 9.2395H19.999V5.78041Z"
                                                            stroke="#06A788" stroke-width="1.1" stroke-miterlimit="10"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path
                                                            d="M14.1383 18.2476H4.62795C4.53938 18.2476 4.46851 18.1749 4.46851 18.0864V16.441C4.46851 16.3524 4.53938 16.2798 4.62795 16.2798H14.1383V18.2476Z"
                                                            stroke="#06A788" stroke-width="1.1" stroke-miterlimit="10"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path
                                                            d="M25.8615 18.2476H35.3701C35.4128 18.2474 35.4537 18.2304 35.4839 18.2002C35.5141 18.17 35.5311 18.1291 35.5313 18.0864V16.441C35.5311 16.3983 35.5141 16.3574 35.4839 16.3272C35.4537 16.297 35.4128 16.2799 35.3701 16.2798H25.8615V18.2476Z"
                                                            stroke="#06A788" stroke-width="1.1" stroke-miterlimit="10"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path
                                                            d="M18.858 13.9401H13.0948C13.0664 13.9401 13.0383 13.9346 13.012 13.9237C12.9858 13.9129 12.9619 13.897 12.9419 13.8769C12.9218 13.8568 12.9059 13.833 12.895 13.8067C12.8842 13.7805 12.8786 13.7524 12.8787 13.724V11.7722C12.8789 11.715 12.9018 11.6601 12.9422 11.6197C12.9827 11.5792 13.0376 11.5564 13.0948 11.5561H26.905C27.0237 11.5561 27.1194 11.6536 27.1194 11.7722V13.724C27.1196 13.7523 27.1142 13.7803 27.1035 13.8065C27.0929 13.8328 27.0771 13.8566 27.0572 13.8767C27.0373 13.8968 27.0136 13.9127 26.9874 13.9236C26.9613 13.9345 26.9333 13.9401 26.905 13.9401H20.9451"
                                                            stroke="#06A788" stroke-width="1.1" stroke-miterlimit="10"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path
                                                            d="M5.40039 27.1281V34.6856C5.40039 34.8415 5.52795 34.969 5.68558 34.969H14.1383M5.40039 18.2476V24.9637"
                                                            stroke="#06A788" stroke-width="1.1" stroke-miterlimit="10"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path
                                                            d="M25.8615 18.2476H34.5976V34.6856C34.5974 34.7607 34.5674 34.8327 34.5143 34.8858C34.4612 34.9389 34.3893 34.9688 34.3142 34.9691H25.8615V18.2476Z"
                                                            stroke="#06A788" stroke-width="1.1" stroke-miterlimit="10"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path
                                                            d="M16.2892 34.969V33.2988C16.2892 33.0756 16.4876 32.8914 16.7304 32.8914H23.2696C23.5106 32.8914 23.709 33.0756 23.709 33.2988V34.969"
                                                            stroke="#06A788" stroke-width="1.1" stroke-miterlimit="10"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path d="M14.1384 13.9401V34.969H25.8615V13.9401"
                                                            stroke="#06A788" stroke-width="1.1" stroke-miterlimit="10"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                    </g>
                                                </svg>
                                        ...
                                        <div class="heading">
                                            <div class="tf-icon ">
                                                <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="M10 20C10.3784 20.0007 10.7565 19.9795 11.1325 19.9365C11.199 19.9306 11.2637 19.9114 11.3227 19.8801C11.3817 19.8488 11.4339 19.806 11.476 19.7542C11.5182 19.7024 11.5496 19.6427 11.5683 19.5786C11.5871 19.5145 11.5927 19.4473 11.5851 19.3809C11.5774 19.3146 11.5565 19.2504 11.5236 19.1923C11.4907 19.1342 11.4465 19.0832 11.3936 19.0424C11.3407 19.0016 11.2802 18.9719 11.2156 18.9549C11.151 18.9379 11.0836 18.934 11.0175 18.9435C10.6797 18.9818 10.34 19.0007 10 19C7.5585 19 6 18.1115 6 17.5V16.032C7.21639 16.7228 8.60233 17.0582 10 17C11.3976 17.0584 12.7836 16.7232 14 16.0325V17.5C14 17.6326 14.0527 17.7598 14.1464 17.8536C14.2402 17.9473 14.3674 18 14.5 18C14.6326 18 14.7598 17.9473 14.8536 17.8536C14.9473 17.7598 
34.2 16.4L33 15.5V17.5C33 17.6326 32.9473 17.7598 32.8536 17.8536C32.7598 17.9473 32.6326 18 32.5 18C32.3674 18 32.2402 17.9473 32.1464 17.8536C32.0527 17.7598 32 17.6326 32 17.5V14.75L24.5 9.125L17 14.75V17.5C17 17.6326 16.9473 17.7598 16.8536 17.8536C16.7598 17.9473 16.6326 18 16.5 18C16.3674 18 16.2402 17.9473 16.1464 17.8536C16.0527 17.7598 16 17.6326 16 17.5V14.5C15.9999 14.4224 16.018 14.3458 16.0527 14.2763C16.0874 14.2069 16.1378 14.1465 16.2 14.1L24.2 8.1C24.2865 8.03509 24.3918 8 24.5 8C24.6082 8 24.7135 8.03509 24.8 8.1L34 15V13.25L24.5 6.125L15.8 12.65C15.6939 12.7296 15.5606 12.7637 15.4293 12.745C15.298 12.7262 15.1796 12.6561 15.1 12.55C15.0204 12.4439 14.9863 12.3106 15.005 12.1793C15.0238 12.048 15.0939 11.9296 15.2 11.85L24.2 5.1C24.2865 5.03509 24.3918 5 24.5 5C24.6082 5 24.7135 5.03509 24.8 5.1L34.8 12.6C34.8622 12.6465 34.9126 12.7069 34.9473 12.7763C34.982 12.8458 35.0001 12.9224 35 13Z"
                                                        fill="#06A788" />
                                                </svg>
                    ...
                    <div class="person absolute wow animate__fadeInRight animate__animated" data-wow-duration="2s"
                        data-wow-delay="0s">
                        <img src="{{ url('images/items/section-trusted-1.png') }}" alt="">
                    </div>
                    <div class="item absolute wow animate__fadeInRight animate__animated" data-wow-duration="2s"
                        data-wow-delay="0.3s">
                        <img src="{{ url('images/items/section-trusted-2.png') }}" alt="">
                    </div>
                </div>
            </section><!-- /.section-trusted -->

            <!-- .section-popular-searches -->
            <section class="section-popular-searches tf-spacing-1">
                <div class="tf-container md">
                    <div class="row">
                        <div class="col-12">
                            <div class="heading-section text-center mb-48">
                                <h2 class="title text-anime-wave">Popular Searches</h2>
                                <p class="text-1 wow animate__fadeInUp animate__animated" data-wow-duration="1.5s"
                            ...
                            <div class="widget-tabs style-2 ">
                                ...
                                <div class="widget-content-tab">
                                    <div class="widget-content-inner active">
                                        <div class="swiper sw-layout-4-v3 style-pagination " data-preview="4"
                                            data-desktop="3" data-tablet="2" data-mobile-sm="1" data-mobile="1"
                                            data-space="15" data-space-md="30" data-space-lg="40" data-speed="1000">
                                            <div class="swiper-wrapper mb-44">
                                                <div class="swiper-slide">
                                                    <div class="box-house hover-img ">
                                                        <div class="image-wrap">
                                                            <a href="property-detail-v1">
                                                                <img class="lazyload"
                                                                    data-src="{{ url('images/section/box-house-10.jpg') }}"
                                                                    src="{{ url('images/section/box-house-10.jpg') }}" alt="">
                                                            </a>
                                                            <ul class="box-tag flex gap-8 ">
                                                                <li class="flat-tag text-4 bg-main fw-6 text-white">
                                                                    Featured</li>
                                                                <li class="flat-tag text-4 bg-3 fw-6 text-white">For
                                                                    Sale</li>
                                                            </ul>
                                                        ...
                                                        <div class="content">
                                                            <h5 class="title">
                                                                <a href="property-detail-v1">Elegant studio
                                                                    flat</a>
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="box-house hover-img ">
                                                        <div class="image-wrap">
                                                            <a href="property-detail-v1">
                                                                <img class="lazyload"
                                                                    data-src="{{ url('images/section/box-house-11.jpg') }}"
                                                                    src="{{ url('images/section/box-house-11.jpg') }}" alt="">
                                                            </a>
                                                            <ul class="box-tag flex gap-8 ">
                                                                <li class="flat-tag text-4 bg-main fw-6 text-white">
                                                                    Featured</li>
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="box-house hover-img ">
                                                        <div class="image-wrap">
                                                            <a href="property-detail-v1">
                                                                <img class="lazyload"
                                                                    data-src="{{ url('images/section/box-house-12.jpg') }}"
                                                                    src="{{ url('images/section/box-house-12.jpg') }}" alt="">
                                                            </a>
                                                            <ul class="box-tag flex gap-8 ">
                                                                <li class="flat-tag text-4 bg-main fw-6 text-white">
                                                                    Featured</li>
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="box-house hover-img ">
                                                        <div class="image-wrap">
                                                            <a href="property-detail-v1">
                                                                <img class="lazyload"
                                                                    data-src="{{ url('images/section/box-house-13.jpg') }}"
                                                                    src="{{ url('images/section/box-house-13.jpg') }}" alt="">
                                                            </a>
                                                            <ul class="box-tag flex gap-8 ">
                                                                <li class="flat-tag text-4 bg-main fw-6 text-white">
                                                                    Featured</li>
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="box-house hover-img">
                                                        <div class="image-wrap">
                                                            <a href="property-detail-v1">
                                                                <img class="lazyload"
                                                                    data-src="{{ url('images/section/box-house.jpg') }}"
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="box-house hover-img">
                                                        <div class="image-wrap">
                                                            <a href="property-detail-v1">
                                                                <img class="lazyload"
                                                                    data-src="{{ url('images/section/box-house-2.jpg') }}"
                                            ...
                                            <div class="sw-pagination sw-pagination-layout-4 text-center"></div>
                                        </div>
                                    </div>
                                    <div class="widget-content-inner ">
                                        <div class="swiper sw-layout-4 style-pagination " data-preview="4"
                                            data-tablet="3" data-mobile-sm="2" data-mobile="1" data-space="15"
                                            data-space-md="30" data-space-lg="40" data-speed="1000">
            ...
            <!-- .section-realty -->
            <section class="section-realty tf-spacing-1">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-12">
                            <div class="heading-section text-center">
                                <h2 class="title text-white text-anime-wave">Market Your Property With <br> Realty</h2>
                                <p class="text-1 text-white wow animate__fadeInUp animate__animated"
                                    data-wow-duration="1.5s" data-wow-delay="0s">No obligation market appraisal for your
                                    property today.
                                    Our virtual options are <br> still available if you prefer</p>
                            </div>
                        </div>
                        <div class="tf-grid-layout-2 lg-col-4 ">
                            <div class="counter-item mx-auto">
                                <div class="count">
                                    <div class="counter-number ">
                                        <div class="odometer style-1-1">10
                                        </div>
                                        <span class="sub plus">+</span>
                                    </div>
                                    <p class="text-1 text-white">Years of Business</p>
                                </div>
                            </div>
                            <div class="counter-item mx-auto">
                                <div class="count text-center">
                                    <div class="counter-number ">
                                        <div class="odometer style-1-2">3000
                                        </div>
                                    </div>
                                    <p class="text-1 text-white ">Properties sold</p>
                                </div>
                            </div>
                            <div class="counter-item mx-auto">
                                <div class="count text-center">
                                    ...
                                    <p class="text-1 text-white">Happy custormers</p>
                                </div>
                            </div>
                            <div class="counter-item mx-auto">
                                <div class="count text-center">
                                    <div class="counter-number ">
                                        <div class="odometer style-1-4">100
                                        </div>
                                    </div>
                                    <p class="text-1 text-white">Years of Business</p>
                                </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="tf-grid-layout-2 md-col-4 mb-48">
                                <div class="agent-item hover-img">
                                    <div class="image-wrap">
                                        <a href="agents-details">
                                            <img class="lazyload" data-src="{{ url('images/section/agent-item-1.jpg') }}"
                                                src="{{ url('images/section/agent-item-1.jpg') }}" alt="">
                                        </a>
                                    ...
                                    <div class="content">
                                        <div class="author">
                                            <h5 class="name lh-30"><a href="agents-details">Leslie
                                                    Alexander</a></h5>
                                ...
                                <div class="agent-item hover-img ">
                                    <div class="image-wrap">
                                        <a href="agents-details">
                                            <img class="lazyload" data-src="{{ url('images/section/agent-item-2.jpg') }}"
                                                src="{{ url('images/section/agent-item-2.jpg') }}" alt="">
                                        </a>
                                        <ul class="tf-social style-3">
                                            <li><a href="#"><i class="icon-fb"></i></a></li>
                                            <li><a href="#"><i class="icon-X"></i></a></li>
                                ...
                                <div class="agent-item hover-img wow ">
                                    <div class="image-wrap">
                                        <a href="agents-details">
                                            <img class="lazyload" data-src="{{ url('images/section/agent-item-3.jpg') }}"
                                                src="{{ url('images/section/agent-item-3.jpg') }}" alt="">
                                        </a>
                                        <ul class="tf-social style-3">
                                            <li><a href="#"><i class="icon-fb"></i></a></li>
                                            <li><a href="#"><i class="icon-X"></i></a></li>
                                ...
                                <div class="agent-item hover-img ">
                                    <div class="image-wrap">
                                        <a href="agents-details">
                                            <img class="lazyload" data-src="{{ url('images/section/agent-item-4.jpg') }}"
                                                src="{{ url('images/section/agent-item-4.jpg') }}" alt="">
                                        </a>
                                        <ul class="tf-social style-3">
                                            <li><a href="#"><i class="icon-fb"></i></a></li>
                                            <li><a href="#"><i class="icon-X"></i></a></li>
                            ...
                            <p class="text-center text-1 mb-48">Explore Property agents are here to help with all your
                                buying, renting and selling goals. <br>
            ...
            </section><!-- /.section-local-agent -->

            <!-- section-neighborhoods -->
            <section class="section-neighborhoods style-2 ">
                <div class="tf-container full">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="swiper sw-layout-4-v2 style-pagination " data-preview="4" data-tablet="3"
                                data-mobile-sm="2" data-mobile="1" data-space="12" data-space-md="12" data-space-lg="12"
                                data-speed="1000">
                                <div class="swiper-wrapper mb-48 wrap-neighborhoods">
                                    <div class="swiper-slide">
                                        <div class="box-location hover-img ">
                                            <div class="image-wrap">
                                                <a href="#">
                                                    <img class="lazyload" data-src="{{ url('images/section/location-9.jpg') }}"
                                                        src="{{ url('images/section/location-9.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="content">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box-location hover-img">
                                            <div class="image-wrap">
                                                <a href="#">
                                                    <img class="lazyload" data-src="{{ url('images/section/location-16.jpg') }}"
                                                        src="{{ url('images/section/location-16.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="content">
                                                <h6 class="text-white">New York</h6>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box-location hover-img">
                                            <div class="image-wrap">
                                                <a href="#">
                                                    <img class="lazyload" data-src="{{ url('images/section/location-17.jpg') }}"
                                                        src="{{ url('images/section/location-17.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="content">
                                                <h6 class="text-white">New York</h6>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box-location hover-img">
                                            <div class="image-wrap">
                                                <a href="#">
                                                    <img class="lazyload" data-src="{{ url('images/section/location-18.jpg') }}"
                                                        src="{{ url('images/section/location-18.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="content">
                                                <h6 class="text-white">New York</h6>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box-location hover-img">
                                            <div class="image-wrap">
                                                <a href="#">
                                                    <img class="lazyload" data-src="{{ url('images/section/location-19.jpg') }}"
                                                        src="{{ url('images/section/location-19.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="content">
                                                <h6 class="text-white">New York</h6>
                                ...
                                <div class="sw-wrap-btn">
                                    <div class="swiper-button-prev sw-button layout-4-prev">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="sw-pagination sw-pagination-layout-4 text-center"></div>
                                    <div class="swiper-button-next sw-button layout-4-next">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="tf-container">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="swiper sw-testimonials style-pagination " data-preview="3" data-tablet="2"
                                data-mobile-sm="2" data-mobile="1" data-space="15" data-space-md="30" data-space-lg="40"
                                data-speed="1000">
                                <div class="swiper-wrapper mb-48 ">
                                    <div class="swiper-slide">
                                        <div class="wg-testimonial text-center">
                                            <div class="avatar">
                                                <img src="{{ url('images/avatar/testimonials-3.jpg') }}" alt="">
                                            </div>
                                            <p class="text-1 description">Phasellus efficitur dictum urna, non elementum
                                                mauris mollis
                                                a. Duis lacinia arcu ac lorem ultricies porta. Maecenas eleifend
                                                malesuada egestas. In
                                                eu eros hendrerit, pharetra justo id, blandit orci.</p>
                                            <div class="ratings justify-center">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="wg-testimonial text-center">
                                            <div class="avatar">
                                                <img src="{{ url('images/avatar/testimonials-2.jpg') }}" alt="">
                                            </div>
                                            <p class="text-1 description">Proin auctor, mauris at tristique ullamcorper,
                                                nunc nisi sagittis velit, eget blandit dolor arcu sed ante. Fusce
                                                euismod varius massa, id viverra nisl semper ut. Aliquam felis eros,
                                                eleifend non faucibus at.</p>
                                            <div class="ratings justify-center">
                                                <i class="icon-start"></i>
                                                <i class="icon-start"></i>
                                                <i class="icon-start"></i>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="wg-testimonial text-center">
                                            <div class="avatar">
                                                <img src="{{ url('images/avatar/testimonials-4.jpg') }}" alt="">
                                            </div>
                                            <p class="text-1 description">Phasellus efficitur dictum urna, non elementum
                                                mauris mollis
                                                a. Duis lacinia arcu ac lorem ultricies porta. Maecenas eleifend
                                    ...
                                    <div class="swiper-slide">
                                        <div class="wg-testimonial text-center">
                                            ...
                                            <p class="text-1 description">Sed eget nibh eros. Phasellus pharetra ac leo
                                                et auctor. Donec libero dui, blandit id nulla laoreet, pellentesque
                                                egestas ante. Etiam mollis tincidunt elit, sit amet sodales tellus
                                                finibus ut. Orci varius natoque.</p>
                                            <div class="ratings justify-center">
                                                <i class="icon-start"></i>
                                                <i class="icon-start"></i>
                                                <i class="icon-start"></i>
                                ...
                                <div class="sw-wrap-btn">
                                    <div class="swiper-button-prev sw-button testimonials-prev">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M19 12H5" stroke="#5C5E61" stroke-width="2" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                    ...
                                    <div class="sw-pagination sw-pagination-testimonials text-center"></div>
                                    <div class="swiper-button-next sw-button testimonials-next">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M5 12H19" stroke="#5C5E61" stroke-width="2" stroke-linecap="round"
                                                stroke-linejoin="round" />
            ...
            <section class="section-appraisal ">
                <div class="wg-appraisal style-2 ">
                    <div class="tf-container">
                        <div class="row">
                            <div class="col-12">
                                <div class="content">
                                    <div class="heading-section mb-32">
                                        <h2 class="title text-white text-anime-wave">Are You Selling Or <br>
                                            Renting Your Property?</h2>
                                        <p class="text-1 text-white wow animate__fadeInUp animate__animated"
                                            data-wow-duration="1.5s" data-wow-delay="0s">Thousands of luxury home
                                            enthusiasts
                                            just like you visit our
                                            website.
                                        </p>
                                    </div>
                                    <a href="#"
                                        class="tf-btn bg-color-white fw-7 pd-11 wow animate__fadeInUp animate__animated"
                                        data-wow-duration="1s" data-wow-delay="0s">
                                        Request your free appraisal
                                    </a>
                                    <div class="person ">
                                        <img class="wow animate__fadeInRight animate__animated" data-wow-duration="2s"
                                            data-wow-delay="0s " src="{{ url('images/section/person-2.png') }}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="wg-partner">
                    <div class="tf-container">
                        <div class="row">
                            <div class="col-12">
                                <div class="heading-section  text-center mb-48">
                                    <h2 class="title text-anime-wave">Let’s Work Together</h2>
                                ...
                                <div class="swiper brand-slide " data-preview="6" data-tablet="4" data-mobile-sm="3"
                                    ...
                                    <div class="swiper-wrapper wrap-partners">
                                        <div class="swiper-slide">
                        ...
                        <div class="col-12">
                            <div class="footer-top">
                                <div class="footer-logo">
                                    <a href="index">
                                        <img id="logo_footer" src="{{ url('images/logo/logo-3%402x.png') }}" alt="logo-footer">
                                    </a>
                                </div>
    ...
    <div class="offcanvas offcanvas-start mobile-nav-wrap " tabindex="-1" id="menu-mobile"
        ...
        <div class="offcanvas-header top-nav-mobile">
            <div class="offcanvas-title">
                <a href="index"><img src="{{ url('images/logo/logo-3.1%402x.png') }}" alt=""></a>
            </div>
                    ...
                    <li class="menu-item menu-item-has-children-mobile current-menu-item">
                        ...
                        <div id="dropdown-menu-one" class="collapse" data-bs-parent="#menu-mobile-menu">
                            <ul class="sub-mobile ">
                                ...
                                <li class="menu-item current-item"><a href="home02">Home Page 02</a></li>
                            ...
                            <ul class="sub-mobile">
                                ...
                                <li class="menu-item menu-item-has-children-mobile-2">
                                    ...
                                    <div id="sub-agency" class="collapse" data-bs-parent="#dropdown-menu-four">
                                        <ul class="sub-mobile">
                                            <li class="menu-item ">
                                                <a href="agency-grid" class="item-menu-mobile ">Agencies
                                                    Grid</a>
                                            </li>
                                            <li class="menu-item ">
                                                <a href="agency-list" class="item-menu-mobile "> Agencies
                                                    List</a>
                                            </li>
                                            <li class="menu-item ">
    ...
    <script type="text/javascript" src="{{ url('js/counter.js') }}"></script>
...
<!-- Mirrored from themesflat.co/html/proty/home02 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:13:29 GMT -->
</html>