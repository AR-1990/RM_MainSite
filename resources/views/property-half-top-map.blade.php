...
<!-- Mirrored from themesflat.co/html/proty/property-half-top-map by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:13:56 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="main-content">
            ...
            <!-- section-property -->
            <section class="section-property tf-spacing-2 ">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-12">
                            <div class="box-title">
                            ...
                            <div class="flat-animate-tab">
                                <div class="tab-content">
                                    <div class="tab-pane active show" id="gridLayout" role="tabpanel">
                                        <div class=" tf-grid-layout lg-col-3 md-col-2  loadmore-item-6">
                                            <div class="box-house hover-img fl-item-6">
                                        ...
                                        <button
                                            class="tf-btn bg-color-primary pd-13 fw-7 mx-auto mt-32 btn-loadmore-6 view-more-button-6">Load
                                            more property
                                        </button>
                                    </div>
                                    <div class="tab-pane" id="listLayout" role="tabpanel">
                                        <div class="tf-grid-layout lg-col-2 loadmore-item-7">
                                            <div class="box-house style-list hover-img fl-item-7">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1">
                                                        <img class="lazyload" data-src="{{ url('images/section/box-house.jpg') }}"
                                                            src="{{ url('images/section/box-house.jpg') }}" alt="">
                                        ...
                                        <button
                                            class="tf-btn bg-color-primary pd-13 fw-7 mx-auto mt-32 btn-loadmore-7 view-more-button-7">Load
                                            more property
                                        </button>
                                    </div>
                                </div>
