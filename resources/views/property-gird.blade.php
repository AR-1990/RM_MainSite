...
<!-- Mirrored from themesflat.co/html/proty/property-gird by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:14:44 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="main-content">
            ...
            <section class="section-property-grid ">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-12">
                                            ...
                                            <div class="box-house hover-img">
                                                <div class="image-wrap">
                                                    ...
                                                    <div class="list-btn flex gap-8 ">
                                                        ...
                                                        <a href="#" class="btn-icon find"><i
                                                                class="icon-find-plus"></i></a>
                                                    </div>
                                                </div>
                                                <div class="content">
                                                    <h5 class="title">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="footer-menu-list newsletter ">
                                    ...
                                    <form class="form-newsletter">
                                        ...
                                        <fieldset>
                                            <input class="" type="email" placeholder="Your email address" name="text"
                                                tabindex="2" aria-required="true" required="">
                                        </fieldset>
                                        <div class="button-submit">
                                            <button class="tf-btn bg-color-primary w-full"
                        ...
                        <div id="dropdown-menu-two" class="collapse" data-bs-parent="#menu-mobile-menu">
                            <ul class="sub-mobile">
                                <li class="menu-item current-item">
                                    <a href="property-gird">Property Grid</a>
                                </li>
                                <li class="menu-item">
