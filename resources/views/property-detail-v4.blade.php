...
<!-- Mirrored from themesflat.co/html/proty/property-detail-v4 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:14:13 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
                            ...
                            <div class="swiper sw-thumbs-sigle " data-preview="1" data-space="0" data-speed="1000">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="{{ url('images/section/property-details-thumbs-1.jpg') }}" data-fancybox="gallery"
                                            class="image-wrap relative d-block">
                                            <img class="lazyload"
                                                data-src="{{ url('images/section/property-details-thumbs-1.jpg') }}"
                                                src="{{ url('images/section/property-details-thumbs-1.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                ...
                <div class="tf-container">
                    <div class="row">
                        <div class="col-xl-8 col-lg-7">
                            ...
                            <div class="wg-property single-property-map spacing-10 ">
...
<!-- Mirrored from themesflat.co/html/proty/property-detail-v4 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:14:16 GMT -->
</html>