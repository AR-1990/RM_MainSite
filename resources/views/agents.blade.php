...
<!-- Mirrored from themesflat.co/html/proty/agents by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:14:19 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
                    ...
                    <div class="row">
                        ...
                        <div class=" tf-grid-layout-2 lg-col-4 md-col-3 sm-col-2">
                            <div class="agent-item hover-img ">
                                ...
                                <div class="content">
                                    <div class="author">
                                        <h5 class="name lh-30"><a href="agents-details">Leslie Alexander</a></h5>
                            ...
                            <div class="agent-item hover-img ">
                                <div class="image-wrap">
                                    <a href="agents-details">
                                        <img class="lazyload" data-src="{{ url('images/section/agent-item-9.jpg') }}"
                                            src="{{ url('images/section/agent-item-9.jpg') }}" alt="">
                                    </a>
                                    <ul class="tf-social style-3">
                                        <li><a href="#"><i class="icon-fb"></i></a></li>
                                        <li><a href="#"><i class="icon-X"></i></a></li>
                            ...
                            <div class="agent-item hover-img">
                                <div class="image-wrap">
                                    <a href="agents-details">
                                        <img class="lazyload" data-src="{{ url('images/section/agent-item-10.jpg') }}"
                                            src="{{ url('images/section/agent-item-10.jpg') }}" alt="">
                                    </a>
                                    <ul class="tf-social style-3">
                                        <li><a href="#"><i class="icon-fb"></i></a></li>
                                        <li><a href="#"><i class="icon-X"></i></a></li>
                            ...
                            <div class="agent-item hover-img">
                                <div class="image-wrap">
                                    <a href="agents-details">
                                        <img class="lazyload" data-src="{{ url('images/section/agent-item-11.jpg') }}"
                                            src="{{ url('images/section/agent-item-11.jpg') }}" alt="">
                                    </a>
                                    <ul class="tf-social style-3">
                                        <li><a href="#"><i class="icon-fb"></i></a></li>
                                        <li><a href="#"><i class="icon-X"></i></a></li>
                            ...
                            <div class="agent-item hover-img">
                                <div class="image-wrap">
                                    <a href="agents-details">
                                        <img class="lazyload" data-src="{{ url('images/section/agent-item-12.jpg') }}"
                                            src="{{ url('images/section/agent-item-12.jpg') }}" alt="">
                                    </a>
                                    <ul class="tf-social style-3">
                                        <li><a href="#"><i class="icon-fb"></i></a></li>
                                        <li><a href="#"><i class="icon-X"></i></a></li>
                            ...
                            <div class="agent-item hover-img ">
                                <div class="image-wrap">
                                    <a href="agents-details">
                                        <img class="lazyload" data-src="{{ url('images/section/agent-item-13.jpg') }}"
                                            src="{{ url('images/section/agent-item-13.jpg') }}" alt="">
                                    </a>
                                    <ul class="tf-social style-3">
                                        <li><a href="#"><i class="icon-fb"></i></a></li>
                                        <li><a href="#"><i class="icon-X"></i></a></li>
                            ...
                            <div class="agent-item hover-img">
                                <div class="image-wrap">
                                    <a href="agents-details">
                                        <img class="lazyload" data-src="{{ url('images/section/agent-item-14.jpg') }}"
                                            src="{{ url('images/section/agent-item-14.jpg') }}" alt="">
                                    </a>
                                    <ul class="tf-social style-3">
                                        <li><a href="#"><i class="icon-fb"></i></a></li>
                                        <li><a href="#"><i class="icon-X"></i></a></li>
                            ...
                            <div class="agent-item hover-img">
                                <div class="image-wrap">
                                    <a href="agents-details">
                                        <img class="lazyload" data-src="{{ url('images/section/agent-item-15.jpg') }}"
                                            src="{{ url('images/section/agent-item-15.jpg') }}" alt="">
                                    </a>
                                    <ul class="tf-social style-3">
                                        <li><a href="#"><i class="icon-fb"></i></a></li>
                                        <li><a href="#"><i class="icon-X"></i></a></li>
...
<!-- Mirrored from themesflat.co/html/proty/agents by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:14:21 GMT -->
</html>