...
<!-- Mirrored from themesflat.co/html/proty/home05 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:13:36 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
...
<body class="theme-color-4 ">
    ...
    <div id="wrapper">
            ...
            <div id="loading-center">
                <div class="loader-container">
                    <div class="wrap-loader">
                        ...
                        <div class="icon">
                            <img src="{{ url('images/logo/loading-5.png') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="header-inner-wrap">
                                <div class="header-logo">
                                    <a href="index" class="site-logo">
                                        <img class="img-default" alt="" src="{{ url('images/logo/logo-6%402x.png') }}">
                                        <img class="img-is-fixed" alt="" src="{{ url('images/logo/logo-6.2%402x.png') }}">
                                    </a>
                                </div>
                                <nav class="main-menu">
                                    <ul class="navigation ">
                                        <li class="has-child current-menu"><a href="#">Home</a>
                                            <ul class="submenu">
                                                ...
                                                <li class="current-item"><a href="home05">Home Page 05</a></li>
                                            </ul>
                                        </li>
        ...
        <div class="main-content">
            ...
            <section class="section-featured-listings tf-spacing-1">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-12">
                                    ...
                                    <div class="widget-content-inner active">
                                        <div class="tf-grid-layout lg-col-3 md-col-2 loadmore-item">
                                            <div class="box-house hover-img fl-item ">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1">
                                                        <img class="lazyload" data-src="{{ url('images/section/box-house-12.jpg') }}"
                                            ...
                                            <div class="box-house hover-img fl-item ">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1">
                                                        <img class="lazyload" data-src="{{ url('images/section/box-house-11.jpg') }}"
                                        ...
                                        <button
                                            class="tf-btn bg-color-primary pd-13 fw-7 btn-loadmore view-more-button ">Load
                                            more property</button>
                                    </div>
                                    <div class="widget-content-inner ">
                                        <div class="tf-grid-layout lg-col-3 md-col-2 loadmore-item-1">
                                            <div class="box-house hover-img fl-item-1">
                                                <div class="image-wrap">
                                                    <a href="#">
                                                        <img class="lazyload" data-src="{{ url('images/section/box-house-12.jpg') }}"
                                                            src="{{ url('images/section/box-house-10.jpg') }}" alt="">
                                        ...
                                        <button
                                            class="tf-btn bg-color-primary pd-13 fw-7 btn-loadmore-1 view-more-button-1  ">Load
                                            more property</button>
                                    </div>
                                    <div class="widget-content-inner ">
                                        <div class="tf-grid-layout lg-col-3 md-col-2 loadmore-item-2">
                                            <div class="box-house hover-img fl-item-2">
                                                <div class="image-wrap">
                                                    <a href="#">
                                                        <img class="lazyload" data-src="{{ url('images/section/box-house-10.jpg') }}"
                                                            src="{{ url('images/section/box-house-10.jpg') }}" alt="">
                                                    </a>
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text-white">
                                        ...
                                        <button
                                            class="tf-btn bg-color-primary pd-13 fw-7 btn-loadmore-2 view-more-button-2 ">Load
                                            more property</button>
                                    </div>
                                    <div class="widget-content-inner ">
                                        <div class="tf-grid-layout lg-col-3 md-col-2 loadmore-item-3">
                                            <div class="box-house hover-img fl-item-3">
                                                <div class="image-wrap">
                                                    <a href="#">
                                                        <img class="lazyload" data-src="{{ url('images/section/box-house-10.jpg') }}"
                                                            src="{{ url('images/section/box-house-10.jpg') }}" alt="">
                                        ...
                                        <button
                                            class="tf-btn bg-color-primary pd-13 fw-7 btn-loadmore-3 view-more-button-3 ">Load
                                            more property</button>
                                    </div>
                                    <div class="widget-content-inner ">
                                        <div class="tf-grid-layout lg-col-3 md-col-2 loadmore-item-4">
                                            <div class="box-house hover-img fl-item-4">
                                                <div class="image-wrap">
                                                    <a href="#">
                                                        <img class="lazyload" data-src="{{ url('images/section/box-house-10.jpg') }}"
                                                            src="{{ url('images/section/box-house-10.jpg') }}" alt="">
                                        ...
                                        <button
                                            class="tf-btn bg-color-primary pd-13 fw-7 btn-loadmore-4 view-more-button-4 ">Load
                                            more property</button>
                                    </div>
                                    <div class="widget-content-inner ">
                                        <div class="grid-layout-3 loadmore-item-5 mb-48">
                                            <div class="box-house hover-img fl-item-5">
                                                <div class="image-wrap">
                                                    <a href="#">
                                                        <img class="lazyload" data-src="{{ url('images/section/box-house-10.jpg') }}"
                                                            src="{{ url('images/section/box-house-10.jpg') }}" alt="">
                                        ...
                                        <button
                                            class="tf-btn bg-color-primary pd-13 fw-7 btn-loadmore-5 view-more-button-5 ">Load
                                            more property</button>
                                    </div>
                                </div>
                            </div>
            ...
            <!-- Categories -->
            <section class="tf-spacing-1 section-categories pt-0">
                <div class="tf-container">
                    <div class="heading-section text-center mb-48">
            ...
            <section class="section-selling-home tf-spacing-1">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-12">
                            <div class="heading-section text-center mb-48">
                                <h2 class="title text-anime-wave">Selling Your Home With Realty</h2>
                                <p class="text-1 wow animate__fadeInUp animate__animated" data-wow-duration="1.5s"
                                    data-wow-delay="0s">We'll get to know you to understand your selling
                                    goals, and explain
                                    the selling process so <br> you know what to expect.
                                </p>
                            </div>
                            <div class="tf-grid-layout lg-col-4 sm-col-2 ">
                                <div class="icons-box style-4 effec-icon  wow animate__zoomIn animate__animated"
                                    ...
                                    <h5 class="title text-center"><a href="#">Local Expertise</a></h5>
                                    <span class="line"></span>
                                    <p class=" text-1 text-center">We are not loud, noisy and full of our own
                                        self-importance.
                                        As your agent we know we work for you.</p>
                                </div>
                                <div class="icons-box style-4 effec-icon  wow animate__zoomIn animate__animated"
                                    data-wow-duration="1s" data-wow-delay="0s">
                                    <div class="tf-icon ">
                                    ...
                                    <h5 class="title text-center"><a href="#">Intuitive search</a></h5>
                                    <span class="line"></span>
                                    <p class=" text-1 text-center">We are not loud, noisy and full of our own
                                        self-importance.
                                        As your agent we know we work for you.</p>
                                ...
                                <div class="icons-box style-4 effec-icon  wow animate__zoomIn animate__animated"
                                    ...
                                    <h5 class="title text-center"><a href="#">We Get Results</a></h5>
                                    <span class="line"></span>
                                    <p class=" text-1 text-center">We are not loud, noisy and full of our own
                                        self-importance.
                                        As your agent we know we work for you.</p>
                                ...
                                <div class="icons-box style-4 effec-icon  wow animate__zoomIn animate__animated"
                                    ...
                                    <h5 class="title text-center"><a href="#">Happy Clients</a></h5>
                                    <span class="line"></span>
                                    <p class=" text-1 text-center">We are not loud, noisy and full of our own
                                        self-importance.
                                        As your agent we know we work for you.</p>
                        ...
                        <div class="col-12">
                            ...
                            <div class="swiper sw-testimonials style-pagination " data-preview="3" data-tablet="2"
                                ...
                                <div class="swiper-wrapper mb-48 ">
                                    <div class="swiper-slide">
                                        <div class="wg-testimonial has-bg text-center">
                                            <div class="avatar">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="wg-testimonial has-bg text-center">
                                            <div class="avatar">
                                                <img src="{{ url('images/avatar/avt-png4.png') }}" alt="">
                                            </div>
                        ...
                        <div class="row ">
                            <div class="col-lg-6 relative z-5">
                                ...
                                <div class="wrap-download">
                                    <a href="#" class="app-store wow animate__fadeInUp animate__animated"
                                        data-wow-duration="1s" data-wow-delay="0s"><img src="{{ url('images/items/app-store.jpg') }}"
                                            alt=""></a>
                                    <a href="#" class="ch-play wow animate__fadeInUp animate__animated"
                                        data-wow-duration="1s" data-wow-delay="0.1s"><img src="{{ url('images/items/ch-play.jpg') }}"
                                            alt=""></a>
                                </div>
                            </div>

                        </div>
                        <div class="image-wrap lg-hide wow animate__fadeInRight animate__animated"
                            data-wow-duration="2.5s" data-wow-delay="0s">
                            <img src="{{ url('images/items/phone.png') }}" alt="">
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <div class="col-12 ">
                            ...
                            <div class="swiper style-pagination tf-sw-mobile-1 " data-screen="575" data-preview="1"
                                ...
                                <div class="swiper-wrapper tf-layout-mobile-sm sm-col-2 lg-col-4 mb-48">
                                    <div class="swiper-slide">
                                        <div class="agent-item hover-img style-2 wow animate__fadeInUp animate__animated"
                                            data-wow-duration="1s" data-wow-delay="0s">
                                            <div class="image-wrap">
                                                <a href="agents-details">
                                                    <img class="lazyload" data-src="{{ url('images/section/agent-item-5.jpg') }}"
                                                        src="{{ url('images/section/agent-item-5.jpg') }}" alt="">
                                                </a>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="agent-item hover-img style-2 wow animate__fadeInUp animate__animated"
                                            ...
                                            <div class="image-wrap">
                                                <a href="agents-details">
                                                    <img class="lazyload" data-src="{{ url('images/section/agent-item-6.jpg') }}"
                                                        src="{{ url('images/section/agent-item-6.jpg') }}" alt="">
                                                </a>
                                                <ul class="tf-social style-3">
                                                    <li><a href="#"><i class="icon-fb"></i></a></li>
                                                    <li><a href="#"><i class="icon-X"></i></a></li>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="agent-item hover-img style-2 wow animate__fadeInUp animate__animated"
                                            ...
                                            <div class="image-wrap">
                                                <a href="agents-details">
                                                    <img class="lazyload" data-src="{{ url('images/section/agent-item-7.jpg') }}"
                                                        src="{{ url('images/section/agent-item-7.jpg') }}" alt="">
                                                </a>
                                                <ul class="tf-social style-3">
                                                    <li><a href="#"><i class="icon-fb"></i></a></li>
                                                    <li><a href="#"><i class="icon-X"></i></a></li>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="agent-item hover-img style-2 wow animate__fadeInUp animate__animated"
                                            ...
                                            <div class="image-wrap">
                                                <a href="agents-details">
                                                    <img class="lazyload" data-src="{{ url('images/section/agent-item-8.jpg') }}"
                                                        src="{{ url('images/section/agent-item-8.jpg') }}" alt="">
                                                </a>
                                                <ul class="tf-social style-3">
                                                    <li><a href="#"><i class="icon-fb"></i></a></li>
                                                    <li><a href="#"><i class="icon-X"></i></a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="image-wrap img-animation wow animate__animated">
                                <img class="lazyload parallax-img" data-src="{{ url('images/section/section-pre-approved-2.jpg') }}"
                                    src="{{ url('images/section/section-pre-approved-2.jpg') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="footer-top">
                            <div class="footer-logo">
                                <a href="index">
                                    <img id="logo_footer" src="{{ url('images/logo/logo-6%402x.png') }}" alt="logo-footer">
                                </a>
                            </div>
    ...
    <div class="offcanvas offcanvas-start mobile-nav-wrap " tabindex="-1" id="menu-mobile"
        ...
        <div class="offcanvas-header top-nav-mobile">
            <div class="offcanvas-title">
                <a href="index"><img src="{{ url('images/logo/logo-6.2%402x.png') }}" alt=""></a>
            </div>
                    ...
                    <li class="menu-item menu-item-has-children-mobile current-menu-item">
                        ...
                        <div id="dropdown-menu-one" class="collapse" data-bs-parent="#menu-mobile-menu">
                            <ul class="sub-mobile ">
                                ...
                                <li class="menu-item current-item"><a href="home05">Home Page 05</a>
                                </li>
                            </ul>
                        </div>
                    </li>
...
<!-- Mirrored from themesflat.co/html/proty/home05 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:13:44 GMT -->
</html>