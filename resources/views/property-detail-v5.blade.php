...
<!-- Mirrored from themesflat.co/html/proty/property-detail-v5 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:14:16 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
            ...
            <div class=" single-property-gallery ">
                <div class="tf-container">
                    <div class="row">
                            ...
                            <div class="swiper sw-single">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="{{ url('images/section/property-details-thumbs-2.jpg') }}" data-fancybox="gallery"
                                            class="image-wrap d-block">
                                            <img class="lazyload"
                                                data-src="{{ url('images/section/property-details-thumbs-2.jpg') }}"
                                                src="{{ url('images/section/property-details-thumbs-2.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="{{ url('images/section/property-details-thumbs-3.jpg') }}" data-fancybox="gallery"
                                            class="image-wrap d-block">
                                            <img class="lazyload"
                                                data-src="{{ url('images/section/property-details-thumbs-3.jpg') }}"
                                                src="{{ url('images/section/property-details-thumbs-3.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="{{ url('images/section/property-details-thumbs-4.jpg') }}" data-fancybox="gallery"
                                            class="image-wrap d-block">
                                            <img class="lazyload"
                                                data-src="{{ url('images/section/property-details-thumbs-4.jpg') }}"
                                                src="{{ url('images/section/property-details-thumbs-4.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="{{ url('images/section/property-details-thumbs-5.jpg') }}" data-fancybox="gallery"
                                            class="image-wrap d-block">
                                            <img class="lazyload"
                                                data-src="{{ url('images/section/property-details-thumbs-5.jpg') }}"
                                                src="{{ url('images/section/property-details-thumbs-5.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="{{ url('images/section/property-details-thumbs-6.jpg') }}" data-fancybox="gallery"
                                            class="image-wrap d-block">
                                            <img class="lazyload"
                                                data-src="{{ url('images/section/property-details-thumbs-6.jpg') }}"
                                                src="{{ url('images/section/property-details-thumbs-6.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="{{ url('images/section/property-details-thumbs-7.jpg') }}" data-fancybox="gallery"
                                            class="image-wrap d-block">
                                            <img class="lazyload"
                                                data-src="{{ url('images/section/property-details-thumbs-7.jpg') }}"
                                                src="{{ url('images/section/property-details-thumbs-7.jpg') }}" alt="">
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="swiper thumbs-sw-pagi style-2" data-preview="6" data-space="15" data-moblie="3"
                            data-mobile-sm="6">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="img-thumb-pagi">
                                        <img src="{{ url('images/section/sw-thumbs-6.jpg') }}" alt="images">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="img-thumb-pagi">
                                        <img src="{{ url('images/section/sw-thumbs-7.jpg') }}" alt="images">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="img-thumb-pagi">
                                        <img src="{{ url('images/section/sw-thumbs-8.jpg') }}" alt="images">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="img-thumb-pagi">
                                        <img src="{{ url('images/section/sw-thumbs-9.jpg') }}" alt="images">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="img-thumb-pagi">
                                        <img src="{{ url('images/section/sw-thumbs-10.jpg') }}" alt="images">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="img-thumb-pagi">
                                        <img src="{{ url('images/section/sw-thumbs-11.jpg') }}" alt="images">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-7">
                            ...
                            <div class="wg-property box-property-detail  spacing-1">
                                ...
                                <div class="content">
                                    <p class="description text-1 mb-10">3 Units in North Hollywood with upside potential
                                        through
                                        construction of an ADU (buyer to verify). Unit mix consists of (3) 3+1 bath
                                        units.
                                        The building is a total of 2, 660 square feet and situated on a 6, 001 square
                                        foot
                                        lot. Easy access to the 101, 170, and 134 freeways. The building is separately
                            ...
                            <div class="wg-property single-property-map spacing-11">
                            ...
                            <div class="wg-property single-property-floor spacing-4">
                                ...
                                <ul class="box-floor" id="parent-floor">
                                    <li class="floor-item">
                                        <div class="floor-header" role="button" data-bs-target="#floor-one"
                            ...
                            <div class="wg-property box-loan spacing-4">
                                ...
                                <form class="form-pre-approved">
                                    ...
                                    <div class="wrap-btn flex items-center justify-between ">
                                        ...
                                        <p class="text-1 mb-0 fw-5 text-color-heading">Your estimated monthly payment:
                                            <span>$599.25</span>
                                        </p>
                                    </div>
                                </form>
                            ...
                            <div class="wg-property single-property-nearby spacing-7">
                                ...
                                <p class="description text-color-default">Explore nearby amenities to precisely locate
...
<!-- Mirrored from themesflat.co/html/proty/property-detail-v5 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:14:19 GMT -->
</html>