...
<!-- Mirrored from themesflat.co/html/proty/property-gird-left-sidebar by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:13:45 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
    ...
    <!-- Custom Styles for Property Filters -->
    <style>
        ...
        .property-search-form .nice-select::before {
            content: '';
            position: absolute;
            top: 0;
            left: 0;
            right: 0;
            bottom: 0;
            background: linear-gradient(45deg, #F1913D, #ff6b35);
            opacity: 0;
            transition: opacity 0.3s ease;
            z-index: -1;
        }
        
        .property-search-form .nice-select:hover,
        .property-search-form .nice-select.open {
            border-color: #F1913D;
            transform: translateY(-1px);
            box-shadow: 0 4px 20px rgba(241, 145, 61, 0.2);
        }
        
        .property-search-form .nice-select .current {
            color: #2c3e50;
            font-weight: 600;
            padding-left: 18px;
            font-size: 14px;
        ...
        .property-search-form .nice-select .option {
            padding: 14px 18px;
            transition: all 0.2s ease;
            font-weight: 500;
        }
        
        .property-search-form .nice-select .option:hover,
        .property-search-form .nice-select .option.focus {
            background: linear-gradient(45deg, #F1913D, #ff6b35);
            color: #fff;
            transform: translateX(5px);
        }
        
        .property-search-form .wrap-btn {
            display: flex;
            align-items: center;
            gap: 12px;
        }
        
        .property-search-form .btn-filter {
        ...
        .property-search-form .btn-filter::before {
            content: '';
            position: absolute;
            top: 0;
            left: -100%;
        ...
        .property-search-form .btn-filter:hover {
            border-color: #F1913D;
            transform: translateY(-2px);
            box-shadow: 0 6px 24px rgba(241, 145, 61, 0.3);
        }
        
        .property-search-form .btn-filter:hover::before {
            left: 0;
        }
        
        .property-search-form .btn-filter:hover .icons svg path {
            stroke: #fff;
        }
        
        .property-search-form .tf-btn {
            background: linear-gradient(45deg, #F1913D, #ff6b35) !important;
            ...
            position: relative;
            overflow: hidden;
            box-shadow: 0 4px 20px rgba(241, 145, 61, 0.3);
        }
        
        .property-search-form .tf-btn::before {
            content: '';
            position: absolute;
            top: 0;
            left: -100%;
            width: 100%;
            height: 100%;
            background: linear-gradient(45deg, #ff6b35, #F1913D);
            transition: left 0.3s ease;
            z-index: 1;
        }
        
        .property-search-form .tf-btn:hover {
            transform: translateY(-3px);
            box-shadow: 0 8px 32px rgba(241, 145, 61, 0.4);
        }
        
        .property-search-form .tf-btn:hover::before {
            left: 0;
        }
        
        .property-search-form .tf-btn span {
            position: relative;
            z-index: 2;
        }
        
        /* Compact row spacing */
        .property-search-form .row.g-3 {
            --bs-gutter-y: 0.5rem;
            --bs-gutter-x: 0.75rem;
        }
        
        /* Additional compact styling */
        .property-search-form .col-lg-1 {
            padding-left: 0.5rem;
        ...
        @media (max-width: 768px) {
            ...
            /* Make form more compact on tablets */
            .property-search-form .row.g-3 {
                --bs-gutter-y: 0.4rem;
                --bs-gutter-x: 0.5rem;
            }
        ...
        .property-search-form.mobile-layout .row > div {
            margin-bottom: 15px;
        }
        
        .property-search-form.mobile-layout .wrap-btn {
            flex-direction: column;
            gap: 15px;
        }
        
        .property-search-form.mobile-layout .btn-filter {
            align-self: center;
        }
        
        /* Enhanced focus states */
        .property-search-form .nice-select:focus-within {
            border-color: #F1913D;
            box-shadow: 0 0 0 4px rgba(241, 145, 61, 0.15);
        }
        ...
        .property-search-form .form-control:hover {
            border-color: #F1913D;
            transform: translateY(-1px);
        }
        
        /* Custom scrollbar for dropdowns */
        .property-search-form .nice-select .list::-webkit-scrollbar {
            width: 6px;
        }
        
        .property-search-form .nice-select .list::-webkit-scrollbar-track {
            background: #f1f1f1;
            border-radius: 3px;
        }
        
        .property-search-form .nice-select .list::-webkit-scrollbar-thumb {
            background: #F1913D;
            border-radius: 3px;
        }
        
        .property-search-form .nice-select .list::-webkit-scrollbar-thumb:hover {
            background: #ff6b35;
        }
        
        /* Beautiful hover effects for the entire form */
        .property-search-form:hover {
            transform: translateY(-2px);
        ...
        @keyframes glow {
            ...
            50% {
                box-shadow: 0 0 0 8px rgba(241, 145, 61, 0.25);
            }
        }
        ...
        .property-search-form .tf-btn.loading {
            pointer-events: none;
            opacity: 0.7;
        }
        
        .property-search-form .tf-btn.loading::after {
            content: '';
...
<body>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="title-inner ">
                            <ul class="breadcrumb">
                                <li><a class="home fw-6 text-color-3" href="{{ route('index') }}">Home</a></li>
                                ...
                                <form class="property-search-form" method="GET" action="{{ route('properties.index') }}">
                                    <div class="row g-3 align-items-end">
                                        <div class="col-lg-3 col-md-6 col-sm-12">
                                            <fieldset>
                                                <input type="text" name="address" placeholder="Address, City, ZIP..." class="form-control" value="{{ request('address') }}">
                                            </fieldset>
                                        </div>
                                        <div class="col-lg-2 col-md-6 col-sm-12">
                                            <div class="nice-select" tabindex="0">
                                                ...
                                                <ul class="list">
                                                    <li data-value="" class="option selected">All Status</li>
                                                    <li data-value="for-sale" class="option">For Sale</li>
                                                    <li data-value="for-rent" class="option">For Rent</li>
                                                    <li data-value="sold" class="option">Sold</li>
                                                    <li data-value="rented" class="option">Rented</li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="col-lg-2 col-md-6 col-sm-12">
                                            <div class="nice-select" tabindex="0">
                                                ...
                                                <ul class="list">
                                                    <li data-value="" class="option selected">All Types</li>
                                        ...
                                        <div class="col-lg-2 col-md-6 col-sm-12">
                                            <div class="nice-select" tabindex="0">
                                                ...
                                                <ul class="list">
                                                    <li data-value="" class="option selected focus">Any Baths</li>
                                                    <li data-value="1" class="option">1 Bath</li>
                                                    <li data-value="2" class="option">2 Baths</li>
                                                    <li data-value="3" class="option">3 Baths</li>
                                                    <li data-value="4" class="option">4+ Baths</li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="col-lg-2 col-md-6 col-sm-12">
                                            <div class="nice-select" tabindex="0">
                                                ...
                                                <ul class="list">
                                                    <li data-value="" class="option selected focus">Any Beds</li>
                                                    <li data-value="1" class="option">1 Bed</li>
                                                    <li data-value="2" class="option">2 Beds</li>
                                                    <li data-value="3" class="option">3 Beds</li>
                                                    <li data-value="4" class="option">4+ Beds</li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-12 col-sm-12">
                                            <div class="wrap-btn d-flex justify-content-end">
                                                <div class="btn-filter show-form me-2">
                                                    <div class="icons">
                                                ...
                                                <button type="submit" class="tf-btn">
                                                    <span>Search <i class="icon-MagnifyingGlass fw-6"></i></span>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane active show" id="gridLayout" role="tabpanel">
                                        <div class="tf-grid-layout md-col-2">
                                            ...
                                            <div class="box-house hover-img">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1">
                                                        <img class="lazyload" data-src="{{ url('images/section/box-house-7.jpg') }}"
                                                            src="{{ url('images/section/box-house-7.jpg') }}" alt="">
                                                    </a>
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text-white">Featured
                                                        </li>
                                            ...
                                            <div class="box-house hover-img">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1">
                                                        <img class="lazyload" data-src="{{ url('images/section/box-house-8.jpg') }}"
                                                            src="{{ url('images/section/box-house-8.jpg') }}" alt="">
                                                    </a>
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text-white">Featured
                                                        </li>
                                            ...
                                            <div class="box-house hover-img">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1">
                                                        <img class="lazyload" data-src="{{ url('images/section/box-house-9.jpg') }}"
                                                            src="{{ url('images/section/box-house-9.jpg') }}" alt="">
                                                    </a>
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text-white">Featured
                                                        </li>
                                            ...
                                            <div class="box-house hover-img">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1">
                                                        <img class="lazyload" data-src="{{ url('images/section/box-house-16.jpg') }}"
                                                            src="{{ url('images/section/box-house-16.jpg') }}" alt="">
                                                    </a>
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text-white">Featured
                                                        </li>
                                ...
                                <div class="sidebar-item sidebar-location">
                                    ...
                                    <div class="wrap-box-location">
                                        <a class="box-location style-2 hover-img-rotate">
                                            <div class="image-wrap">
                                                <img class="lazyload" data-src="{{ url('images/section/location-23.jpg') }}"
                                                    src="{{ url('images/section/location-23.jpg') }}" alt="">
                                            </div>
                                            <div class="content">
                                        ...
                                        <a class="box-location style-2 hover-img-rotate">
                                            <div class="image-wrap">
                                                <img class="lazyload" data-src="{{ url('images/section/location-24.jpg') }}"
                                                    src="{{ url('images/section/location-24.jpg') }}" alt="">
                                            </div>
                                            <div class="content">
                                        ...
                                        <a class="box-location style-2 hover-img-rotate">
                                            <div class="image-wrap">
                                                <img class="lazyload" data-src="{{ url('images/section/location-25.jpg') }}"
                                                    src="{{ url('images/section/location-25.jpg') }}" alt="">
                                            </div>
                                            <div class="content">
                                        ...
                                        <a class="box-location style-2 hover-img-rotate">
                                            <div class="image-wrap">
                                                <img class="lazyload" data-src="{{ url('images/section/location-26.jpg') }}"
                                                    src="{{ url('images/section/location-26.jpg') }}" alt="">
                                            </div>
                                            <div class="content">
                                        ...
                                        <a class="box-location style-2 hover-img-rotate">
                                            <div class="image-wrap">
                                                <img class="lazyload" data-src="{{ url('images/section/location-27.jpg') }}"
                                                    src="{{ url('images/section/location-27.jpg') }}" alt="">
                                            </div>
                                            <div class="content">
                                        ...
                                        <a class="box-location style-2 hover-img-rotate">
                                            <div class="image-wrap">
                                                <img class="lazyload" data-src="{{ url('images/section/location-28.jpg') }}"
                                                    src="{{ url('images/section/location-28.jpg') }}" alt="">
                                            </div>
                                            <div class="content">
                                ...
                                <div class="sidebar-item sidebar-contact-agents">
                                    ...
                                    <div class="wrap-contact-agents">
                                        <div class="box-contact-agent">
                                            <div class="avatar">
                                                <img src="{{ url('images/avatar/avt-png19.png') }}" alt="">
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="box-contact-agent">
                                            <div class="avatar">
                                                <img src="{{ url('images/avatar/avt-png20.png') }}" alt="">
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="box-contact-agent">
                                            <div class="avatar">
                                                <img src="{{ url('images/avatar/avt-png21.png') }}" alt="">
                                            </div>
                                            <div class="content">
        ...
        <div class="offcanvas-body inner-mobile-nav">
            <div class="mb-body">
                <ul id="menu-mobile-menu">
                    ...
                    <li class="menu-item menu-item-has-children-mobile current-menu-item current-menu-item">
    ...
    <!-- Custom JavaScript for Property Filters -->
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Initialize nice-select dropdowns
            if (typeof $.fn.niceSelect !== 'undefined') {
                $('.nice-select').niceSelect();
            }
            
            // Handle form submission with filter values
            const form = document.querySelector('.property-search-form');
            const selects = form.querySelectorAll('.nice-select');
                ...
                options.forEach(option => {
                    option.addEventListener('click', function() {
                        ...
                        if (!hiddenInput) {
                            ...
                            hiddenInput.name = select.querySelector('.current').textContent.toLowerCase().replace(/\s+/g, '_');
            ...
            const filterBtn = form.querySelector('.btn-filter');
            if (filterBtn) {
                filterBtn.addEventListener('click', function() {
                    const searchForm = form.querySelector('.wd-search-form');
                    if (searchForm) {
...
<!-- Mirrored from themesflat.co/html/proty/property-gird-left-sidebar by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:13:51 GMT -->
</html>