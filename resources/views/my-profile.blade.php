...
<!-- Mirrored from themesflat.co/html/proty/my-profile by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:14:42 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
    <!--[if IE ]><meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/><![endif]-->
    <title>My Profile - Randhawa Marketing</title>
                    ...
                    <div class="widget-box-2">
                        ...
                        <div class="box">
                            ...
                            <div class="box-agent-avt">
                                <div class="avatar">
                                    <img src="{{ url('images/avatar/account.jpg') }}" alt="avatar" loading="lazy" width="128"
                                        height="128">
                                </div>
                        ...
                        <div class="box">
                            ...
                            <div class="box-agent-avt">
                                <div class="img-poster">
                                    <img src="{{ url('images/avatar/account-2.jpg') }}" alt="avatar" loading="lazy">
                                </div>
                                <div class="content uploadfile">
