...
<!-- Mirrored from themesflat.co/html/proty/home04 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:13:33 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
...
<body class="theme-color-3">
    ...
    <div id="wrapper" class="counter-scroll">
            ...
            <div id="loading-center">
                <div class="loader-container">
                    <div class="wrap-loader">
                        ...
                        <div class="icon">
                            <img src="{{ url('images/logo/loading-4.png') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="top-bar-inner">
                            <ul class="top-bar-info">
                                <li>
                                    ...
                                    <p>Phone: <span class="fw-7">0333-1929762</span></p>
                                </li>
                                <li>
                                    <i class="icon-mail"></i>
                                    <p>Email: <a href="#">info@randhawamarketing.com</a></p>
                                </li>
                            </ul>
                            ...
                            <div class="header-inner-wrap">
                                <div class="header-logo">
                                    <a href="index" class="site-logo">
                                        <img id="logo_header" alt="" src="{{ url('images/logo/logo-5%402x.png') }}">
                                    </a>
                                </div>
                                <nav class="main-menu">
                                    <ul class="navigation ">
                                        <li class="has-child current-menu"><a href="#">Home</a>
                                            <ul class="submenu">
                                                ...
                                                <li class="current-item"><a href="home04">Home Page 04</a></li>
                                        ...
                                        <li class="has-child current"><a href="#">Blog</a>
                                            <ul class="submenu">
                                                <li class="current"><a href="blog-list">Blog List</a></li>
        ...
        <div class="page-title home04">
            <div class="tf-container">
                <div class="row">
                    <div class="col-12">
                        <div class="content-inner">
                            <div class="heading-title">
                                <h1 class="title">Serving Los Angele</h1>
                                <p class="h6 fw-4">Trusted Advisors Delivering Results
                                </p>
                            </div>
        ...
        <div class="main-content">
                                ...
                                <div class="wrap-counter">
                                    <div class="counter-item style-2">
                                        <div class="count">
                                            ...
                                            <div class="counter-number  ">
                                                <div class="odometer style-2  style-2-1">100
                                                </div>
                                    ...
                                    <div class="counter-item style-2">
                                        <div class="count">
                                            ...
                                            <div class="counter-number ">
                                                <div class="odometer style-2 style-2-2">100
                                                </div>
                                            </div>
                                    ...
                                    <div class="counter-item style-2">
                                        <div class="count">
                                            ...
                                            <div class="counter-number ">
                                                <div class="odometer style-2 style-2-3">1
                                                </div>
                                                <span>.600</span>
                                                <span class="sub plus">+</span>
                                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="wrap-image relative ">
                                <div class="image-wrap hover-img-wrap img-1 animate__zoomIn wow animate__animated"
                                    ...
                                    <img class="lazyload parallax-img" data-src="{{ url('images/section/section-box-team.jpg') }}"
                                        src="{{ url('images/section/section-box-team.jpg') }}" alt="">
                                </div>
                                <div class="image-wrap hover-img-wrap img-2 animate__zoomIn wow animate__animated"
                                    data-wow-duration="2s">
                                    <img class="lazyload parallax-img" data-src="{{ url('images/section/section-box-team-2.jpg') }}"
                                        src="{{ url('images/section/section-box-team-2.jpg') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="tf-container">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="swiper sw-layout-3 style-pagination " data-preview="3" data-tablet="3"
                                ...
                                <div class="swiper-wrapper mb-48">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box-house hover-img">
                                            <div class="image-wrap">
                                                <a href="property-detail-v1">
                                                    <img class="lazyload" data-src="{{ url('images/section/box-house-14.jpg') }}"
                                                        src="{{ url('images/section/box-house-14.jpg') }}" alt="">
                                                </a>
                                                <ul class="box-tag flex gap-8 ">
                                                    <li class="flat-tag text-4 bg-main fw-6 text-white">
                                                        Featured</li>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box-house hover-img">
                                            <div class="image-wrap">
                                                <a href="property-detail-v1">
                                                    <img class="lazyload" data-src="{{ url('images/section/box-house-13.jpg') }}"
            ...
            <section class="section-help tf-spacing-1 pb-0">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="heading-section text-center">
                                <h2 class="title text-anime-wave">How Can We Help You?</h2>
                                <p class="text-1 wow animate__fadeInUp animate__animated" data-wow-duration="1.5s"
                                    data-wow-delay="0s">Thousands of luxury home enthusiasts just like you
                                    visit
                                    our website.
                            ...
                            <div class="tf-grid-layout md-col-2 mb-6">
                                <div class="icons-box  style-3 wow animate__zoomIn animate__animated"
                ...
                <div class="item text-center">
                    <img src="{{ url('images/section/section-help.png') }}" alt="">
                </div>
            </section>
            <!-- section-help -->
                                ...
                                <div class="swiper-wrapper mb-48 wrap-neighborhoods">
                                    <div class="swiper-slide">
                                        <div class="box-location h-450 hover-img ">
                                            ...
                                            <div class="content">
                                                <h6 class="text-white">Townhouse</h6>
                                                <a href="#"
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box-location h-450 hover-img">
                                            <div class="image-wrap">
                                                <a href="#">
                                                    <img class="lazyload" data-src="{{ url('images/section/location-21.jpg') }}"
                                                        src="{{ url('images/section/location-21.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="content">
                                                <h6 class="text-white">Villas</h6>
                                                <a href="#"
                                                    class="text-1 tf-btn style-border pd-23 text-white  tf-btn style-border pd-23">2.491
                                                    Properties <i class="icon-arrow-right"></i></a>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box-location h-450 hover-img">
                                            <div class="image-wrap">
                                                <a href="#">
                                                    <img class="lazyload" data-src="{{ url('images/section/location-22.jpg') }}"
                                                        src="{{ url('images/section/location-22.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="content">
                                                <h6 class="text-white">Apartments</h6>
                                                <a href="#"
                                                    class="text-1 tf-btn style-border pd-23 text-white  tf-btn style-border pd-23">2.491
                                                    Properties <i class="icon-arrow-right"></i></a>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="content">
                                    ...
                                    <a href="#"
                                        class="tf-btn bg-color-primary pd-11 fw-7 wow animate__fadeInUp animate__animated"
                                        data-wow-duration="1.5s" data-wow-delay="0s">
                                        Request your free appraisal
                                    </a>
                                    <div class="person wow animate__fadeInRight animate__animated"
                                        data-wow-duration="1.5s" data-wow-delay="0s">
                                        <img src="{{ url('images/section/person-1.png') }}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <!-- section-best-sale -->
            <section class="section-best-sale tf-spacing-1">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-12">
                            <div class="heading-section text-center mb-48">
                                <h2 class="title text-anime-wave">Best Properties For Sale
                                </h2>
                                <p class="text-1 text-anime-wave">Thousands of luxury home enthusiasts just like you
                                    visit
                                    our website.
                                </p>
                            </div>
                            <div class="swiper sw-layout-3 style-pagination " data-preview="3" data-tablet="2"
                                data-mobile-sm="1" data-mobile="1" data-space="15" data-space-md="20" data-space-lg="40"
                                data-speed="1000">
                                <div class="swiper-wrapper mb-48">
                                    <div class="swiper-slide">
                                        <div class="box-house hover-img ">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box-house hover-img ">
                                            <div class="image-wrap">
                                                <a href="property-detail-v1">
                                                    <img class="lazyload" data-src="{{ url('images/section/box-house-3.jpg') }}"
                                                        src="{{ url('images/section/box-house-3.jpg') }}" alt="">
                                                </a>
                                                <ul class="box-tag flex gap-8 ">
                                                    <li class="flat-tag text-4 bg-main fw-6 text-white">
                                                        Featured</li>
            ...
            <div class="section-testimonials ">
                <div class="tf-container-xxl">
                    <div class="row">
                        <div class="col-12">
                            <div class="heading-section text-center mb-48">
                                <h2 class="title text-anime-wave">What Our Clients Say?</h2>
                                <p class="text-1 wow animate__fadeInUp animate__animated" data-wow-duration="1.5s"
                                    data-wow-delay="0s">Here’s just a few reasons why homeowners are choosing
                                    Realty to sell
                                    their property.
                                </p>
                            </div>
                            <div class="swiper sw-testimonials style-pagination " data-preview="3" data-tablet="2"
                                data-mobile-sm="2" data-mobile="1" data-space="15" data-space-md="30" data-space-lg="40"
                                data-speed="1000">
                                <div class="swiper-wrapper mb-58 ">
                                    <div class="swiper-slide">
                                        <div class="wg-testimonial style-no-boder text-center">
                                            <div class="avatar">
                                                <img src="{{ url('images/avatar/testimonials-1.jpg') }}" alt="">
                                            </div>
                                            <p class="text-1 description">Lorem ipsum dolor sit amet, consectetur
                                                adipiscing elit. Vivamus sagittis, lorem in fringilla feugiat, nisi
                                                libero dapibus dui finibus luctus felis augue ac quam. Ut at egestas
                                                mauris. Nulla quis laoreet diam</p>
                                            ...
                                            <div class="author">
                                                ...
                                                <p class="text-9 lh-20">Los Angeles, CA</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
            ...
            <section class="section-work-together style-2   tf-spacing-1">
                <div class="wg-partner">
                    <div class="tf-container">
                        <div class="row">
                            <div class="col-12 wrap-partners">
                                <div class="heading-section  text-center mb-48">
                                ...
                                <div class="swiper brand-slide mb-40" data-preview="6" data-tablet="4"
                ...
                <div class="box-sale">
                    <div class="tf-container">
                        <div class="row">
                            <div class="col-12">
                                <div class="heading-section text-center mb-48 ">
                                    <h2 class="title text-white text-anime-wave">Sell Your Home With One Of <br>
                                        California’s
                                        Leading Real Estate Agencies</h2>
                                    <p class="text-1 text-white wow animate__fadeInUp animate__animated"
                                        data-wow-duration="1.5s" data-wow-delay="0s">Find a lender who can offer
                                        competitive
                                        mortgage rates
                                        and help you with pre-approval.
                                    </p>
                                </div>
                                <a href="#"
                                    class="tf-btn bg-color-primary pd-12 mx-auto fw-7 wow animate__fadeInUp animate__animated"
                                    data-wow-duration="1.5s" data-wow-delay="0s">Meet The Team</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="tf-grid-layout md-col-3">
                                <div class="icons-box  style-7 effec-icon  wow animate__zoomIn animate__animated"
                                    data-wow-duration="1s" data-wow-delay="0s">
                                    ...
                                    <h4 class="title text-center"><a href="#">Property Management</a></h4>
                                    <p class="text-center text-1">Realty real estate specialise in property management,
                                        with services that cover all aspects of residential and commercial leasing.</p>
                                    <a href="#" class="tf-btn style-border pd-6 fw-7 mx-auto">
                                        Find out more
                                    </a>
                                </div>
                                <div class="icons-box  style-7 effec-icon  wow animate__zoomIn animate__animated"
                                    ...
                                    <h4 class="title text-center"><a href="#">Rent a Home </a></h4>
                                    <p class="text-center text-1">Realty real estate specialise in property management,
                                        with services that cover all aspects of residential and commercial leasing.</p>
                                    <a href="#" class="tf-btn style-border pd-6 fw-7 mx-auto">
                                        Find out more
                                ...
                                <div class="icons-box  style-7 effec-icon  wow animate__zoomIn animate__animated"
                                    ...
                                    <h4 class="title text-center"><a href="#">Sell a Home</a></h4>
                                    <p class="text-center text-1">Realty real estate specialise in property management,
                                        with services that cover all aspects of residential and commercial leasing.</p>
                                    <a href="#" class="tf-btn style-border pd-6 fw-7 mx-auto">
                                        Find out more
                    ...
                    <div class="col-12">
                        <div class="footer-top">
                            <div class="footer-logo">
                                <a href="index">
                                    <img id="logo_footer" src="{{ url('images/logo/logo-5.1%402x.png') }}" alt="logo-footer">
                                </a>
                            </div>
    ...
    <div class="offcanvas offcanvas-start mobile-nav-wrap " tabindex="-1" id="menu-mobile"
        ...
        <div class="offcanvas-header top-nav-mobile">
            <div class="offcanvas-title">
                <a href="index"><img src="{{ url('images/logo/logo-5%402x.png') }}" alt=""></a>
            </div>
                    ...
                    <li class="menu-item menu-item-has-children-mobile current-menu-item">
                        ...
                        <div id="dropdown-menu-one" class="collapse" data-bs-parent="#menu-mobile-menu">
                            <ul class="sub-mobile ">
                                ...
                                <li class="menu-item current-item"><a href="home04">Home Page 04</a></li>
...
<!-- Mirrored from themesflat.co/html/proty/home04 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:13:36 GMT -->
</html>