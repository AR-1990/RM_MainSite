...
<!-- Mirrored from themesflat.co/html/proty/property-detail-v1 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:13:56 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
    <!--[if IE ]><meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/><![endif]-->
    <title>Property Details - Randhawa Marketing</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="main-content">
            ...
            <section class="section-property-image">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-12">
                            <div class="wrap-image">
                                <div class="image img-1">
                                    <a href="{{ url('images/section/property-detail-3.jpg') }}" data-fancybox="gallery"
                                        class="image-wrap relative d-block">
                                        <img class="lazyload" data-src="{{ url('images/section/property-detail-3.jpg') }}"
                                            src="{{ url('images/section/property-detail-3.jpg') }}" alt="">
                                    </a>
                                    <div class="tag-property ">
                                        ...
                                        <div class="text-16 text-white fw-6 lh-20">1/16 Photos</div>
                                    </div>
                                </div>
                                <div class="wrap-image-right">
                                    <div class="image img-2">
                                        <a href="{{ url('images/section/property-detail-4.jpg') }}" data-fancybox="gallery"
                                            class="image-wrap relative d-block">
                                            <img class="lazyload" data-src="{{ url('images/section/property-detail-4.jpg') }}"
                                                src="{{ url('images/section/property-detail-4.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="bot">
                                        <div class="image img-3">
                                            <a href="{{ url('images/section/property-detail-5.jpg') }}" data-fancybox="gallery"
                                                class="image-wrap relative d-block">
                                                <img class="lazyload" data-src="{{ url('images/section/property-detail-5.jpg') }}"
                                                    src="{{ url('images/section/property-detail-5.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="image img-4">
                                            <a href="{{ url('images/section/property-detail-6.jpg') }}" data-fancybox="gallery"
                                                class="image-wrap relative d-block">
                                                <img class="lazyload" data-src="{{ url('images/section/property-detail-6.jpg') }}"
                                                    src="{{ url('images/section/property-detail-6.jpg') }}" alt="">
                                            </a>
                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-7">
                                ...
                                <div class="info flex justify-between">
                                    <div class="feature">
                                        <p class="location text-1 flex items-center gap-10">
                                            <i class="icon-location"></i>102 102 Ingraham St, Brooklyn, NY 11237
                                        </p>
                            ...
                            <div class="wg-property box-property-detail">
                                ...
                                <div class="content">
                                    <p class="description text-1">3 Units in North Hollywood with upside potential
                                        through
                            ...
                            <div class="wg-property box-amenities">
                                <div class="wg-title text-11 fw-6 text-color-heading">
                            ...
                            <div class="wg-property single-property-map">
                            ...
                            <div class="wg-property single-property-floor">
                                <div class="wg-title text-11 fw-6 text-color-heading">Floor Plans</div>
                                <ul class="box-floor" id="parent-floor">
                                    <li class="floor-item">
                                        <div role="button" class="floor-header" data-bs-target="#floor-one"
                            ...
                            <div class="wg-property box-attachments">
                            ...
                            <div class="wg-property box-virtual-tour">
                            ...
                            <div class="wg-property box-loan">
                            ...
                            <div class="wg-property single-property-nearby">
                            ...
                            <div class="wg-property mb-0 box-comment">
...
<!-- Mirrored from themesflat.co/html/proty/property-detail-v1 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:14:03 GMT -->
</html>