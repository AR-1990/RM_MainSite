...
<!-- Mirrored from themesflat.co/html/proty/property-half-map-grid by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:13:52 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
        ...
        <div class="main-content">
            ...
            <section class="section-property-map ">
                ...
                <div class="content-right">
                    <div class="wg-filter relative style-3">
                        <div class="form-title style-2">
                            ...
                            <div class="wrap-btn">
                                ...
                                <a href="#" class="tf-btn bg-color-primary pd-3 pd-20">
                                    Search <i class="icon-MagnifyingGlass fw-6"></i>
                                </a>
                            </div>
                        </div>
                        <div class="wd-search-form style-2">
                    ...
                    <div class="tf-grid-layout-3 xxl-col-3 sm-col-2">
                        <div class="box-house hover-img">
                            ...
                            <div class="content">
                                ...
                                <p class="location text-1 flex items-center gap-6 line-clamp-1">
                                    <i class="icon-location"></i> 102 Ingraham St, Brooklyn...
                                </p>
                        ...
                        <div class="box-house hover-img">
                            <div class="image-wrap">
                                <a href="property-detail-v1">
                                    <img class="lazyload" data-src="{{ url('images/section/box-house-19.jpg') }}"
                                        src="{{ url('images/section/box-house-19.jpg') }}" alt="">
                                </a>
                                <ul class="box-tag flex gap-8 ">
                                    <li class="flat-tag text-4 bg-main fw-6 text-white">Featured</li>
                                    <li class="flat-tag text-4 bg-3 fw-6 text-white">For Sale</li>
                        ...
                        <div class="box-house hover-img">
                            <div class="image-wrap">
                                <a href="property-detail-v1">
                                    <img class="lazyload" data-src="{{ url('images/section/box-house-20.jpg') }}"
                                        src="{{ url('images/section/box-house-20.jpg') }}" alt="">
                                </a>
                                <ul class="box-tag flex gap-8 ">
                                    <li class="flat-tag text-4 bg-main fw-6 text-white">Featured</li>
                                    <li class="flat-tag text-4 bg-3 fw-6 text-white">For Sale</li>
                        ...
                        <div class="box-house hover-img">
                            <div class="image-wrap">
                                <a href="property-detail-v1">
                                    <img class="lazyload" data-src="{{ url('images/section/box-house-22.jpg') }}"
                                        src="{{ url('images/section/box-house-22.jpg') }}" alt="">
                                </a>
                                <ul class="box-tag flex gap-8 ">
                                    <li class="flat-tag text-4 bg-main fw-6 text-white">Featured</li>
                                    <li class="flat-tag text-4 bg-3 fw-6 text-white">For Sale</li>
...
<!-- Mirrored from themesflat.co/html/proty/property-half-map-grid by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:13:54 GMT -->
</html>