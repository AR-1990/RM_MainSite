...
<!-- Mirrored from themesflat.co/html/proty/property-half-map-list by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:13:54 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('css/map.min.css') }}" />
...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="main-content">
            ...
            <section class="section-property-map list">
                <div class="wrap-map">
                    <div id="map"></div>
                </div>
                <div class="content-right">
                    <div class="wg-filter relative style-2">
                        <div class="form-title style-2">
                            ...
                            <div class="nice-select" tabindex="0">
                                <span class="current">Bad</span>
                                <ul class="list">
                                    <li data-value="" class="option selected focus">Bad</li>
                                    <li data-value="floating" class="option">1</li>
                                    <li data-value="massage" class="option">2</li>
                                    <li data-value="floor-standing" class="option">3</li>
                                    <li data-value="built-in" class="option">4</li>
                                </ul>
                            </div>
                            <div class="nice-select" tabindex="0">
                                <span class="current">Bed</span>
                                <ul class="list">
                                    <li data-value="" class="option selected focus">Bed</li>
                                    <li data-value="twin" class="option">Twin</li>
                                    <li data-value="bunk" class="option">Bunk</li>
                                    <li data-value="kids" class="option">Kids</li>
                            ...
                            <div class="wrap-btn">
                                ...
                                <a href="#" class="tf-btn bg-color-primary fw-6 pd-10">
                    ...
                    <div class="wrap-list">
                        <div class="box-house hover-img style-list">
                            <div class="image-wrap">
                                <a href="property-detail-v1">
                                    <img class="lazyload" data-src="{{ url('images/section/box-house-list-5.jpg') }}"
                                        src="{{ url('images/section/box-house-list-5.jpg') }}" alt="">
                                </a>
                                ...
                                <div class="list-btn flex gap-8 ">
                                    ...
                                    <a href="#" class="btn-icon find hover-tooltip"><i class="icon-find-plus"></i>
                            ...
                            <div class="content">
                                ...
                                <ul class="meta-list flex">
                                    <li class="meta-item">
                                        <div class="text-1 flex"><i class="icon-bed"></i>Beds<span>4</span></div>
                                        <div class="text-1 flex"><i class="icon-sqft"></i>Sqft<span>1150</span></div>
                                    </li>
                                    <li class="meta-item">
                                        <div class="text-1 flex"><i class="icon-bath"></i>Baths<span>2</span></div>
                                        <div class="text-1 flex"><i class="icon-garage"></i>Garage<span>2</span></div>
                                    </li>
                        ...
                        <div class="box-house hover-img style-list">
                            <div class="image-wrap">
                                <a href="property-detail-v1">
                                    <img class="lazyload" data-src="{{ url('images/section/box-house-list-6.jpg') }}"
                                        src="{{ url('images/section/box-house-list-6.jpg') }}" alt="">
                                </a>
                                <ul class="box-tag flex gap-8 ">
                                    <li class="flat-tag text-4 bg-main fw-6 text-white">For Sale</li>
                                </ul>
                        ...
                        <div class="box-house hover-img style-list">
                            <div class="image-wrap">
                                <a href="property-detail-v1">
                                    <img class="lazyload" data-src="{{ url('images/section/box-house-list-7.jpg') }}"
                                        src="{{ url('images/section/box-house-list-7.jpg') }}" alt="">
                                </a>
                                <ul class="box-tag flex gap-8 ">
                                    <li class="flat-tag text-4 bg-main fw-6 text-white">For Sale</li>
                                </ul>
                        ...
                        <div class="box-house hover-img style-list">
                            <div class="image-wrap">
                                <a href="property-detail-v1">
                                    <img class="lazyload" data-src="{{ url('images/section/box-house-list-2.jpg') }}"
                                        src="{{ url('images/section/box-house-list-2.jpg') }}" alt="">
                                </a>
                                <ul class="box-tag flex gap-8 ">
                                    <li class="flat-tag text-4 bg-main fw-6 text-white">For Sale</li>
                                </ul>
    ...
    <script src="{{ url('js/map.min.js') }}"></script>
    <script src="{{ url('js/map.js') }}"></script>
    <script src="{{ url('js/rangle-slider.js') }}"></script>
...
<!-- Mirrored from themesflat.co/html/proty/property-half-map-list by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:13:56 GMT -->
</html>