...
<footer id="footer" class="footer-modern">
    <div class="fm-cta" style="--fm-cta-image: url('{{ asset('/images/dream-home/villa-night.jpg') }}');">
        <div class="fm-cta-inner">
            ...
            <a href="{{ route('properties.index') }}" class="fm-btn">
                Explore Homes
            </a>
        </div>
    </div>
        ...
        <div class="fm-container">
            <div class="fm-top">
                <div class="fm-brand-col">
                    <a href="{{ route('index') }}" class="fm-logo" aria-label="Randhawa Marketing">
                ...
                <div class="fm-cols">
                    <div class="fm-col">
                        ...
                        <ul>
                            ...
                            <li><a href="{{ route('properties.index') }}">Listings</a></li>
            ...
            <div class="fm-newsletter">
                ...
                <form id="newsletter-form" class="fm-newsletter-form" method="POST" action="{{ route('subscribe.store') }}">
                    @csrf
            ...
            <div class="fm-legal">
                <p>© {{ date('Y') }} Randhawa Marketing // All rights reserved</p>
                <p><a href="{{ route('contact') }}">We respect your <u>privacy</u></a></p>
