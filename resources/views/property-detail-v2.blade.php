...
<!-- Mirrored from themesflat.co/html/proty/property-detail-v2 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:14:03 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
                            ...
                            <div class="swiper sw-thumbs-sigle " data-preview="1" data-space="0" data-speed="1000">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="{{ url('images/section/property-details-v2-1.jpg') }}" data-fancybox="gallery"
                                            class="image-wrap relative d-block">
                                            <img class="lazyload" data-src="{{ url('images/section/property-details-v2-1.jpg') }}"
                                                src="{{ url('images/section/property-details-v2-1.jpg') }}" alt="">
                                    ...
                                    <div class="swiper-slide">
                                        <a href="{{ url('images/section/property-details-v3-1.jpg') }}" data-fancybox="gallery"
                                            class="image-wrap d-block">
                                            <img class="lazyload" data-src="{{ url('images/section/property-details-v3-1.jpg') }}"
                                                src="{{ url('images/section/property-details-v3-1.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="{{ url('images/section/property-details-v3-2.jpg') }}" data-fancybox="gallery"
                                            class="image-wrap d-block">
                                            <img class="lazyload" data-src="{{ url('images/section/property-details-v3-2.jpg') }}"
                                                src="{{ url('images/section/property-details-v3-2.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="{{ url('images/section/property-details-v3-3.jpg') }}" data-fancybox="gallery"
                                            class="image-wrap d-block">
                                            <img class="lazyload" data-src="{{ url('images/section/property-details-v3-3.jpg') }}"
                                                src="{{ url('images/section/property-details-v3-3.jpg') }}" alt="">
                                        </a>

                                    </div>
                                    <div class="swiper-slide">
                                        <a href="{{ url('images/section/property-details-v3-4.jpg') }}" data-fancybox="gallery"
                                            class="image-wrap d-block">

                                            <img class="lazyload" data-src="{{ url('images/section/property-details-v3-4.jpg') }}"
                                                src="{{ url('images/section/property-details-v3-4.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="{{ url('images/section/property-details-v3-5.jpg') }}" data-fancybox="gallery"
                                            class="image-wrap d-block">
                                            <img class="lazyload" data-src="{{ url('images/section/property-details-v3-5.jpg') }}"
...
<!-- Mirrored from themesflat.co/html/proty/property-detail-v2 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:14:07 GMT -->
</html>