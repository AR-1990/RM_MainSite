...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" href="{{ asset('/icons/favicon.svg') }}" />
</head>
...
<body class="popup-loader home-hero-redesign">
    ...
    <div id="wrapper">
                            ...
                            <div class="header-inner-wrap">
                                <div class="header-logo">
                                    <a href="index" class="site-logo">
                                        <img id="logo_header" alt="" src="{{ asset('/images/logo/logo@2x.png') }}">
                                    </a>
                                </div>
                                <nav class="main-menu">
                                    <ul class="navigation ">
                                        <li class="has-child current-menu"><a href="#">Home</a>
                                            <ul class="submenu">
                                                <li class="current-item"><a href="index">Home Page 01</a></li>
        ...
        <div class="page-title home01 hero-eastate">
            <div class="hero-shell">
                <div class="hero-panel" style="background-image: url('{{ asset('/images/section/hero-background.png') }}');">
                    ...
                    <div class="hero-content">
                        ...
                        <div class="hero-search-wrap">
                            <div class="hero-search-card">
                                ...
                                <form action="{{ route('properties.index') }}" method="GET" id="property-search-form" class="hero-search-form">
                                    ...
                                    <div class="hero-search-bar">
                                        ...
                                        <div class="hero-field">
                                            ...
                                            <input type="text" id="hero-location" name="search" placeholder="e.g Islamabad, Bahria Enclave" value="{{ request('search') }}">
                                        </div>
                                    ...
                                    <div class="hero-popular">
                                        ...
                                        <div class="hero-popular-tags">
                                            @foreach($categories->take(4) as $popular)
                                                <a class="hero-popular-tag" href="{{ route('properties.index', ['category' => $popular->id, 'status' => 'for_sale']) }}">{{ $popular->name }}</a>
                                            @endforeach
                                        </div>
                                    </div>
                                @endif
        ...
        <div class="main-content ">
                        ...
                        <div class="dream-home-left">
                            <h2 class="dream-home-title">
                                <span class="dream-home-title-row">
                                    ...
                                    <span class="dream-home-inline-pill" aria-hidden="true">
                                        <img src="{{ asset('/images/dream-home/villa-night.jpg') }}" alt="">
                                    </span>
                                    <span class="dream-home-inline-circle" aria-hidden="true">
                                        <img src="{{ asset('/images/dream-home/apartment.jpg') }}" alt="">
                                    </span>
                                </span>
                            ...
                            <div class="dream-home-copy">
                                <div class="dream-home-avatars" aria-hidden="true">
                                    ...
                                    <img src="{{ asset('/images/avatar/avt-png10.png') }}" alt="">
                                </div>
                                ...
                                <a href="{{ route('contact') }}" class="dream-home-cta">Contact us</a>
                            </div>
                        </div>
                            ...
                            <div class="dream-home-gallery" data-dream-gallery>
                                <div class="dream-home-track" data-dream-track>
                                    <article class="dream-home-slide is-active">
                                        <img src="{{ asset('/images/dream-home/concrete-3882638.jpg') }}" alt="Modern concrete residence">
                                    </article>
                                    <article class="dream-home-slide">
                                        <img src="{{ asset('/images/dream-home/modern-house.jpg') }}" alt="Contemporary luxury home">
                                    </article>
                                    <article class="dream-home-slide">
                                        <img src="{{ asset('/images/dream-home/coastal-house.jpg') }}" alt="Coastal property">
                                    </article>
                                    <article class="dream-home-slide">
                                        <img src="{{ asset('/images/dream-home/glass-house.jpg') }}" alt="Glass architecture home">
                                    </article>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="ptype-shell">
                        ...
                        <div class="ptype-list" data-ptype-list>
                            @forelse($categoriesWithCounts as $category)
                                <div class="ptype-bar{{ $loop->first ? ' is-active' : '' }}" data-ptype-bar data-ptype-id="{{ $category->id }}">
                                    <h3 class="ptype-name">{{ $category->name }}</h3>
                                    <a href="{{ route('properties.index', ['category' => $category->id]) }}" class="ptype-more">
                                        View all
                            ...
                            @if($categoriesWithCounts->isNotEmpty())
                                <div class="ptype-stage" data-ptype-stage>
                                    @foreach($categoriesWithCounts as $category)
                                        <div class="ptype-panel{{ $loop->first ? ' is-active' : '' }}" data-ptype-panel="{{ $category->id }}">
                                            @if($category->previewProperties->isNotEmpty())
                                                <div class="ptype-grid">
                                                    @foreach($category->previewProperties as $property)
                                                        @php
                                                        ...
                                                        @endphp
                                                        <a href="{{ route('properties.show', $property->id) }}" class="ptype-card">
                                                            <div class="ptype-card-media">
                                                                ...
                                                                @if($specs)
                                                                    <span class="ptype-specs">{{ $specs }}</span>
                                                                @endif
                                                            </div>
                                                            <div class="ptype-card-body">
                                                                <div class="ptype-card-top">
                                                                    <h4>{{ \Illuminate\Support\Str::limit($property->title, 48) }}</h4>
                                                                    <span class="ptype-price">{{ $property->display_price }}</span>
                                                                </div>
                                                                <p class="ptype-loc">
                                                                    <i class="icon-location"></i>
                                                                    <span>{{ $property->city }}@if($property->full_address), {{ \Illuminate\Support\Str::limit($property->full_address, 55) }}@endif</span>
                                                                </p>
                                                            </div>
                                                        </a>
                                                    @endforeach
                                            ...
                                            @else
                                                <div class="ptype-empty">
                                                    ...
                                                    <a href="{{ route('properties.index', ['category' => $category->id]) }}">Browse properties</a>
                                                </div>
                                            @endif
                                        </div>
                                    @endforeach
            ...
            <section class="section-help section-help-hscroll" data-help-hscroll>
                    ...
                    <div class="help-h-stage" data-help-stage>
                        <div class="help-h-slide is-active" data-help-slide>
                            <article class="help-h-panel">
                                <div class="help-h-media">
                                    <img src="{{ asset('/images/dream-home/concrete-3882638.jpg') }}" alt="Property rating">
                                </div>
                                <div class="help-h-copy">
                                    ...
                                    <a href="{{ route('properties.index') }}" class="help-h-cta">Explore properties</a>
                                </div>
                            </article>
                        </div>
                        ...
                        <div class="help-h-slide" data-help-slide>
                            <article class="help-h-panel is-reverse">
                                <div class="help-h-media">
                                    <img src="{{ asset('/images/dream-home/modern-house.jpg') }}" alt="Buying guidance">
                                </div>
                                <div class="help-h-copy">
                                    ...
                                    <a href="{{ route('contact') }}" class="help-h-cta">Talk to an advisor</a>
                                </div>
                            </article>
                        </div>
                        ...
                        <div class="help-h-slide" data-help-slide>
                            <article class="help-h-panel">
                                <div class="help-h-media">
                                    <img src="{{ asset('/images/dream-home/coastal-house.jpg') }}" alt="Selling support">
                                </div>
                                <div class="help-h-copy">
                                    ...
                                    <a href="{{ route('contact') }}" class="help-h-cta">Start selling</a>
                                </div>
                            </article>
                        </div>
                    </div>
                ...
                <div class="tf-container">
                    <p class="help-h-footnote">
                        ...
                        <a href="{{ route('contact') }}">Let’s chat</a>
                    </p>
                </div>
                ...
                <div class="tf-container">
                    <div class="loan-shell">
                        <div class="loan-visual">
                            <img src="{{ asset('/images/section/section-pre-approved.jpg') }}" alt="Get pre-approved for a home loan">
                        ...
                        <div class="loan-panel">
                            ...
                            <form class="loan-form form-pre-approved" action="#" method="get">
                                ...
                                <div class="loan-actions">
                                    <a href="{{ route('contact') }}" class="loan-link">Talk to an advisor</a>
            ...
            <section class="section-neighborhoods section-neighborhoods-modern">
                <div class="tf-container">
                    ...
                    <div class="nbh-grid">
                        <a href="{{ route('properties.index') }}" class="nbh-card">
                            <img src="{{ asset('/images/section/location-9.jpg') }}" alt="Multan">
                        ...
                        <a href="{{ route('properties.index') }}" class="nbh-card">
                            <img src="{{ asset('/images/section/location-10.jpg') }}" alt="Islamabad">
                            <span class="nbh-shade"></span>
                            <span class="nbh-body">
                        ...
                        <a href="{{ route('properties.index') }}" class="nbh-card">
                            <img src="{{ asset('/images/section/location-11.jpg') }}" alt="Lahore">
                            <span class="nbh-shade"></span>
                            <span class="nbh-body">
                        ...
                        <a href="{{ route('properties.index') }}" class="nbh-card nbh-card--wide">
                            <img src="{{ asset('/images/section/location-13.jpg') }}" alt="Karachi">
                            <span class="nbh-shade"></span>
                            <span class="nbh-body">
                        ...
                        <a href="{{ route('properties.index') }}" class="nbh-card nbh-card--wide">
                            <img src="{{ asset('/images/section/location-14.jpg') }}" alt="Rawalpindi">
                            <span class="nbh-shade"></span>
                            <span class="nbh-body">
            ...
            <section class="section-listing section-open-houses">
                <div class="tf-container">
                    <div class="oh-top">
                        ...
                        <a href="{{ route('properties.index') }}" class="oh-explore">
                            Explore listings
                        </a>
                    </div>

                    <div class="oh-grid">
                        @forelse($openHousesProperties as $property)
                            @php
                                $img = $property->primary_image
                                    ? asset('/' . ltrim($property->primary_image, '/'))
                            ...
                            @endphp
                            <a href="{{ route('properties.show', $property->id) }}" class="oh-card">
                                <img class="oh-card-img" src="{{ $img }}" alt="{{ $property->title }}" loading="lazy">
                                <span class="oh-card-shade" aria-hidden="true"></span>
                                <div class="oh-card-content">
                                    <div class="oh-card-head">
                                        <span class="oh-status">{{ $statusBit }}</span>
                                        <span class="oh-type">{{ $typeLabel }}</span>
                                    </div>
                                    <strong class="oh-price">{{ $property->display_price }}</strong>
                                    @if(count($meta))
                                        <p class="oh-meta">{{ implode('  ·  ', $meta) }}</p>
                                    @endif
                                    <p class="oh-address">{{ $property->full_address ?: $property->city }}</p>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="content">
                                    ...
                                    <a href="{{ route('contact') }}" class="partners-appraisal-cta">
                                        Request your free appraisal
                                    </a>
                                    <div class="person wow animate__fadeInRight animate__animated"
                                        data-wow-duration="2s">
                                        <img src="{{ asset('/images/section/person-1.png') }}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section class="section-opinion section-insight-modern">
                <div class="tf-container">
                    <div class="insight-top">
                        ...
                        <a href="{{ route('blog.index') }}" class="insight-view-all">View all stories</a>
                    </div>

                    <div class="insight-layout">
                        <article class="insight-feature">
                            <a href="{{ route('blog.index') }}" class="insight-feature-media">
                                <img src="{{ asset('/images/blog/blog-grid-1.jpg') }}" alt="Building gains into housing stocks">
                            </a>
                            <div class="insight-feature-copy">
                                ...
                                <h3>
                                    <a href="{{ route('blog.index') }}">Building gains into housing stocks and how to trade the cycle with clarity</a>
                                </h3>
                                <p>A practical look at timing, risk, and what local demand signals actually mean before you commit capital.</p>
                                <a href="{{ route('blog.index') }}" class="insight-link">Continue reading</a>
                            </div>
                        </article>

                        <div class="insight-stack">
                            <article class="insight-item">
                                <a href="{{ route('blog.index') }}" class="insight-item-media">
                                    <img src="{{ asset('/images/blog/blog-grid-2.jpg') }}" alt="Market news briefing">
                                </a>
                                <div class="insight-item-copy">
                                    ...
                                    <h3>
                                        <a href="{{ route('blog.index') }}">What this week’s listings reveal about buyer confidence</a>
                                    </h3>
                                    <a href="{{ route('blog.index') }}" class="insight-link">Continue reading</a>
                                </div>
                            </article>
                            ...
                            <article class="insight-item">
                                <a href="{{ route('blog.index') }}" class="insight-item-media">
                                    <img src="{{ asset('/images/blog/blog-grid-3.jpg') }}" alt="Homeowner guidance">
                                </a>
                                <div class="insight-item-copy">
                                    <div class="insight-meta">
                                        <span>Guidance</span>
                                    ...
                                    <h3>
                                        <a href="{{ route('blog.index') }}">How to prepare a home for stronger offers without overspending</a>
                                    </h3>
                                    <a href="{{ route('blog.index') }}" class="insight-link">Continue reading</a>
                                </div>
                            </article>
                        ...
                        <div class="tm-col is-slow">
                            <div class="tm-col-track">
                                    <article class="tm-card">
                                        ...
                                        <div class="tm-author">
                                            <img src="{{ asset('/images/avatar/testimonials-4.jpg') }}" alt="Annette Black">
                                            <div>
                                    ...
                                    <article class="tm-card">
                                        ...
                                        <div class="tm-author">
                                            <img src="{{ asset('/images/avatar/avt-png7.png') }}" alt="Eleanor Pena">
                                            <div>
                                    ...
                                    <article class="tm-card">
                                        ...
                                        <div class="tm-author">
                                            <img src="{{ asset('/images/avatar/avt-png5.png') }}" alt="Cody Fisher">
                                            <div>
                                    ...
                                    <article class="tm-card">
                                        ...
                                        <div class="tm-author">
                                            <img src="{{ asset('/images/avatar/avt-png6.png') }}" alt="Theresa Webb">
                                            <div>
                        ...
                        <div class="tm-col is-mid">
                            <div class="tm-col-track">
                                    <article class="tm-card">
                                        ...
                                        <div class="tm-author">
                                            <img src="{{ asset('/images/avatar/avt-png8.png') }}" alt="Jerome Bell">
                                            <div>
                                    ...
                                    <article class="tm-card">
                                        ...
                                        <div class="tm-author">
                                            <img src="{{ asset('/images/avatar/avt-png9.png') }}" alt="Kristin Watson">
                                            <div>
                                    ...
                                    <article class="tm-card">
                                        ...
                                        <div class="tm-author">
                                            <img src="{{ asset('/images/avatar/avt-png4.png') }}" alt="Devon Lane">
                                            <div>
                                    ...
                                    <article class="tm-card">
                                        ...
                                        <div class="tm-author">
                                            <img src="{{ asset('/images/avatar/avt-png10.png') }}" alt="Cameron Williamson">
                                            <div>
                        ...
                        <div class="tm-col is-fast">
                            <div class="tm-col-track">
                                    <article class="tm-card">
                                        ...
                                        <div class="tm-author">
                                            <img src="{{ asset('/images/avatar/avt-png11.png') }}" alt="Leslie Alexander">
                                            <div>
                                    ...
                                    <article class="tm-card">
                                        ...
                                        <div class="tm-author">
                                            <img src="{{ asset('/images/avatar/avt-png12.png') }}" alt="Jane Cooper">
                                            <div>
                                    ...
                                    <article class="tm-card">
                                        ...
                                        <div class="tm-author">
                                            <img src="{{ asset('/images/avatar/avt-png13.png') }}" alt="Robert Fox">
                                            <div>
                                    ...
                                    <article class="tm-card">
                                        ...
                                        <div class="tm-author">
                                            <img src="{{ asset('/images/avatar/avt-png14.png') }}" alt="Brooklyn Simmons">
                                            <div>
            ...
            <div class="modal-content">
                <div class="flat-account">
                    <div class="banner-account">
                        <img src="{{ asset('/images/section/banner-login.jpg') }}" alt="banner">
                    </div>
    ...
    <div class="modal modal-account fade" id="modalRegister">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="flat-account">
                    <div class="banner-account">
                        <img src="{{ asset('/images/section/banner-register.jpg') }}" alt="banner">
                    </div>
                    <form class="form-account">
                        <div class="title-box">
                            <h4>Register</h4>
    ...
    <div class="offcanvas offcanvas-start mobile-nav-wrap " tabindex="-1" id="menu-mobile"
        ...
        <div class="offcanvas-header top-nav-mobile">
            <div class="offcanvas-title">
                <a href="index"><img src="{{ asset('/images/logo/logo%402x.png') }}" alt=""></a>
            </div>
    ...
    <script type="text/javascript" src="{{ asset('/js/simpleParallaxVanilla.umd.js') }}"></script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (searchForm) {
                searchForm.addEventListener('submit', function(e) {
                    ...
                    const propertiesasset = '{{ route("properties.index") }}';
