...
<head>
  ...
  <link rel="stylesheet" href="{{ url('assets-admin/bundles/morris/morris.css') }}">
  <!-- Template CSS -->
...
<!-- JS Libraries -->
<script src="{{ url('assets-admin/bundles/morris/morris.min.js') }}"></script>
<script src="{{ url('assets-admin/bundles/morris/raphael-min.js') }}"></script>
<!-- Page Specific JS File -->
<script src="{{ url('assets-admin/js/page/chart-morris.js') }}"></script>
<!-- Template JS File -->
