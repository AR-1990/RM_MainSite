...
<head>
  ...
  <link rel="stylesheet" href="{{ url('assets-admin/assets/bundles/bootstrap-daterangepicker/daterangepicker.css') }}">
  <link rel="stylesheet" href="{{ url('assets-admin/assets/bundles/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css') }}">
  <link rel="stylesheet" href="{{ url('assets-admin/assets/bundles/select2/dist/css/select2.min.css') }}">
  <link rel="stylesheet" href="{{ url('assets-admin/assets/bundles/jquery-selectric/selectric.css') }}">
  <link rel="stylesheet" href="{{ url('assets-admin/assets/bundles/bootstrap-timepicker/css/bootstrap-timepicker.min.css') }}">
  <link rel="stylesheet" href="{{ url('assets-admin/assets/bundles/bootstrap-tagsinput/dist/bootstrap-tagsinput.css') }}">
  <!-- Template CSS -->
                        ...
                        <div class="col-6 col-sm-4">
                          <label class="imagecheck mb-4">
                            ...
                            <span class="imagecheck-figure">
                              <img src="{{ url('assets-admin/assets/img/blog/img01.png') }}" alt="}" class="imagecheck-image">
                            </span>
                          </label>
                        </div>
                        <div class="col-6 col-sm-4">
                          <label class="imagecheck mb-4">
                            ...
                            <span class="imagecheck-figure">
                              <img src="{{ url('assets-admin/assets/img/blog/img02.png') }}" alt="}" class="imagecheck-image">
                            </span>
                          </label>
                        </div>
                        <div class="col-6 col-sm-4">
                          <label class="imagecheck mb-4">
                            ...
                            <span class="imagecheck-figure">
                              <img src="{{ url('assets-admin/assets/img/blog/img03.png') }}" alt="}" class="imagecheck-image">
                            </span>
                          </label>
                        </div>
                        <div class="col-6 col-sm-4">
                          <label class="imagecheck mb-4">
                            ...
                            <span class="imagecheck-figure">
                              <img src="{{ url('assets-admin/assets/img/blog/img04.png') }}" alt="}" class="imagecheck-image">
                            </span>
                          </label>
                        </div>
                        <div class="col-6 col-sm-4">
                          <label class="imagecheck mb-4">
                            ...
                            <span class="imagecheck-figure">
                              <img src="{{ url('assets-admin/assets/img/blog/img05.png') }}" alt="}" class="imagecheck-image">
                            </span>
                          </label>
                        </div>
                        <div class="col-6 col-sm-4">
                          <label class="imagecheck mb-4">
                            ...
                            <span class="imagecheck-figure">
                              <img src="{{ url('assets-admin/assets/img/blog/img06.png') }}" alt="}" class="imagecheck-image">
                            </span>
                          </label>
                        </div>
                      </div>
