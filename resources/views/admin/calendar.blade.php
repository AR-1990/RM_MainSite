...
<head>
  ...
  <link rel="stylesheet" href="{{ url('assets-admin/bundles/fullcalendar/fullcalendar.min.css') }}">
  <!-- Template CSS -->
...
<body>
  ...
  <!-- JS Libraies -->
  <script src="{{ url('assets-admin/bundles/fullcalendar/fullcalendar.min.js') }}"></script>
  <!-- Page Specific JS File -->
  <script src="{{ url('assets-admin/js/page/calendar.js') }}"></script>
  <!-- Template JS File -->
