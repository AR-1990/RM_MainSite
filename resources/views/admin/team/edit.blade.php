    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{ route('admin.team.show', $teamMember->id) }}">{{ $teamMember->name }}</a></div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Edit Team Member Information</h4>
                    </div>
                    <div class="card-body">
                        <form id="team-member-form" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="bio" name="bio" rows="4" placeholder="Tell us about this team member...">{{ $teamMember->bio }}</textarea>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" class="form-control" id="phone" name="phone" value="{{ $teamMember->phone }}">
                                                <div class="invalid-feedback"></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="experience_years" name="experience_years" value="{{ $teamMember->experience_years }}" min="0" max="50">
                                                <div class="invalid-feedback"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="sort_order" name="sort_order" value="{{ $teamMember->sort_order ?? 0 }}" min="0">
                                                <div class="invalid-feedback"></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="education" name="education" rows="3" placeholder="Educational background...">{{ $teamMember->education }}</textarea>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                        ...
                                        <div id="expertise-container">
                                            @if($teamMember->expertise && count($teamMember->expertise) > 0)
                                                ...
                                                <div class="input-group mb-2">
                                                    <input type="text" class="form-control" name="expertise[]" value="{{ $expertise }}" placeholder="e.g., Real Estate, Property Management">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="certifications-container">
                                            @if($teamMember->certifications && count($teamMember->certifications) > 0)
                                                ...
                                                <div class="input-group mb-2">
                                                    <input type="text" class="form-control" name="certifications[]" value="{{ $certification }}" placeholder="e.g., Licensed Real Estate Agent">
                                                    <div class="input-group-append">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="achievements-container">
                                            @if($teamMember->achievements && count($teamMember->achievements) > 0)
                                                ...
                                                <div class="input-group mb-2">
                                                    <input type="text" class="form-control" name="achievements[]" value="{{ $achievement }}" placeholder="e.g., Top Sales Agent 2023">
                                                    <div class="input-group-append">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="image-preview-container">
                                            <div class="image-preview" id="image-preview">
                                                @if($teamMember->image)
                                                    <img src="{{ url('' . $teamMember->image) }}" class="img-fluid rounded" style="max-height: 200px;">
                                                    <p class="text-success mt-2">Current Image</p>
                                                @else
                                            ...
                                            @if($teamMember->image)
                                                <button type="button" class="btn btn-outline-danger btn-block mt-2" id="remove-image">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-2">
                                            ...
                                            <input type="url" class="form-control" name="linkedin" value="{{ $teamMember->linkedin }}" placeholder="LinkedIn URL">
                                        </div>
                                        <div class="input-group mb-2">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fab fa-twitter text-info"></i></span>
                                            </div>
                                            <input type="url" class="form-control" name="twitter" value="{{ $teamMember->twitter }}" placeholder="Twitter URL">
                                        </div>
                                        <div class="input-group mb-2">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fab fa-facebook text-primary"></i></span>
                                            </div>
                                            <input type="url" class="form-control" name="facebook" value="{{ $teamMember->facebook }}" placeholder="Facebook URL">
                                        </div>
                                        <div class="input-group mb-2">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fab fa-instagram text-danger"></i></span>
                                            </div>
                                            <input type="url" class="form-control" name="instagram" value="{{ $teamMember->instagram }}" placeholder="Instagram URL">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" {{ $teamMember->is_active ? 'checked' : '' }}>
                            ...
                            <div class="form-group text-center">
                                ...
                                <a href="{{ route('admin.team.show', $teamMember->id) }}" class="btn btn-secondary btn-lg ml-2">
                                    <i class="fas fa-eye"></i> View Member
                                </a>
                                <a href="{{ route('admin.team.index') }}" class="btn btn-outline-secondary btn-lg ml-2">
...
$(document).ready(function() {
    ...
    $('#team-member-form').on('submit', function(e) {
        ...
        $.ajax({
            url: '{{ route("admin.team.update", $teamMember->id) }}',
            method: 'POST',
            data: formData,
            processData: false,
            contentType: false,
