  ...
  <ul class="navbar-nav navbar-right">
        ...
        <div class="dropdown-list-content dropdown-list-message">
          <a href="#" class="dropdown-item">
            <span class="dropdown-item-avatar text-white">
              <img alt="image" src="{{ url('assets-admin/img/users/user-1.png') }}" class="rounded-circle">
            </span>
          ...
          <a href="#" class="dropdown-item">
            <span class="dropdown-item-avatar text-white">
              <img alt="image" src="{{ url('assets-admin/img/users/user-2.png') }}" class="rounded-circle">
            </span>
            <span class="dropdown-item-desc">
    ...
    <li class="dropdown">
      <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
        <img alt="image" src="{{ url('assets-admin/img/user.png') }}" class="user-img-radious-style">
        <span class="d-sm-none d-lg-inline-block">{{ Auth::user()->name ?? 'Admin' }}</span>
      </a>
