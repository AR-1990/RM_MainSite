...
<head>
  ...
  <link rel="stylesheet" href="{{ url('assets-admin/assets/bundles/codemirror/lib/codemirror.css') }}">
  <link rel="stylesheet" href="{{ url('assets-admin/assets/bundles/codemirror/theme/duotone-dark.css') }}">
