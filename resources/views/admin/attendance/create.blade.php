    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Create a new attendance record for an employee</p>
            </div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="alert alert-info mt-2">
                        ...
                        Use "Save as Draft" for incomplete records, or fill in all details and use "Save Attendance Record".
                    </div>
                </div>
                <div class="card-body">
                    <form id="attendanceForm" class="form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control" id="expected_check_in" name="expected_check_in" value="09:00">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control" id="expected_check_out" name="expected_check_out" value="17:00">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="alert alert-info">
                                    <strong>Late Status:</strong> <span id="lateMinutesDisplay" class="text-success">On time</span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="alert alert-info">
                                    <strong>Overtime:</strong> <span id="overtimeDisplay" class="text-muted">No overtime</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="break_hours" name="break_hours" 
                                           step="0.5" min="0" max="24" placeholder="0.0" value="0">
                        ...
                        <div id="outdoorFields" class="row" style="display: none;">
                            <div class="col-12">
                                <hr>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="work_description" name="work_description" 
                                              rows="3" placeholder="Describe the work being done outdoors"></textarea>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="attendance_note" name="attendance_note" 
                                              rows="3" placeholder="Special notes about attendance, late reasons, or work details"></textarea>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="comments" name="comments" 
                                              rows="4" placeholder="Any additional comments or notes about this attendance record"></textarea>
...
$(document).ready(function() {
    ...
    function submitForm(isDraft = false) {
        ...
        const loadingText = isDraft ? '<i class="fas fa-spinner fa-spin"></i> Saving Draft...' : '<i class="fas fa-spinner fa-spin"></i> Saving...';
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    const title = isDraft ? 'Draft Saved' : 'Success';
                    const message = isDraft ? 'Attendance record saved as draft. You can complete it later.' : response.message;
            ...
            error: function(xhr) {
                let message = 'An error occurred while saving the attendance record.';
