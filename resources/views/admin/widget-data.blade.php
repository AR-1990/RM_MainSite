...
<head>
  ...
  <link rel="stylesheet" href="{{ url('assets-admin/assets/bundles/bootstrap-social/bootstrap-social.css') }}">
  <link rel="stylesheet" href="{{ url('assets-admin/assets/bundles/owlcarousel2/dist/assets/owl.carousel.min.css') }}">
  <link rel="stylesheet" href="{{ url('assets-admin/assets/bundles/owlcarousel2/dist/assets/owl.theme.default.min.css') }}">
  <link rel="stylesheet" href="{{ url('assets-admin/assets/bundles/summernote/summernote-bs4.css') }}">
  <!-- Template CSS -->
                ...
                <div class="card author-box card-primary">
                  <div class="card-body">
                    <div class="author-box-left">
                      <img alt="image" src="{{ url('assets-admin/assets/img/users/user-1.png') }}" class="rounded-circle author-box-picture">
                ...
                <div class="card card-danger">
                  ...
                  <div class="card-body">
                    <div class="owl-carousel owl-theme" id="users-carousel">
                      <div>
                        <div class="user-item">
                          <img alt="image" src="{{ url('assets-admin/assets/img/users/user-1.png') }}" class="img-fluid">
                      ...
                      <div>
                        <div class="user-item">
                          <img alt="image" src="{{ url('assets-admin/assets/img/users/user-2.png') }}" class="img-fluid">
                          <div class="user-details">
                      ...
                      <div>
                        <div class="user-item">
                          <img alt="image" src="{{ url('assets-admin/assets/img/users/user-3.png') }}" class="img-fluid">
                          <div class="user-details">
                      ...
                      <div>
                        <div class="user-item">
                          <img alt="image" src="{{ url('assets-admin/assets/img/users/user-4.png') }}" class="img-fluid">
                          <div class="user-details">
                      ...
                      <div>
                        <div class="user-item">
                          <img alt="image" src="{{ url('assets-admin/assets/img/users/user-5.png') }}" class="img-fluid">
                          <div class="user-details">
              ...
              <div class="col-12 col-sm-12 col-lg-5">
                <div class="card profile-widget">
                  <div class="profile-widget-header">
                    <img alt="image" src="{{ url('assets-admin/assets/img/users/user-1.png') }}" class="rounded-circle profile-widget-picture">
                ...
                <div class="card mt-4">
                  ...
                  <div class="card-body pb-0">
                    <div class="row">
                      <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                        <div class="avatar-item">
                          <img alt="image" src="{{ url('assets-admin/assets/img/users/user-1.png') }}" class="img-fluid" data-toggle="tooltip"
                            title="Ashton Cox">
                      ...
                      <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                        <div class="avatar-item">
                          <img alt="image" src="{{ url('assets-admin/assets/img/users/user-2.png') }}" class="img-fluid" data-toggle="tooltip"
                            title="John Doe">
                      ...
                      <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                        <div class="avatar-item">
                          <img alt="image" src="{{ url('assets-admin/assets/img/users/user-3.png') }}" class="img-fluid" data-toggle="tooltip"
                            title="Airi Satou">
                      ...
                      <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                        <div class="avatar-item">
                          <img alt="image" src="{{ url('assets-admin/assets/img/users/user-4.png') }}" class="img-fluid" data-toggle="tooltip"
                            title="Hasan Basri">
                          <div class="avatar-badge" title="Author" data-toggle="tooltip"><i
                              class="fas fa-pencil-alt"></i></div>
                        </div>
                    ...
                    <div class="row">
                      <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                        <div class="avatar-item">
                          <img alt="image" src="{{ url('assets-admin/assets/img/users/user-5.png') }}" class="img-fluid" data-toggle="tooltip"
                            title="Airi Satou">
                          <div class="avatar-badge" title="Editor" data-toggle="tooltip"><i class="fas fa-wrench"></i>
                          </div>
                        </div>
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <ul class="list-unstyled list-unstyled-border mb-0">
                          <li class="media">
                            <img alt="image" src="{{ url('assets-admin/assets/img/users/user-1.png') }}"
                          ...
                          <li class="media">
                            <img alt="image" src="{{ url('assets-admin/assets/img/users/user-2.png') }}"
                              class="mr-3 user-img-radious-style user-list-img" width="40">
                            <div class="media-body ml-3">
                          ...
                          <li class="media">
                            <img alt="image" src="{{ url('assets-admin/assets/img/users/user-3.png') }}"
                              class="mr-3 user-img-radious-style user-list-img" width="40">
                            <div class="media-body ml-3">
                      ...
                      <div class="col-sm-6 mt-sm-0 mt-4">
                        ...
                        <ul class="list-unstyled list-unstyled-border list-unstyled-noborder mb-0">
                          <li class="media">
                            <img alt="image" src="{{ url('assets-admin/assets/img/users/user-4.png') }}"
                              class="mr-3 user-img-radious-style user-list-img" width="40">
                            <div class="media-body ml-3">
                          ...
                          <li class="media">
                            <img alt="image" src="{{ url('assets-admin/assets/img/users/user-5.png') }}"
                              class="mr-3 user-img-radious-style user-list-img" width="40">
                            <div class="media-body ml-3">
                          ...
                          <li class="media">
                            <img alt="image" src="{{ url('assets-admin/assets/img/users/user-6.png') }}"
                              class="mr-3 user-img-radious-style user-list-img" width="40">
                            <div class="media-body ml-3">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <ul class="list-unstyled list-unstyled-border list-unstyled-noborder">
                      <li class="media">
                        <img alt="image" class="mr-3 rounded-circle" width="70" src="{{ url('assets-admin/assets/img/users/user-1.png') }}">
                      ...
                      <li class="media">
                        <img alt="image" class="mr-3 rounded-circle" width="70" src="{{ url('assets-admin/assets/img/users/user-2.png') }}">
                        <div class="media-body">
                          <div class="media-right">
                      ...
                      <li class="media">
                        <img alt="image" class="mr-3 rounded-circle" width="70" src="{{ url('assets-admin/assets/img/users/user-3.png') }}">
                        <div class="media-body">
                          <div class="media-right">
                            <div class="text-primary">Approved</div>
                          </div>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <ul class="list-unstyled user-progress list-unstyled-border list-unstyled-noborder">
                      <li class="media">
                        <img alt="image" class="mr-3 rounded-circle" width="50" src="{{ url('assets-admin/assets/img/users/user-1.png') }}">
                        <div class="media-body">
                          <div class="media-title">Cara Stevens</div>
                          <div class="text-job text-muted">Web Developer</div>
                        </div>
                      ...
                      <li class="media">
                        <img alt="image" class="mr-3 rounded-circle" width="50" src="{{ url('assets-admin/assets/img/users/user-5.png') }}">
                        <div class="media-body">
                          <div class="media-title">Ashton Cox</div>
                          <div class="text-job text-muted">Web Developer</div>
                        </div>
                      ...
                      <li class="media">
                        <img alt="image" class="mr-3 rounded-circle" width="50" src="{{ url('assets-admin/assets/img/users/user-4.png') }}">
                        <div class="media-body">
                          <div class="media-title">Sarah Smith</div>
                          <div class="text-job text-muted">Web Developer</div>
                        </div>
                  ...
                  <div class="card-body">
                    <ul class="list-unstyled list-unstyled-border">
                      ...
                      <li class="media">
                        ...
                        <img alt="image" class="mr-3 rounded-circle" width="50" src="{{ url('assets-admin/assets/img/users/user-9.png') }}">
                        <div class="media-body">
                      ...
                      <li class="media">
                        ...
                        <img alt="image" class="mr-3 rounded-circle" width="50" src="{{ url('assets-admin/assets/img/users/user-10.png') }}">
                        <div class="media-body">
                          <div class="badge badge-pill badge-danger mb-1 float-right">Not Finished</div>
                      ...
                      <li class="media">
                        ...
                        <img alt="image" class="mr-3 rounded-circle" width="50" src="{{ url('assets-admin/assets/img/users/user-8.png') }}">
                        <div class="media-body">
                          <div class="badge badge-pill badge-primary mb-1 float-right">Completed</div>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <ul class="list-unstyled list-unstyled-border">
                      ...
                      <li class="media">
                        <img alt="image" class="mr-3 rounded-circle" width="50" src="{{ url('assets-admin/assets/img/users/user-2.png') }}">
                        <div class="media-body">
                      ...
                      <li class="media">
                        <img alt="image" class="mr-3 rounded-circle" width="50" src="{{ url('assets-admin/assets/img/users/user-3.png') }}">
                        <div class="media-body">
              ...
              <div class="col-12 col-sm-6 col-lg-4">
                <div class="card gradient-bottom">
                  ...
                  <div class="card-body" id="top-5-scroll">
                    <ul class="list-unstyled list-unstyled-border">
                      <li class="media">
                        <img class="mr-3 rounded" width="55" src="{{ url('assets-admin/assets/img/products/product-3.png') }}" alt="product">
                        <div class="media-body">
                      ...
                      <li class="media">
                        <img class="mr-3 rounded" width="55" src="{{ url('assets-admin/assets/img/products/product-4.png') }}" alt="product">
                        <div class="media-body">
                          <div class="float-right">
                      ...
                      <li class="media">
                        <img class="mr-3 rounded" width="55" src="{{ url('assets-admin/assets/img/products/product-1.png') }}" alt="product">
                        <div class="media-body">
                          <div class="float-right">
                      ...
                      <li class="media">
                        <img class="mr-3 rounded" width="55" src="{{ url('assets-admin/assets/img/products/product-2.png') }}" alt="product">
                        <div class="media-body">
                          <div class="float-right">
                      ...
                      <li class="media">
                        <img class="mr-3 rounded" width="55" src="{{ url('assets-admin/assets/img/products/product-5.png') }}" alt="product">
                        <div class="media-body">
                          <div class="float-right">
