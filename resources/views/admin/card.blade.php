...
<head>
  ...
  <link rel="stylesheet" href="{{ url('assets-admin/bundles/chocolat/dist/css/chocolat.css') }}">
  <!-- Template CSS -->
...
<body>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="chocolat-parent">
                      <a href="{{ url('assets-admin/img/image-gallery/3.png') }}" class="chocolat-image" title="Just an example">
                        <div data-crop-image="285">
                          <img alt="image" src="{{ url('assets-admin/img/image-gallery/3.png') }}" class="img-fluid">
                        </div>
                      </a>
                    </div>
                  </div>
  ...
  <!-- JS Libraies -->
  <script src="{{ url('assets-admin/bundles/chocolat/dist/js/jquery.chocolat.min.js') }}"></script>
