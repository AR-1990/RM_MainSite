...
<head>
  ...
  <link rel="stylesheet" href="{{ url('assets-admin/assets/bundles/jqvmap/dist/jqvmap.min.css') }}">
  <link rel="stylesheet" href="{{ url('assets-admin/assets/bundles/flag-icon-css/css/flag-icon.min.css') }}">
  <!-- Template CSS -->
