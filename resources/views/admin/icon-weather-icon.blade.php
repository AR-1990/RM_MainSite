...
<head>
  ...
  <link rel="stylesheet" href="{{ url('assets-admin/assets/bundles/weather-icon/css/weather-icons.min.css') }}">
  <link rel="stylesheet" href="{{ url('assets-admin/assets/bundles/weather-icon/css/weather-icons-wind.min.css') }}">
  <!-- Template CSS -->
