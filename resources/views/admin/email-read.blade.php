...
<body>
                  ...
                  <div class="body">
                    <div id="mail-nav">
                      ...
                      <ul class="online-user" id="online-offline">
                        <li><a href="javascript:;"> <img alt="image" src="{{ url('assets-admin/assets/img/users/user-2.png') }}"
                              class="rounded-circle" width="35" data-toggle="tooltip" title="Sachin Pandit">
                            Sachin Pandit
                          </a></li>
                        <li><a href="javascript:;"> <img alt="image" src="{{ url('assets-admin/assets/img/users/user-1.png') }}"
                              class="rounded-circle" width="35" data-toggle="tooltip" title="Sarah Smith">
                            Sarah Smith
                          </a></li>
                        <li><a href="javascript:;"> <img alt="image" src="{{ url('assets-admin/assets/img/users/user-3.png') }}"
                              class="rounded-circle" width="35" data-toggle="tooltip" title="Airi Satou">
                            Airi Satou
                          </a></li>
                        <li><a href="javascript:;"> <img alt="image" src="{{ url('assets-admin/assets/img/users/user-4.png') }}"
                              class="rounded-circle" width="35" data-toggle="tooltip" title="Angelica Ramos	">
                            Angelica Ramos
                          </a></li>
                        <li><a href="javascript:;"> <img alt="image" src="{{ url('assets-admin/assets/img/users/user-5.png') }}"
                        ...
                        <div class="mail-sender">
                          ...
                          <div class="media">
                            <a href="#" class="table-img m-r-15">
                              <img alt="image" src="{{ url('assets-admin/assets/img/users/user-2.png') }}" class="rounded-circle" width="35"
                        ...
                        <div class="attachment-mail">
                          ...
                          <div class="row">
                            <div class="col-md-2">
                              <a href="#">
                                <img class="img-thumbnail img-responsive" alt="attachment"
                                  src="{{ url('assets-admin/assets/img/users/user-1.png') }}">
                              </a>
                            ...
                            <div class="col-md-2">
                              <a href="#">
                                <img class="img-thumbnail img-responsive" alt="attachment"
                                  src="{{ url('assets-admin/assets/img/users/user-3.png') }}">
                              </a>
                            ...
                            <div class="col-md-2">
                              <a href="#">
                                <img class="img-thumbnail img-responsive" alt="attachment"
                                  src="{{ url('assets-admin/assets/img/users/user-4.png') }}">
                              </a>
  ...
  <script src="{{ url('assets-admin/assets/bundles/ckeditor/ckeditor.js') }}"></script>
  <!-- Page Specific JS File -->
  <script src="{{ url('assets-admin/js/page/advance-table.js') }}"></script>
  <script src="{{ url('assets-admin/assets/js/page/ckeditor.js') }}"></script>
  <!-- Template JS File -->
