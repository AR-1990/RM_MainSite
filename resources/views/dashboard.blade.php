...
<!-- Mirrored from themesflat.co/html/proty/dashboard by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:14:29 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
    <!--[if IE ]><meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/><![endif]-->
    <title>Dashboard - Randhawa Marketing</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('css/jqueryui.min.css') }}" />
...
<body class="bg-dashboard">
                    ...
                    <div class="menu-box">
                        <ul class="box-menu-dashboard">
                            <li class="nav-menu-item active">
                                <a class="nav-menu-link" href="dashboard">
                            ...
                            <li class="nav-menu-item">
                                <a class="nav-menu-link" href="my-profile">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li class="nav-menu-item">
                                <a class="nav-menu-link" href="my-package">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li class="nav-menu-item">
                                <a class="nav-menu-link" href="my-favorites">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li class="nav-menu-item">
                                <a class="nav-menu-link" href="my-save-search">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li class="nav-menu-item">
                                <a class="nav-menu-link" href="review">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li class="nav-menu-item">
                                <a class="nav-menu-link" href="my-property">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li class="nav-menu-item">
                                <a class="nav-menu-link" href="add-property">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li class="nav-menu-item">
                                <a class="nav-menu-link" href="index">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            ...
                                            <tbody>
                                                <tr class="file-delete">
                                                    <td>
                                                        <div class="listing-box">
                                                            <div class="images">
                                                                <img src="{{ url('images/home/house-db-1.jpg') }}" alt="images">
                                                            </div>
                                                            <div class="content">
                                                                <div class="title"><a href="property-detail-v1"
                                                ...
                                                <tr class="file-delete">
                                                    <td>
                                                        <div class="listing-box">
                                                            <div class="images">
                                                                <img src="{{ url('images/home/house-db-2.jpg') }}" alt="images">
                                                            </div>
                                                            <div class="content">
                                                                <div class="title"><a href="property-detail-v1"
                                                ...
                                                <tr class="file-delete">
                                                    <td>
                                                        <div class="listing-box">
                                                            <div class="images">
                                                                <img src="{{ url('images/home/house-db-3.jpg') }}" alt="images">
                                                            </div>
                                                            <div class="content">
                                                                <div class="title"><a href="property-detail-v1"
                                                ...
                                                <tr class="file-delete">
                                                    <td>
                                                        <div class="listing-box">
                                                            <div class="images">
                                                                <img src="{{ url('images/home/house-db-4.jpg') }}" alt="images">
                                                            </div>
                                                            <div class="content">
                                                                <div class="title"><a href="property-detail-v1"
                                                ...
                                                <tr class="file-delete">
                                                    <td>
                                                        <div class="listing-box">
                                                            <div class="images">
                                                                <img src="{{ url('images/home/house-db-5.jpg') }}" alt="images">
                                                            </div>
                                                            <div class="content">
                                                                <div class="title"><a href="property-detail-v1"
                            ...
                            <div class="widget-box-2 mess-box mb-20">
                                ...
                                <ul class="list-mess">
                                    <li class="mess-item">
                                        <div class="user-box">
                                            <div class="avatar">
                                                <img src="{{ url('images/avatar/avt-png9.png') }}" alt="avt">
                                            </div>
                                            <div class="content">
                                    ...
                                    <li class="mess-item">
                                        <div class="user-box">
                                            <div class="avatar">
                                                <img src="{{ url('images/avatar/avt-png10.png') }}" alt="avt">
                                            </div>
                                            <div class="content">
                                    ...
                                    <li class="mess-item">
                                        <div class="user-box">
                                            <div class="avatar">
                                                <img src="{{ url('images/avatar/avt-png11.png') }}" alt="avt">
                                            </div>
                                            <div class="content">
                                    ...
                                    <li class="mess-item">
                                        <div class="user-box">
                                            <div class="avatar">
                                                <img src="{{ url('images/avatar/avt-png12.png') }}" alt="avt">
                                            </div>
                                            <div class="content">
                            ...
                            <div class="widget-box-2 mess-box">
                                ...
                                <ul class="list-mess">
                                    <li class="mess-item">
                                        <div class="user-box">
                                            <div class="avatar">
                                                <img src="{{ url('images/avatar/avt-png13.png') }}" alt="avt">
                                            </div>
                                            <div class="content">
                                    ...
                                    <li class="mess-item">
                                        <div class="user-box">
                                            <div class="avatar">
                                                <img src="{{ url('images/avatar/avt-png14.png') }}" alt="avt">
                                            </div>
                                            <div class="content">
                                    ...
                                    <li class="mess-item">
                                        <div class="user-box">
                                            <div class="avatar">
                                                <img src="{{ url('images/avatar/avt-png15.png') }}" alt="avt">
                                            </div>
                                            <div class="content">
                                    ...
                                    <li class="mess-item">
                                        <div class="user-box">
                                            <div class="avatar">
                                                <img src="{{ url('images/avatar/avt-png16.png') }}" alt="avt">
                                            </div>
                                            <div class="content">
                                    ...
                                    <li class="mess-item">
                                        <div class="user-box">
                                            <div class="avatar">
                                                <img src="{{ url('images/avatar/avt-png17.png') }}" alt="avt">
                                            </div>
                                            <div class="content">
                    ...
                    <li class="menu-item menu-item-has-children-mobile current-menu-item">
                        ...
                        <div id="dropdown-menu-four" class="collapse" data-bs-parent="#menu-mobile-menu">
                            <ul class="sub-mobile">
                                ...
                                <li class="menu-item current-item"><a href="dashboard">Dashboard</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="menu-item menu-item-has-children-mobile">
    ...
    <script type="text/javascript" src="{{ url('js/chart-init.js') }}"></script>
...
<!-- Mirrored from themesflat.co/html/proty/dashboard by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:14:36 GMT -->
</html>