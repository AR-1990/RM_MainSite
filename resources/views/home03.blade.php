...
<!-- Mirrored from themesflat.co/html/proty/home03 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:13:29 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
...
<body class="theme-color-2">
    ...
    <div id="wrapper">
            ...
            <div id="loading-center">
                <div class="loader-container">
                    <div class="wrap-loader">
                        ...
                        <div class="icon">
                            <img src="{{ url('images/logo/loading-3.png') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="header-inner-wrap">
                                <div class="header-logo">
                                    <a href="index" class="site-logo">
                                        <img id="logo_header" src="{{ url('images/logo/logo-4%402x.png') }}" alt="">
                                    </a>
                                </div>
                                <nav class="main-menu">
                                    <ul class="navigation ">
                                        <li class="has-child current-menu"><a href="#">Home</a>
                                            <ul class="submenu">
                                                ...
                                                <li class="current-item"><a href="home03">Home Page 03</a></li>
        ...
        <div class="main-content">
            ...
            <!-- section-help -->
            <section class="section-help style-2 tf-spacing-1">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class=" tf-grid-layout md-col-3 ">
                                <div class="icons-box effec-icon default ">
                                    ...
                                    <h4 class="title text-center"><a href="#">Buy a Home</a></h4>
                                    <p class="text-center text-1">Find your place with an immersive photo experience and
                                        the most listings, including things you won’t find anywhere else.</p>
                                ...
                                <div class="content">
                                    <div class="heading-section mb-32">
                                        <h2 class="title text-anime-wave">Have confidence in any
                                            market with us</h2>
                                        <p class="text-1 wow animate__fadeInUp animate__animated" data-wow-duration="1s"
                                    ...
                                    <a href="#"
                                        class="tf-btn bg-color-primary pd-19 fw-7 wow animate__fadeInUp animate__animated"
                                        data-wow-duration="1s" data-wow-delay="0s">
                                        Find your agnet today
                                    </a>
                                    <div class="person wow animate__fadeInRight animate__animated"
                                        data-wow-duration="1s" data-wow-delay="0s">
                                        <img src="{{ url('images/section/person-3.png') }}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section class="section-current-properties tf-spacing-1">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-12">
                            <div class="heading-section text-center mb-48">
                                <h2 class="title text-anime-wave">Current Properties</h2>
                                <p class="text-1 wow animate__fadeInUp animate__animated" data-wow-duration="1.5s"
                                    data-wow-delay="0s">Thousands of luxury home enthusiasts just like you
                                    visit our website.
                                </p>
                                ...
                                <div class="swiper-wrapper mb-48">
                                    <div class="swiper-slide">
                                        <div class="box-house hover-img ">
                                            ...
                                            <div class="content">
                                                ...
                                                <p class="location text-1 flex items-center tf-gap-5">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box-house hover-img ">
                                            <div class="image-wrap">
                                                <a href="property-detail-v1">
                                                    <img class="lazyload" data-src="{{ url('images/section/box-house-17.jpg') }}"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="heading-section mb-46 text-center">
                                <h2 class="title text-anime-wave">Agents Specializing In California</h2>
                                <p class="text-1 wow animate__fadeInUp animate__animated" data-wow-duration="1.5s"
                            ...
                            <div class="swiper style-pagination tf-sw-mobile-1 " data-screen="576" data-preview="1"
                                ...
                                <div class="swiper-wrapper tf-layout-mobile-sm sm-col-2 lg-col-4 mb-48">
                                    <div class="swiper-slide">
                                        <div class="agent-item style-3 hover-img ">
                                            <div class="image-wrap">
                                                <a href="agents-details">
                                                    <img class="lazyload" data-src="{{ url('images/section/agent-item-1.1.jpg') }}"
                                                        src="{{ url('images/section/agent-item-1.1.jpg') }}" alt="">
                                                </a>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="agent-item style-3 hover-img ">
                                            <div class="image-wrap">
                                                <a href="agents-details">
                                                    <img class="lazyload" data-src="{{ url('images/section/agent-item-2.1.jpg') }}"
                                                        src="{{ url('images/section/agent-item-2.1.jpg') }}" alt="">
                                                </a>
                                                <ul class="tf-social style-3">
                                                    <li><a href="#"><i class="icon-fb"></i></a></li>
                                                    <li><a href="#"><i class="icon-X"></i></a></li>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="agent-item style-3 hover-img ">
                                            <div class="image-wrap">
                                                <a href="agents-details">
                                                    <img class="lazyload" data-src="{{ url('images/section/agent-item-3.1.jpg') }}"
                                                        src="{{ url('images/section/agent-item-3.1.jpg') }}" alt="">
                                                </a>
                                                <ul class="tf-social style-3">
                                                    <li><a href="#"><i class="icon-fb"></i></a></li>
                                                    <li><a href="#"><i class="icon-X"></i></a></li>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="agent-item style-3 hover-img ">
                                            <div class="image-wrap">
                                                <a href="agents-details">
                                                    <img class="lazyload" data-src="{{ url('images/section/agent-item-4.1.jpg') }}"
                                                        src="{{ url('images/section/agent-item-4.1.jpg') }}" alt="">
                                                </a>
                                                <ul class="tf-social style-3">
                                                    <li><a href="#"><i class="icon-fb"></i></a></li>
                                                    <li><a href="#"><i class="icon-X"></i></a></li>
                                ...
                                <div class="sw-pagination sw-pagination-mb-1 text-center d-md-none d-block mb-20"></div>
                            </div>
                            <p class="text-center text-1 mb-46">Explore Property agents are here to help with all your
            ...
            <section class="section-featured tf-spacing-1">
                <div class="box-house style-list style-3">
                    <div class="image-wrap img-animation2 wow animate__animated ">
                        <a href="#" class="">
                            <img class="lazyload " data-src="{{ url('images/section/section-featured.jpg') }}"
                                src="{{ url('images/section/section-featured.jpg') }}" alt="">
                        </a>
                    </div>
                    <div class="wrap-content">
                        <div class="content">
                            ...
                            <div class="heading">
                                ...
                                <h3 class="title">
                                    <a href="property-detail-v1">Rancho Vista Verde, Santa Barbara</a>
                                </h3>
                                <ul class="meta-list flex">
                                    <li class="meta-item">
                            ...
                            <div class="author">
                                ...
                                <div class="info">
                                    ...
                                    <h6 class="name fw-6 text-color-heading "><a href="agents-details">John
                                            Smith</a></h6>
                                </div>
                            </div>
                            <div class="bot flex justify-between items-center">
                                ...
                                <div class="wrap-btn flex">
                                    ...
                                    <a href="property-detail-v1" class="tf-btn style-border pd-4">Details</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="tf-grid-layout lg-col-4 sm-col-2 mb-46">
                                ...
                                <div class="icons-box effec-icon style-2 ">
                                    ...
                                    <h5 class="title "><a href="#">We Have <br>
                                            Happy Clients</a></h5>
                ...
                <div class="tf-container">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="swiper sw-testimonials style-pagination " data-preview="2" data-tablet="2"
                                data-mobile-sm="2" data-mobile="1" data-space="15" data-space-md="30" data-space-lg="40"
                                data-speed="1000">
                                <div class="swiper-wrapper mb-48 ">
                                    <div class="swiper-slide">
                                        <div class="wg-testimonial style-4 text-center">
                                            <div class="avatar">
            ...
            <section class="section-work-together style-2  ">
                    ...
                    <div class="col-12">
                        <div class="footer-top">
                            <div class="footer-logo">
                                <a href="index">
                                    <img id="logo_footer" src="{{ url('images/logo/logo-4.1%402x.png') }}" alt="logo-footer">
                                </a>
                            </div>
    ...
    <div class="offcanvas offcanvas-start mobile-nav-wrap " tabindex="-1" id="menu-mobile"
        ...
        <div class="offcanvas-header top-nav-mobile">
            <div class="offcanvas-title">
                <a href="index"><img src="{{ url('images/logo/logo-4%402x.png') }}" alt=""></a>
            </div>
                    ...
                    <li class="menu-item menu-item-has-children-mobile current-menu-item">
                        ...
                        <div id="dropdown-menu-one" class="collapse" data-bs-parent="#menu-mobile-menu">
                            <ul class="sub-mobile ">
                                ...
                                <li class="menu-item current-item"><a href="home03">Home Page 03</a></li>
...
<!-- Mirrored from themesflat.co/html/proty/home03 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:13:33 GMT -->
</html>