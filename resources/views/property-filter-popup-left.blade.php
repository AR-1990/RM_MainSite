...
<!-- Mirrored from themesflat.co/html/proty/property-filter-popup-left by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:13:56 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
...
<body>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="box-title">
                                ...
                                <div class="right">
                                    <div class="filter-popup" data-bs-toggle="offcanvas" href="#filter-sidbar-left"
                                        role="button">
                                        Filter
                                        <div class="icons">
    ...
    <!-- .filter-sidebar -->
    <div class="offcanvas offcanvas-start offcanvas-filter" tabindex="-1" id="filter-sidbar-left"
        aria-labelledby="offcanvasLabel">
        <div class="offcanvas-header ">
            <h4 class="offcanvas-title " id="offcanvasLabel">Find Your Home</h4>
            <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <form class="wd-search-form style-4">
                <fieldset class=" box-search mb-12 mb-30">
                    <input type="text" class="form-control" required placeholder="What are you looking for..."
                        name="search" id="search" required>
                    <div class="icon ">
                        <i class="icon-search"></i>
                    </div>
                </fieldset>
                <div class="box-select style-2 mb-30">
                    <div class="nice-select" tabindex="0">
                        <span class="current">Status</span>
                        <ul class="list">
                            <li data-value="1" class="option">Rent</li>
                            <li data-value="2" class="option selected">Sale</li>
                        </ul>
                    </div>
                </div>
                <div class="group-amenities mb-30">
                    <div class=" title text-4 fw-6">Property type:</div>
                    <fieldset class="checkbox-item style-1  ">
                        <label>
                            <span class="text-4">Apartment</span>
                            <input type="checkbox">
                            <span class="btn-checkbox"></span>
                        </label>
                    </fieldset>
                    ...
                    <fieldset class="checkbox-item style-1   mt-12">
                        <label>
                            <span class="text-4">Townhouse</span>
                            <input type="checkbox">
                            <span class="btn-checkbox"></span>
                        </label>
                    </fieldset>
                    <fieldset class="checkbox-item style-1   mt-12">
                        <label>
                            <span class="text-4">Penthouse</span>
                            <input type="checkbox">
                            <span class="btn-checkbox"></span>
                        </label>
                    </fieldset>
                    <fieldset class="checkbox-item style-1   mt-12">
                        <label>
                            <span class="text-4">Commercial</span>
                            <input type="checkbox">
                            <span class="btn-checkbox"></span>
                        </label>
                    </fieldset>
                    <fieldset class="checkbox-item style-1   mt-12">
                        <label>
                            <span class="text-4">Family Home</span>
                            <input type="checkbox">
                            <span class="btn-checkbox"></span>
                        </label>
                    </fieldset>
                    <fieldset class="checkbox-item style-1  ">
                        <label>
                            <span class="text-4">Land/Plot</span>
                            <input type="checkbox">
                            <span class="btn-checkbox"></span>
                        </label>
                    </fieldset>
                </div>
                <div class="group-price mb-30">
                    <div class="widget-price">
                        <div class="box-title-price">
                            <span class="title-price">Price</span>
                            <div class="caption-price">
                                <span>from</span>
                                <span class="value fw-6" id="slider-range-value-popup-1"></span>
                                <span>to</span>
                                <span class="value fw-6" id="slider-range-value-popup-2"></span>
                            </div>
                        </div>
                        <div id="slider-range-5"></div>
                        <div class="slider-labels">
                            <div>
                                <input type="hidden" name="min-value-5" value="">
                                <input type="hidden" name="max-value-5" value="">
                            </div>
                        </div>
                    </div>
                    <div class="widget-price">
                        <div class="box-title-price">
                            ...
                            <div class="caption-price">
                                <span>from</span>
                                <span class="value fw-6" id="slider-range-value-popup-3"></span>
                                <span>to</span>
                                <span class="value fw-6" id="slider-range-value-popup-4"></span>
                            </div>
                        </div>
                        <div id="slider-range-6"></div>
                        <div class="slider-labels">
                            <div>
                                <input type="hidden" name="min-value6" value="">
                                <input type="hidden" name="max-value6" value="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="group-checkbox mb-30">
                    <div class="title" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample"
                        aria-expanded="false" aria-controls="collapseExample">
                        <div class="text-4 fw-6">Other features</div>
                    </div>
                ...
                <button type="submit" class="tf-btn bg-color-primary w-100 fw-6 mb-30">
                    ...
                    <a href="#" class="option">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                ...
                                stroke="#5C5E61" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                        Reset search
                    </a>
                    <a href="#" class="option">
