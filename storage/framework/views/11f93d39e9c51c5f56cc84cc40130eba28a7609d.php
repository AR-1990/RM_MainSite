...
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
    <title>Randhawa Marketing - Real Estate Excellence</title>

    <meta name="description"
        content="Randhawa Marketing is a leading real estate company specializing in buying, selling, and renting properties. We connect buyers and tenants with trusted property owners, offering a fast and convenient property search experience with detailed information and excellent service.">
    <meta name="keywords"
        content="Randhawa Marketing, Real Estate, Buy, Rent, Homes, Apartment, Listings, Sale, Rental, Housing, Property, Real Estate Company">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Great+Vibes&family=Manrope:wght@400;500;600;700&display=swap" rel="stylesheet">
    ...
    <link rel="apple-touch-icon-precomposed" href="<?php echo e(asset('/icons/favicon.svg')); ?>" />
</head>

<body class="popup-loader home-hero-redesign">
    <!-- wrapper -->
    <div id="wrapper">
        ...
        <!-- page-title / hero -->
        <div class="page-title home01 hero-eastate">
            <div class="hero-shell">
                <div class="hero-panel" style="background-image: url('<?php echo e(asset('/images/section/hero-background.png')); ?>');">
                    <div class="hero-panel-overlay"></div>
                    <div class="hero-content">
                        <div class="heading-title">
                            <h1 class="title">Journey To Your Perfect Home</h1>
                            <p class="hero-subtitle">Let our expert team guide you through the magic of real estate and helping you find the perfect home where your dreams take flight.</p>
                        </div>

                        <div class="hero-search-wrap">
                            <div class="hero-search-card">
                                <div class="hero-tabs" role="tablist" aria-label="Search type">
                                    <button type="button" class="hero-tab is-active" data-status="for_sale">For sale</button>
                                    <button type="button" class="hero-tab" data-status="for_rent">For rent</button>
                                </div>

                                <form action="<?php echo e(route('properties.index')); ?>" method="GET" id="property-search-form" class="hero-search-form">
                                    <input type="hidden" name="status" id="search-status" value="for_sale">

                                    <div class="hero-search-bar">
                                        <div class="hero-field">
                                            <label for="hero-category">Property Type</label>
                                            <select name="category" id="hero-category">
                                        ...
                                        <div class="hero-field">
                                            ...
                                            <input type="text" id="hero-location" name="search" placeholder="e.g Islamabad, Bahria Enclave" value="<?php echo e(request('search')); ?>">
                                        </div>

                                        <div class="hero-field hero-field-price">
                                            <label>Price Range</label>
                                            <div class="hero-price-range">
                                                <input type="number" name="min_price" min="0" placeholder="Min. Price" value="<?php echo e(request('min_price')); ?>">
                                                <span class="hero-price-sep">-</span>
                                                <input type="number" name="max_price" min="0" placeholder="Max. Price" value="<?php echo e(request('max_price')); ?>">
                                            </div>
                                        </div>
                                ...
                                <?php if(isset($categories) && $categories->count()): ?>
                                    <div class="hero-popular">
                                        <span class="hero-popular-label">Popular Search</span>
                                        <div class="hero-popular-tags">
                                            <?php $__currentLoopData = $categories->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $popular): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <a class="hero-popular-tag" href="<?php echo e(route('properties.index', ['category' => $popular->id, 'status' => 'for_sale'])); ?>"><?php echo e($popular->name); ?></a>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    </div>
                                <?php endif; ?>
        ...
        <div class="main-content ">
            ...
            <!-- Dream home intro -->
            <section class="dream-home-section" aria-label="Dream home awaits">
                <div class="tf-container dream-home-inner">
                    <div class="dream-home-layout">
                        <div class="dream-home-left">
                            <h2 class="dream-home-title">
                                <span class="dream-home-title-row">
                                    <span class="dream-home-word">Where</span>
                                    <em class="dream-home-script">Your</em>
                                    <span class="dream-home-inline-pill" aria-hidden="true">
                                        <img src="<?php echo e(asset('/images/dream-home/villa-night.jpg')); ?>" alt="">
                                    </span>
                                    <span class="dream-home-inline-circle" aria-hidden="true">
                                        <img src="<?php echo e(asset('/images/dream-home/apartment.jpg')); ?>" alt="">
                                    </span>
                                </span>
                                <span class="dream-home-title-row">dream home awaits</span>
                            </h2>

                            <div class="dream-home-copy">
                                <div class="dream-home-avatars" aria-hidden="true">
                                    <img src="<?php echo e(asset('/images/avatar/avatar-1.jpg')); ?>" alt="">
                                    <img src="<?php echo e(asset('/images/avatar/avatar-2.jpg')); ?>" alt="">
                                    <img src="<?php echo e(asset('/images/avatar/avatar-3.jpg')); ?>" alt="">
                                    <img src="<?php echo e(asset('/images/avatar/avt-png10.png')); ?>" alt="">
                                </div>
                                <p class="dream-home-text">
                                    Discover a world where each architectural marvel &amp; every opulent interior come to life.
                                    Welcome to the height of luxury real estate, where your dreams find their home
                                </p>
                                <a href="<?php echo e(route('contact')); ?>" class="dream-home-cta">Contact us</a>
                            </div>
                        </div>

                        <div class="dream-home-right">
                            <div class="dream-home-nav" role="group" aria-label="Gallery controls">
                                <button type="button" class="dream-home-nav-btn" data-dream-prev aria-label="Previous image">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                                        <path d="M15 18l-6-6 6-6" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                </button>
                                <button type="button" class="dream-home-nav-btn" data-dream-next aria-label="Next image">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                            ...
                            <div class="dream-home-gallery" data-dream-gallery>
                                <div class="dream-home-track" data-dream-track>
                                    <article class="dream-home-slide is-active">
                                        <img src="<?php echo e(asset('/images/dream-home/concrete-3882638.jpg')); ?>" alt="Modern concrete residence">
                                    </article>
                                    <article class="dream-home-slide">
                                        <img src="<?php echo e(asset('/images/dream-home/modern-house.jpg')); ?>" alt="Contemporary luxury home">
                                    </article>
                                    <article class="dream-home-slide">
                                        <img src="<?php echo e(asset('/images/dream-home/coastal-house.jpg')); ?>" alt="Coastal property">
                                    </article>
                                    <article class="dream-home-slide">
                                        <img src="<?php echo e(asset('/images/dream-home/glass-house.jpg')); ?>" alt="Glass architecture home">
                                    </article>
                                </div>
                            </div>
                        </div>
            ...
            <div class="home-theme-band">
            <!-- Browse by Property Type (hover reveals listings) -->
            <section class="section-ptype-browse">
                <div class="tf-container">
                    <div class="ptype-shell">
                        <div class="ptype-heading text-center">
                            <h2>Browse by Property Type</h2>
                            <p>Discover homes across every category curated for how you want to live.</p>
                        </div>

                        <div class="ptype-list" data-ptype-list>
                            <?php $__empty_1 = true; $__currentLoopData = $categoriesWithCounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="ptype-bar<?php echo e($loop->first ? ' is-active' : ''); ?>" data-ptype-bar data-ptype-id="<?php echo e($category->id); ?>">
                                    <h3 class="ptype-name"><?php echo e($category->name); ?></h3>
                                    <a href="<?php echo e(route('properties.index', ['category' => $category->id])); ?>" class="ptype-more">
                                        View all
                                        <i class="icon-arrow-right"></i>
                                    </a>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <div class="ptype-empty">
                                    <p>No property categories available.</p>
                                </div>
                            <?php endif; ?>

                            <?php if($categoriesWithCounts->isNotEmpty()): ?>
                                <div class="ptype-stage" data-ptype-stage>
                                    <?php $__currentLoopData = $categoriesWithCounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="ptype-panel<?php echo e($loop->first ? ' is-active' : ''); ?>" data-ptype-panel="<?php echo e($category->id); ?>">
                                            <?php if($category->previewProperties->isNotEmpty()): ?>
                                                <div class="ptype-grid">
                                                    <?php $__currentLoopData = $category->previewProperties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php
                                                            $img = $property->primary_image
                                                                ? asset('/' . ltrim($property->primary_image, '/'))
                                                                : asset('/images/section/box-house.jpg');
                                                            $bedBath = [];
                                                            if ($property->bedrooms > 0) {
                                                                $bedBath[] = $property->bedrooms . ' bed';
                                                            }
                                                            if ($property->bathrooms > 0) {
                                                                $bedBath[] = $property->bathrooms . ' bathroom';
                                                            }
                                                            $specs = $bedBath ? implode(' | ', $bedBath) : trim($property->display_size . ' ' . $property->size_prefix);
                                                        ?>
                                                        <a href="<?php echo e(route('properties.show', $property->id)); ?>" class="ptype-card">
                                                            <div class="ptype-card-media">
                                                                <img src="<?php echo e($img); ?>" alt="<?php echo e($property->title); ?>" loading="lazy">
                                                                <span class="ptype-fav" aria-hidden="true"><i class="icon-heart-1"></i></span>
                                                                <?php if($specs): ?>
                                                                    <span class="ptype-specs"><?php echo e($specs); ?></span>
                                                                <?php endif; ?>
                                                            </div>
                                                            <div class="ptype-card-body">
                                                                <div class="ptype-card-top">
                                                                    <h4><?php echo e(\Illuminate\Support\Str::limit($property->title, 48)); ?></h4>
                                                                    <span class="ptype-price"><?php echo e($property->display_price); ?></span>
                                                                </div>
                                                                <p class="ptype-loc">
                                                                    <i class="icon-location"></i>
                                                                    <span><?php echo e($property->city); ?><?php if($property->full_address): ?>, <?php echo e(\Illuminate\Support\Str::limit($property->full_address, 55)); ?><?php endif; ?></span>
                                                                </p>
                                                            </div>
                                                        </a>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <?php else: ?>
                                                <div class="ptype-empty">
                                                    ...
                                                    <a href="<?php echo e(route('properties.index', ['category' => $category->id])); ?>">Browse properties</a>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="home-white-inset">
            <!-- section-help -->
            <section class="section-help section-help-hscroll" data-help-hscroll>
                <div class="help-h-pin" data-help-pin>
                    <div class="help-h-intro text-center">
                        <span class="help-h-badge">How we help</span>
                        <h2 class="title">Discover how we can help</h2>
                        <p class="text-1">One card at a time — rating, buying, then selling.</p>
                    </div>

                    <div class="help-h-stage" data-help-stage>
                        <div class="help-h-slide is-active" data-help-slide>
                            <article class="help-h-panel">
                                <div class="help-h-media">
                                    <img src="<?php echo e(asset('/images/dream-home/concrete-3882638.jpg')); ?>" alt="Property rating">
                                </div>
                                <div class="help-h-copy">
                                    <span class="help-h-label">Rating</span>
                                    <h3>Understand true value before you decide</h3>
                                    <p>We compare market signals, nearby listings, and property strengths so you price — and purchase — with real context.</p>
                                    <ul class="help-h-points">
                                        <li><span>Focus</span><strong>Market valuation</strong></li>
                                        <li><span>Support</span><strong>Nearby listing compare</strong></li>
                                        <li><span>Outcome</span><strong>Informed decisions</strong></li>
                                    </ul>
                                    <a href="<?php echo e(route('properties.index')); ?>" class="help-h-cta">Explore properties</a>
                                </div>
                            </article>
                        </div>

                        <div class="help-h-slide" data-help-slide>
                            <article class="help-h-panel is-reverse">
                                <div class="help-h-media">
                                    <img src="<?php echo e(asset('/images/dream-home/modern-house.jpg')); ?>" alt="Buying guidance">
                                </div>
                                <div class="help-h-copy">
                                    <span class="help-h-label">Buying</span>
                                    <h3>Find and secure the right home with clarity</h3>
                                    <p>From budget planning to shortlisting, we help you move with confidence — so every step feels guided, not guessed.</p>
                                    <ul class="help-h-points">
                                        <li><span>Focus</span><strong>Budget &amp; affordability</strong></li>
                                        <li><span>Support</span><strong>Monthly cost planning</strong></li>
                                        <li><span>Outcome</span><strong>Confident shortlists</strong></li>
                                    </ul>
                                    <a href="<?php echo e(route('contact')); ?>" class="help-h-cta">Talk to an advisor</a>
                                </div>
                            </article>
                        </div>
                        ...
                        <div class="help-h-slide" data-help-slide>
                            <article class="help-h-panel">
                                <div class="help-h-media">
                                    <img src="<?php echo e(asset('/images/dream-home/coastal-house.jpg')); ?>" alt="Selling support">
                                </div>
                                <div class="help-h-copy">
                                    <span class="help-h-label">Selling</span>
                                    <h3>Sell with strategy, presentation, and speed</h3>
                                    <p>We position your property, market it professionally, and guide negotiations so your sale stays smooth from listing to closing.</p>
                                    <ul class="help-h-points">
                                        <li><span>Focus</span><strong>Smart pricing</strong></li>
                                        <li><span>Support</span><strong>Premium marketing</strong></li>
                                        <li><span>Outcome</span><strong>Faster closing</strong></li>
                                    </ul>
                                    <a href="<?php echo e(route('contact')); ?>" class="help-h-cta">Start selling</a>
                                </div>
                            </article>
                        </div>
                    </div>
                ...
                <div class="tf-container">
                    <p class="help-h-footnote">
                        Looking to spotlight a unique property with expert marketing?
                        <a href="<?php echo e(route('contact')); ?>">Let’s chat</a>
                    </p>
                </div>
            </section><!-- /.section-help -->

            <!-- .section-pre-approved -->
            <section class="section-pre-approved section-loan-modern">
                <div class="tf-container">
                    <div class="loan-shell">
                        <div class="loan-visual">
                            <img src="<?php echo e(asset('/images/section/section-pre-approved.jpg')); ?>" alt="Get pre-approved for a home loan">
                            <div class="loan-visual-overlay">
                                <span class="loan-chip">Financing</span>
                                <p>Clear monthly estimates before you tour or make an offer.</p>
                            </div>
                        </div>

                        <div class="loan-panel">
                            <div class="loan-panel-head">
                                <span class="loan-badge">Home loans</span>
                                <h2>Get pre-approved with confidence</h2>
                                <p>Estimate your monthly payment in minutes — then talk to an advisor for the right next step.</p>
                            </div>

                            <form class="loan-form form-pre-approved" action="#" method="get">
                                <div class="loan-grid">
                                    <label class="loan-field">
                                        <span>Property price</span>
                                        <input type="number" id="amount" name="amount" placeholder="25,000,000" inputmode="numeric">
                                    </label>
                                    <label class="loan-field loan-field-split">
                                        <span>Down payment</span>
                                        <div class="loan-split">
                                            <input type="number" id="payment" name="payment" placeholder="5,000,000" inputmode="numeric">
                                            <input class="input-percent" type="text" value="20%" aria-label="Down payment percent" readonly>
                                        </div>
                                    </label>
                                    <label class="loan-field">
                                        <span>Interest rate (%)</span>
                                        <input type="number" id="interestRate" name="interestRate" placeholder="12" step="0.1" inputmode="decimal">
                                    </label>
                                    <label class="loan-field">
                                        <span>Term (months)</span>
                                        <div class="nice-select" tabindex="0">
                                            <span class="current">240 months</span>
                                            <ul class="list">
                                                <li data-value="60 months" class="option">60 months</li>
                                                <li data-value="120 months" class="option">120 months</li>
                                                <li data-value="180 months" class="option">180 months</li>
                                                <li data-value="240 months" class="option selected">240 months</li>
                                                <li data-value="300 months" class="option">300 months</li>
                                                <li data-value="360 months" class="option">360 months</li>
                                            </ul>
                                        </div>
                                    </label>
                                    <label class="loan-field">
                                        <span>Property tax / year</span>
                                        <input type="number" id="tax" name="tax" placeholder="300,000" inputmode="numeric">
                                    </label>
                                    <label class="loan-field">
                                        <span>Home insurance / year</span>
                                        <input type="number" id="insurance" name="insurance" placeholder="300,000" inputmode="numeric">
                                    </label>
                                </div>

                                <div class="loan-result">
                                    <div>
                                        <span class="loan-result-label">Estimated monthly payment</span>
                                        <strong class="loan-result-value">PKR 8,000</strong>
                                    </div>
                                    <button type="submit" class="loan-btn">Calculate</button>
                                </div>

                                <div class="loan-actions">
                                    <a href="<?php echo e(route('contact')); ?>" class="loan-link">Talk to an advisor</a>
                                    <button type="reset" class="loan-reset">Reset</button>
                                </div>
                            </form>

                            <ul class="loan-notes">
                                <li>No obligation estimate</li>
                                <li>Advisor-backed guidance</li>
            ...
            </div><!-- /.home-white-inset -->

            <!-- section-neighborhoods -->
            <section class="section-neighborhoods section-neighborhoods-modern">
                <div class="tf-container">
                    <div class="nbh-heading text-center">
                        <span class="nbh-badge">Locations</span>
                        <h2>Explore the neighborhoods</h2>
                        <p>Discover homes across Pakistan’s most sought-after cities — curated by Randhawa Marketing.</p>
                    </div>

                    <div class="nbh-grid">
                        <a href="<?php echo e(route('properties.index')); ?>" class="nbh-card">
                            <img src="<?php echo e(asset('/images/section/location-9.jpg')); ?>" alt="Multan">
                            <span class="nbh-shade"></span>
                            <span class="nbh-body">
                                <span class="nbh-city">Multan</span>
                                <span class="nbh-cta">2,491 Properties <i class="icon-arrow-right"></i></span>
                            </span>
                        </a>
                        <a href="<?php echo e(route('properties.index')); ?>" class="nbh-card">
                            <img src="<?php echo e(asset('/images/section/location-10.jpg')); ?>" alt="Islamabad">
                            <span class="nbh-shade"></span>
                            <span class="nbh-body">
                                <span class="nbh-city">Islamabad</span>
                                <span class="nbh-cta">2,491 Properties <i class="icon-arrow-right"></i></span>
                            </span>
                        </a>
                        <a href="<?php echo e(route('properties.index')); ?>" class="nbh-card">
                            <img src="<?php echo e(asset('/images/section/location-11.jpg')); ?>" alt="Lahore">
                            <span class="nbh-shade"></span>
                            <span class="nbh-body">
                                <span class="nbh-city">Lahore</span>
                                <span class="nbh-cta">2,491 Properties <i class="icon-arrow-right"></i></span>
                            </span>
                        </a>
                        <a href="<?php echo e(route('properties.index')); ?>" class="nbh-card nbh-card--wide">
                            <img src="<?php echo e(asset('/images/section/location-13.jpg')); ?>" alt="Karachi">
                            <span class="nbh-shade"></span>
                            <span class="nbh-body">
                                <span class="nbh-city">Karachi</span>
                                <span class="nbh-cta">2,491 Properties <i class="icon-arrow-right"></i></span>
                            </span>
                        </a>
                        <a href="<?php echo e(route('properties.index')); ?>" class="nbh-card nbh-card--wide">
                            <img src="<?php echo e(asset('/images/section/location-14.jpg')); ?>" alt="Rawalpindi">
                            <span class="nbh-shade"></span>
                            <span class="nbh-body">
                                <span class="nbh-city">Rawalpindi</span>
                                <span class="nbh-cta">2,491 Properties <i class="icon-arrow-right"></i></span>
                            </span>
                        </a>
                    </div>
            ...
            <section class="section-listing section-open-houses">
                <div class="tf-container">
                    <div class="oh-top">
                        <div class="oh-heading-block">
                            <span class="oh-kicker">Featured tours</span>
                            <h2 class="oh-heading-title">Open Houses</h2>
                            <p class="oh-heading-sub">Homes worth walking through this week.</p>
                        </div>
                        <a href="<?php echo e(route('properties.index')); ?>" class="oh-explore">
                            Explore listings
                        </a>
                    </div>

                    <div class="oh-grid">
                        <?php $__empty_1 = true; $__currentLoopData = $openHousesProperties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php
                                $img = $property->primary_image
                                    ? asset('/' . ltrim($property->primary_image, '/'))
                                    : asset('/images/section/box-house-list-1.jpg');
                                $statusBit = $property->is_sold
                                    ? 'Sold'
                                    : (($property->property_status ?? '') === 'for_rent' ? 'For rent' : 'For sale');
                                $typeLabel = $property->category->name ?? 'Property';
                                $meta = [];
                                if ($property->bedrooms > 0) {
                                    $meta[] = $property->bedrooms . ' beds';
                                }
                                if ($property->bathrooms > 0) {
                                    $meta[] = $property->bathrooms . ' baths';
                                }
                                $sizeBit = trim($property->display_size . ' ' . $property->size_prefix);
                                if ($sizeBit !== '') {
                                    $meta[] = $sizeBit;
                                }
                            ?>
                            <a href="<?php echo e(route('properties.show', $property->id)); ?>" class="oh-card">
                                <img class="oh-card-img" src="<?php echo e($img); ?>" alt="<?php echo e($property->title); ?>" loading="lazy">
                                <span class="oh-card-shade" aria-hidden="true"></span>
                                <div class="oh-card-content">
                                    <div class="oh-card-head">
                                        <span class="oh-status"><?php echo e($statusBit); ?></span>
                                        <span class="oh-type"><?php echo e($typeLabel); ?></span>
                                    </div>
                                    <strong class="oh-price"><?php echo e($property->display_price); ?></strong>
                                    <?php if(count($meta)): ?>
                                        <p class="oh-meta"><?php echo e(implode('  ·  ', $meta)); ?></p>
                                    <?php endif; ?>
                                    <p class="oh-address"><?php echo e($property->full_address ?: $property->city); ?></p>
                                </div>
                                <span class="oh-arrow" aria-hidden="true">
            ...
            <section class="section-work-together section-partners-theme">
                <div class="wg-partner  tf-spacing-1">
                    <div class="tf-container">
                        <div class="row">
                            <div class="col-12">
                                <div class="partners-theme-heading text-center">
                                    <span class="partners-theme-kicker">Trusted network</span>
                                    <h2 class="partners-theme-title">Let’s work together</h2>
                                    <p class="partners-theme-sub">Partners and brands we collaborate with to move deals forward — smoother, clearer, faster.</p>
                                </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="partner-item style-2 ">
                                                <svg width="126" height="82" viewBox="0 0 126 82" fill="none"
                                                    ...
                                                    <g clip-path="asset(#clip0_2304_5655)">
                                                        <path
                                        ...
                                        <div class="swiper-slide">
                                            <div class="partner-item style-2">
                                                <svg width="130" height="49" viewBox="0 0 130 49" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <g clip-path="asset(#clip0_2304_5712)">
                                                        <path
                                        ...
                                        <div class="swiper-slide">
                                            <div class="partner-item style-2">
                                                <svg width="148" height="38" viewBox="0 0 148 38" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <g clip-path="asset(#clip0_2304_5750)">
                                                        <path
                                        ...
                                        <div class="swiper-slide">
                                            <div class="partner-item style-2">
                                                ...
                                                <svg width="126" height="75" viewBox="0 0 126 75" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <g clip-path="asset(#clip0_2304_5782)">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="partner-item style-2">
                                                <svg width="153" height="30" viewBox="0 0 153 30" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <g clip-path="asset(#clip0_2304_5818)">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="partner-item style-2">
                                                <svg width="86" height="82" viewBox="0 0 86 82" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <g clip-path="asset(#clip0_2304_5853)">
                                                        <path
                ...
                <div class="wg-appraisal ">
                    <div class="tf-container">
                        <div class="row">
                            <div class="col-12">
                                <div class="content">
                                    <div class="partners-appraisal-copy">
                                        <span class="partners-theme-kicker is-dark">Free valuation</span>
                                        <h2 class="partners-appraisal-title">Selling or renting your property?</h2>
                                        <p class="partners-appraisal-sub">Get a clear market readout from Randhawa Marketing — pricing, demand, and next steps without the guesswork.</p>
                                    </div>
                                    <a href="<?php echo e(route('contact')); ?>" class="partners-appraisal-cta">
                                        Request your free appraisal
                                    </a>
                                    <div class="person wow animate__fadeInRight animate__animated"
                                        data-wow-duration="2s">
                                        <img src="<?php echo e(asset('/images/section/person-1.png')); ?>" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <!-- section-opinion -->
            <section class="section-opinion section-insight-modern">
                <div class="tf-container">
                    <div class="insight-top">
                        <div class="insight-heading-block">
                            <span class="insight-kicker">From the desk</span>
                            <h2 class="insight-heading-title">Insight &amp; Opinion</h2>
                            <p class="insight-heading-sub">Market notes, buying guidance, and local perspective — written for people who take homes seriously.</p>
                        </div>
                        <a href="<?php echo e(route('blog.index')); ?>" class="insight-view-all">View all stories</a>
                    </div>

                    <div class="insight-layout">
                        <article class="insight-feature">
                            <a href="<?php echo e(route('blog.index')); ?>" class="insight-feature-media">
                                <img src="<?php echo e(asset('/images/blog/blog-grid-1.jpg')); ?>" alt="Building gains into housing stocks">
                            </a>
                            <div class="insight-feature-copy">
                                <div class="insight-meta">
                                    <span>Real estate</span>
                                    <span aria-hidden="true">·</span>
                                    <time datetime="2024-08-26">26 Aug 2024</time>
                                </div>
                                <h3>
                                    <a href="<?php echo e(route('blog.index')); ?>">Building gains into housing stocks and how to trade the cycle with clarity</a>
                                </h3>
                                <p>A practical look at timing, risk, and what local demand signals actually mean before you commit capital.</p>
                                <a href="<?php echo e(route('blog.index')); ?>" class="insight-link">Continue reading</a>
                            </div>
                        </article>

                        <div class="insight-stack">
                            <article class="insight-item">
                                <a href="<?php echo e(route('blog.index')); ?>" class="insight-item-media">
                                    <img src="<?php echo e(asset('/images/blog/blog-grid-2.jpg')); ?>" alt="Market news briefing">
                                </a>
                                <div class="insight-item-copy">
                                    ...
                                    <h3>
                                        <a href="<?php echo e(route('blog.index')); ?>">What this week’s listings reveal about buyer confidence</a>
                                    </h3>
                                    <a href="<?php echo e(route('blog.index')); ?>" class="insight-link">Continue reading</a>
                                </div>
                            </article>
                            ...
                            <article class="insight-item">
                                <a href="<?php echo e(route('blog.index')); ?>" class="insight-item-media">
                                    <img src="<?php echo e(asset('/images/blog/blog-grid-3.jpg')); ?>" alt="Homeowner guidance">
                                </a>
                                <div class="insight-item-copy">
                                    <div class="insight-meta">
                                        <span>Guidance</span>
                                    ...
                                    <h3>
                                        <a href="<?php echo e(route('blog.index')); ?>">How to prepare a home for stronger offers without overspending</a>
                                    </h3>
                                    <a href="<?php echo e(route('blog.index')); ?>" class="insight-link">Continue reading</a>
                                </div>
                            </article>
            ...
            <section class="section-testimonials section-testimonials-marquee">
                <div class="tf-container">
                    <div class="tm-heading text-center">
                        <span class="tm-kicker">Testimonials</span>
                        <h2 class="tm-title">Trusted by clients across Pakistan</h2>
                        <p class="tm-sub">See what our clients say about working with Randhawa Marketing.</p>
                    </div>

                    <div class="tm-marquee" aria-hidden="false">
                        <div class="tm-col is-slow">
                            <div class="tm-col-track">
                                    <article class="tm-card">
                                        <p class="tm-quote">Randhawa Marketing helped us close on our home in Islamabad with clear guidance at every step. The process felt calm and professional.</p>
                                        <div class="tm-author">
                                            <img src="<?php echo e(asset('/images/avatar/testimonials-4.jpg')); ?>" alt="Annette Black">
                                            <div>
                                                <strong>Annette Black</strong>
                                                <span>Homebuyer, Islamabad</span>
                                            </div>
                                        </div>
                                    </article>
                                    <article class="tm-card">
                                        <p class="tm-quote">Their market readout was honest and useful. We adjusted pricing once and had serious offers within two weeks.</p>
                                        <div class="tm-author">
                                            <img src="<?php echo e(asset('/images/avatar/avt-png7.png')); ?>" alt="Eleanor Pena">
                                            <div>
                                    ...
                                    <article class="tm-card">
                                        <p class="tm-quote">From viewing to negotiation, the team stayed responsive. We always knew what was happening next.</p>
                                        <div class="tm-author">
                                            <img src="<?php echo e(asset('/images/avatar/avt-png5.png')); ?>" alt="Cody Fisher">
                                            <div>
                                    ...
                                    <article class="tm-card">
                                        <p class="tm-quote">Clear communication and strong local knowledge. Exactly what we needed for an out-of-city purchase.</p>
                                        <div class="tm-author">
                                            <img src="<?php echo e(asset('/images/avatar/avt-png6.png')); ?>" alt="Theresa Webb">
                                            <div>
                        ...
                        <div class="tm-col is-mid">
                            <div class="tm-col-track">
                                    <article class="tm-card">
                                        <p class="tm-quote">We listed with them after two quiet months elsewhere. Presentation and outreach were on another level.</p>
                                        <div class="tm-author">
                                            <img src="<?php echo e(asset('/images/avatar/avt-png8.png')); ?>" alt="Jerome Bell">
                                            <div>
                                                <strong>Jerome Bell</strong>
                                                <span>Seller, Karachi</span>
                                            </div>
                                        </div>
                                    </article>
                                    <article class="tm-card">
                                        <p class="tm-quote">Professional, patient, and detail-oriented. They treated our sale like it mattered — because it did.</p>
                                        <div class="tm-author">
                                            <img src="<?php echo e(asset('/images/avatar/avt-png9.png')); ?>" alt="Kristin Watson">
                                            <div>
                                    ...
                                    <article class="tm-card">
                                        <p class="tm-quote">The valuation was realistic, not inflated. That honesty helped us move faster with the right buyers.</p>
                                        <div class="tm-author">
                                            <img src="<?php echo e(asset('/images/avatar/avt-png4.png')); ?>" alt="Devon Lane">
                                            <div>
                                    ...
                                    <article class="tm-card">
                                        <p class="tm-quote">Great support for both buying and renting decisions. Straightforward advice without pressure.</p>
                                        <div class="tm-author">
                                            <img src="<?php echo e(asset('/images/avatar/avt-png10.png')); ?>" alt="Cameron Williamson">
                                            <div>
                        ...
                        <div class="tm-col is-fast">
                            <div class="tm-col-track">
                                    <article class="tm-card">
                                        <p class="tm-quote">A premium experience without the fluff. Clean listings, strong follow-ups, and solid negotiation.</p>
                                        <div class="tm-author">
                                            <img src="<?php echo e(asset('/images/avatar/avt-png11.png')); ?>" alt="Leslie Alexander">
                                            <div>
                                    ...
                                    <article class="tm-card">
                                        <p class="tm-quote">They understood what we wanted better than we could explain it. Found the right fit quickly.</p>
                                        <div class="tm-author">
                                            <img src="<?php echo e(asset('/images/avatar/avt-png12.png')); ?>" alt="Jane Cooper">
                                            <div>
                                    ...
                                    <article class="tm-card">
                                        <p class="tm-quote">Reliable updates and thoughtful recommendations. We felt looked after from day one.</p>
                                        <div class="tm-author">
                                            <img src="<?php echo e(asset('/images/avatar/avt-png13.png')); ?>" alt="Robert Fox">
                                            <div>
                                                <strong>Robert Fox</strong>
                                                <span>NRI investor</span>
                                            </div>
                                        </div>
                                    </article>
                                    <article class="tm-card">
                                        <p class="tm-quote">One of the smoother property journeys we’ve had. Clear process, strong local network.</p>
                                        <div class="tm-author">
                                            <img src="<?php echo e(asset('/images/avatar/avt-png14.png')); ?>" alt="Brooklyn Simmons">
                                            <div>
                                                <strong>Brooklyn Simmons</strong>
                                                <span>Couple buying</span>
                                            </div>
                                        </div>
                                    </article>
                                    <article class="tm-card">
            ...
            <div class="modal-content">
                <div class="flat-account">
                    <div class="banner-account">
                        <img src="<?php echo e(asset('/images/section/banner-login.jpg')); ?>" alt="banner">
                    </div>
                        ...
                        <div class="group-btn">
                            <a href="#" class="btn-social">
                                <svg width="21" height="20" viewBox="0 0 21 20" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="asset(#clip0_2478_11334)">
                                        <path
    ...
    <div class="modal modal-account fade" id="modalRegister">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="flat-account">
                    <div class="banner-account">
                        <img src="<?php echo e(asset('/images/section/banner-register.jpg')); ?>" alt="banner">
                    </div>
                    <form class="form-account">
                        <div class="title-box">
                            <h4>Register</h4>
                        ...
                        <div class="group-btn">
                            <a href="#" class="btn-social">
                                <svg width="21" height="20" viewBox="0 0 21 20" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="asset(#clip0_2478_12036)">
                                        <path
                                            d="M4.93242 12.0863L4.23625 14.6852L1.69176 14.739C0.931328 13.3286 0.5 11.7149 0.5 10C0.5 8.34179 0.903281 6.77804 1.61812 5.40112H1.61867L3.88398 5.81644L4.87633 8.06815C4.66863 8.67366 4.55543 9.32366 4.55543 10C4.55551 10.7341 4.68848 11.4374 4.93242 12.0863Z"
                                            fill="#FBBB00" />
                                        <path
                            ...
                            <a href="#" class="btn-social">
                                <svg width="21" height="20" viewBox="0 0 21 20" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="asset(#clip0_2478_12044)">
                                        <path
                                            d="M20.5 10C20.5 14.9914 16.843 19.1285 12.0625 19.8785V12.8906H14.3926L14.8359 10H12.0625V8.12422C12.0625 7.3332 12.45 6.5625 13.6922 6.5625H14.9531V4.10156C14.9531 4.10156 13.8086 3.90625 12.7145 3.90625C10.4305 3.90625 8.9375 5.29063 8.9375 7.79688V10H6.39844V12.8906H8.9375V19.8785C4.15703 19.1285 0.5 14.9914 0.5 10C0.5 4.47734 4.97734 0 10.5 0C16.0227 0 20.5 4.47734 20.5 10Z"
                                            fill="#1877F2" />
                                        <path
    ...
    <div class="offcanvas offcanvas-start mobile-nav-wrap " tabindex="-1" id="menu-mobile"
        ...
        <div class="offcanvas-header top-nav-mobile">
            <div class="offcanvas-title">
                <a href="index"><img src="<?php echo e(asset('/images/logo/logo%402x.png')); ?>" alt=""></a>
            </div>
                ...
                <ul id="menu-mobile-menu">
                    <li class="menu-item menu-item-has-children-mobile current-menu-item">
                        ...
                        <div id="dropdown-menu-one" class="collapse" data-bs-parent="#menu-mobile-menu">
                            <ul class="sub-mobile ">
                                <li class="menu-item current-item"><a href="index">Home Page 01</a></li>
    ...
    <script type="text/javascript" src="<?php echo e(asset('/js/lazysize.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('/js/rangle-slider.js')); ?>"></script>
    ...
    <script type="text/javascript" src="<?php echo e(asset('/js/swiper.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('/js/simpleParallaxVanilla.umd.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('/js/wow.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('/js/Splitetext.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('/js/gsap.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('/js/ScrollTrigger.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('/js/main.js')); ?>"></script>
    <script>
        (function () {
            var statusInput = document.getElementById('search-status');
            var tabs = document.querySelectorAll('.hero-tab');
            if (statusInput && tabs.length) {
                tabs.forEach(function (tab) {
                    tab.addEventListener('click', function () {
                        tabs.forEach(function (t) { t.classList.remove('is-active'); });
                        tab.classList.add('is-active');
                        statusInput.value = tab.getAttribute('data-status');
                    });
                });
            }

            var header = document.getElementById('header-main');
            if (header && document.body.classList.contains('home-hero-redesign')) {
                var syncing = false;
            ...
            /* Property type browse — fast crossfade, no blur */
            var ptypeList = document.querySelector('[data-ptype-list]');
            if (ptypeList) {
                var ptypeBars = Array.prototype.slice.call(ptypeList.querySelectorAll('[data-ptype-bar]'));
                var ptypeStage = ptypeList.querySelector('[data-ptype-stage]');
                var ptypePanels = Array.prototype.slice.call(ptypeList.querySelectorAll('[data-ptype-panel]'));
                var ptypeDefault = ptypeBars[0] || null;
                var ptypeActiveId = null;
                var ptypeTimer = null;
                var ptypeHeightTimer = null;
                var ptypeFine = window.matchMedia('(hover: hover) and (pointer: fine)');

                var ptypePanelById = function (id) {
                    return ptypePanels.find(function (panel) {
                        return panel.getAttribute('data-ptype-panel') === id;
                    }) || null;
                };

                var setPtypeStageHeight = function (panel, animate) {
                    if (!ptypeStage || !panel) return;
                    var styles = window.getComputedStyle(ptypeStage);
                    var pad = (parseFloat(styles.paddingTop) || 0) + (parseFloat(styles.paddingBottom) || 0);
                    var nextH = Math.ceil(panel.scrollHeight + pad);
                    if (!animate) {
                        ptypeStage.style.transition = 'none';
                        ptypeStage.style.height = nextH + 'px';
                        void ptypeStage.offsetHeight;
                        ptypeStage.style.transition = '';
                        ptypeStage.style.height = 'auto';
                        return;
                    }
                    var currentH = ptypeStage.offsetHeight;
                    ptypeStage.style.height = currentH + 'px';
                    requestAnimationFrame(function () {
                        ptypeStage.style.height = nextH + 'px';
                    });
                    clearTimeout(ptypeHeightTimer);
                    ptypeHeightTimer = setTimeout(function () {
                        if (ptypeStage) ptypeStage.style.height = 'auto';
                    }, 300);
                };

                var activatePtype = function (bar, instant) {
                    if (!bar || !ptypeStage) return;
                    var id = bar.getAttribute('data-ptype-id');
                    if (!id || id === ptypeActiveId) {
                        if (id === ptypeActiveId && bar.nextElementSibling !== ptypeStage) {
                            bar.after(ptypeStage);
                        }
                        return;
                    }

                    var nextPanel = ptypePanelById(id);
                    if (!nextPanel) return;

                    ptypeActiveId = id;
                    ptypeBars.forEach(function (b) {
                        b.classList.toggle('is-active', b === bar);
                    });

                    if (!instant) {
                        ptypeStage.style.height = ptypeStage.offsetHeight + 'px';
                    }

                    ptypePanels.forEach(function (panel) {
                        panel.classList.toggle('is-active', panel === nextPanel);
                    });

                    bar.after(ptypeStage);
                    setPtypeStageHeight(nextPanel, !instant);
                };

                if (ptypeDefault) {
                    activatePtype(ptypeDefault, true);
                }

                window.addEventListener('resize', function () {
                    var active = ptypePanelById(ptypeActiveId);
                    if (active) setPtypeStageHeight(active, false);
                });

                ptypeBars.forEach(function (bar) {
                    bar.addEventListener('mouseenter', function () {
                        if (!ptypeFine.matches) return;
                        clearTimeout(ptypeTimer);
                        ptypeTimer = setTimeout(function () {
                            activatePtype(bar, false);
                        }, 40);
                    });

                    bar.addEventListener('click', function (e) {
                        if (e.target.closest('.ptype-more')) return;
                        if (ptypeFine.matches) return;
                        e.preventDefault();
                        activatePtype(bar, false);
                    });
                ...
                ptypeList.addEventListener('mouseleave', function () {
                    clearTimeout(ptypeTimer);
                });
            }

            /* Dream home gallery */
            var gallery = document.querySelector('[data-dream-gallery]');
            if (gallery) {
                var track = gallery.querySelector('[data-dream-track]');
                var slides = Array.prototype.slice.call(gallery.querySelectorAll('.dream-home-slide'));
                var prevBtn = document.querySelector('[data-dream-prev]');
                var nextBtn = document.querySelector('[data-dream-next]');
                var index = 0;
                ...
                var goTo = function (nextIndex) {
                    ...
                    for (var i = 0; i < index; i++) {
                        offset += slides[i].offsetWidth + 18;
                    }
            ...
            /* Help — next card covers previous from the right only */
            var helpSection = document.querySelector('[data-help-hscroll]');
            var helpPin = helpSection && helpSection.querySelector('[data-help-pin]');
            var helpSlides = helpSection
                ? Array.prototype.slice.call(helpSection.querySelectorAll('[data-help-slide]'))
                : [];

            if (helpSection && helpPin && helpSlides.length && window.gsap && window.ScrollTrigger) {
                gsap.registerPlugin(ScrollTrigger);

                var mm = gsap.matchMedia();
                mm.add('(min-width: 992px)', function () {
                    gsap.set(helpSlides[0], { xPercent: 0, scale: 1, zIndex: 1 });
                    helpSlides.slice(1).forEach(function (slide, i) {
                        gsap.set(slide, {
                            xPercent: 100,
                            scale: 1,
                            zIndex: i + 2
                    ...
                    var tl = gsap.timeline({
                        ...
                        scrollTrigger: {
                            ...
                            start: 'top top',
                                ...
                                return '+=' + (steps * window.innerHeight * 1.1);
                            },
                            pin: true,
                            scrub: 0.8,
                            snap: {
                    ...
                    helpSlides.forEach(function (slide, i) {
                        if (i === 0) return;
                        var prev = helpSlides[i - 1];
                        var at = i - 1;
                    ...
                    return function () {
                        ...
                        tl.kill();
                        gsap.set(helpSlides, { clearProps: 'all' });
                    };
                });
            }
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const statusDropdown = document.querySelector('.tf-dropdown-sort');
            const statusInput = document.getElementById('search-status');
            const statusText = document.querySelector('.text-sort-value');
            
            if (statusDropdown) {
                statusDropdown.addEventListener('click', function(e) {
                    if (e.target.closest('.select-item')) {
                        const selectedItem = e.target.closest('.select-item');
                        const value = selectedItem.getAttribute('data-value');
                        const text = selectedItem.querySelector('.text-value-item').textContent;
                        ...
                        // Update active state
                        document.querySelectorAll('.select-item').forEach(item => item.classList.remove('active'));
            ...
            if (searchForm) {
                searchForm.addEventListener('submit', function(e) {
                    ...
                    // Build asset with parameters
                    const formData = new FormData(searchForm);
                    const params = new assetSearchParams();
                    ...
                    const propertiesasset = '<?php echo e(route("properties.index")); ?>';
                    const searchasset = params.toString() ? `${propertiesasset}?${params.toString()}` : propertiesasset;
                    window.location.href = searchasset;
                });
            }
        });
    </script>
...
<!-- Mirrored from themesflat.co/html/proty/index by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 18:13:12 GMT -->
</html>
<?php /**PATH C:\Users\AR\Desktop\RM_MainSite\resources\views/index.blade.php ENDPATH**/ ?>