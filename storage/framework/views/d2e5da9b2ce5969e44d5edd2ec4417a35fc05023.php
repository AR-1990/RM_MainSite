<div class="main-sidebar sidebar-style-2">
  <aside id="sidebar-wrapper">
    <div class="sidebar-brand">
      <a href="<?php echo e(route('admin.index')); ?>"> <img alt="image" src="<?php echo e(url('assets-admin/img/logo.png')); ?>" class="header-logo" /> <span
    ...
    <ul class="sidebar-menu">
      ...
      <li class="dropdown active">
        <a href="<?php echo e(route('admin.index')); ?>" class="nav-link"><i data-feather="monitor"></i><span>Dashboard</span></a>
      </li>
      <li class="dropdown">
        <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="layout"></i><span>Property</span></a>
        <ul class="dropdown-menu">
          <li><a class="nav-link" href="<?php echo e(route('admin.property.add')); ?>">Add Property</a></li>
          <li><a class="nav-link" href="<?php echo e(route('admin.property.table')); ?>">Property Table</a></li>
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a class="nav-link" href="<?php echo e(route('admin.blogs.index')); ?>">All Blogs</a></li>
          <li><a class="nav-link" href="<?php echo e(route('admin.blogs.create')); ?>">Create Blog</a></li>
          <li><a class="nav-link" href="<?php echo e(route('admin.blog-categories.index')); ?>">Blog Categories</a></li>
          <li><a class="nav-link" href="<?php echo e(route('admin.blog-categories.create')); ?>">Add Category</a></li>
        </ul>
      </li>
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a class="nav-link" href="<?php echo e(route('admin.leads.index')); ?>">All Leads</a></li>
          <li><a class="nav-link" href="<?php echo e(route('admin.leads.create')); ?>">Create Lead</a></li>
          <li><a class="nav-link" href="<?php echo e(route('admin.contacts.index')); ?>">Contact Inquiries</a></li>
        </ul>
      </li>
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="<?php echo e(route('admin.subscriptions.index')); ?>">All Subscriptions</a></li>
                <li><a class="nav-link" href="<?php echo e(route('admin.subscriptions.create')); ?>">Add Subscription</a></li>
              </ul>
            </li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="<?php echo e(route('admin.news.index')); ?>">All News</a></li>
                <li><a class="nav-link" href="<?php echo e(route('admin.news.create')); ?>">Add News</a></li>
              </ul>
            </li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="<?php echo e(route('admin.projects.index')); ?>">All Projects</a></li>
                <li><a class="nav-link" href="<?php echo e(route('admin.projects.create')); ?>">Add Project</a></li>
                <li><a class="nav-link" href="<?php echo e(route('admin.project-categories.index')); ?>">Project Categories</a></li>
                <li><a class="nav-link" href="<?php echo e(route('admin.project-categories.create')); ?>">Add Project Category</a></li>
              </ul>
            </li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="<?php echo e(route('admin.team.index')); ?>">All Team Members</a></li>
                <li><a class="nav-link" href="<?php echo e(route('admin.team.create')); ?>">Add Team Member</a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="<?php echo e(route('admin.users.index')); ?>">All Users</a></li>
                <li><a class="nav-link" href="<?php echo e(route('admin.users.create')); ?>">Add User</a></li>
                <li><a class="nav-link" href="<?php echo e(route('admin.users.export')); ?>">Export Users</a></li>
              </ul>
            </li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="<?php echo e(route('admin.attendance.index')); ?>">All Records</a></li>
                <li><a class="nav-link" href="<?php echo e(route('admin.attendance.create')); ?>">Add Record</a></li>
                <li><a class="nav-link" href="<?php echo e(route('admin.attendance.enhanced-stats')); ?>">Employee Statistics</a></li>
              </ul>
            </li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="<?php echo e(route('admin.workload.index')); ?>">All Tasks</a></li>
                <li><a class="nav-link" href="<?php echo e(route('admin.workload.create')); ?>">Create Task</a></li>
                <li><a class="nav-link" href="<?php echo e(route('admin.workload.audit-logs')); ?>">Audit Logs</a></li>
              </ul>
            </li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="<?php echo e(route('admin.accounts.dashboard')); ?>">Overview</a></li>
                <li><a class="nav-link" href="<?php echo e(route('admin.accounts.salaries.index')); ?>">Salaries</a></li>
                <li><a class="nav-link" href="<?php echo e(route('admin.accounts.advances.index')); ?>">Salary Advances</a></li>
                <li><a class="nav-link" href="<?php echo e(route('admin.accounts.advances.index')); ?>">Loans</a></li>
                <li><a class="nav-link" href="<?php echo e(route('admin.accounts.expenses.index')); ?>">Expenses</a></li>
                <li><a class="nav-link" href="<?php echo e(route('admin.accounts.categories.index')); ?>">Expense Categories</a></li>
              </ul>
            </li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="archive"></i><span>Reports &amp; Backups</span></a>
              <ul class="dropdown-menu">
                   <li><a class="nav-link" href="<?php echo e(route('admin.backups.index')); ?>">File Backups</a></li>
                 </ul>
            </li>
      <!-- // ... existing code ...
      <li class="dropdown">
...
<?php /**PATH C:\Users\AR\Desktop\rm\resources\views/admin/layout/sidebar.blade.php ENDPATH**/ ?>