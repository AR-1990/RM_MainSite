...
<head>
    ...
    <title>About Us - Randhawa Marketing</title>
...
<body>
            ...
            <div id="loading-center">
                <div class="loader-container">
                    <div class="wrap-loader">
                        ...
                        <div class="icon">
                            <img src="<?php echo e(url('images/logo/loading.png')); ?>" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="main-content tf-spacing-6 header-fixed">
                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-7 mx-auto">
                            <div class="heading-section text-center mb-48">
                                <h2 class="title">About Randhawa Marketing</h2>
                            </div>
                            
                            <!-- Our Profile -->
                            <div class="about-card mb-49">
                                <div class="icon-box mb-3">
                                    <i class="fas fa-building fa-2x text-primary"></i>
                                </div>
                                <h3 class="fw-8 title mb-24">Our Profile</h3>
                                <p class="about-body">
                                    Randhawa Marketing is a trusted and reputable real estate company specializing in residential and commercial properties. We provide end-to-end services including buying, selling, renting, property management, and legal documentation support. Randhawa Marketing mission is to simplify real estate transactions, deliver value, and build lasting relationships with our clients. We focus on integrity, professionalism, and client satisfaction in every interaction. We guide clients at every step from property selection and market advice to documentation and finalization ensuring a seamless experience.
                                </p>
                            </div>
                            ...
                            <div class="about-card mb-49">
                                ...
                                <h3 class="fw-8 title mb-24">Property Portfolio</h3>
                                <p class="about-body">
                                    Randhawa Marketing offers a diverse portfolio of residential and commercial properties across Pakistan, including prime locations in Islamabad, Lahore, Multan, Karachi, Faisalabad you can say that all over in Pakistan. Our portfolio includes houses, apartments, villas, offices, shops, plazas, hotels, warehouses, and investment properties to meet a variety of client needs. Each property is carefully vetted to ensure quality, legal compliance, and market value. We help clients explore options, compare properties, and select the best opportunities that match their goals. With Randhawa Marketing you have access to a wide range of properties backed by expert guidance and reliable support.
                                </p>
                            </div>
                            ...
                            <div class="about-card mb-49">
                                ...
                                <h3 class="fw-8 title mb-24">Our Services</h3>
                                <p class="about-body">
                                    Randhawa Marketing provides complete real estate solutions to make buying, selling, renting, and managing properties simple and hassle-free. We guide clients at every step, from selecting the right property and offering market insights to handling legal documentation and ensuring smooth transactions. Our team manages marketing, negotiations, lease agreements, and property oversight with professionalism. We also provide expert advice on pricing, investments, and local market trends, helping clients make well-informed decisions. With Randhawa Marketing, every property transaction is transparent, efficient, and customized to meet your unique needs.
                                </p>
                            </div>
                            ...
                            <div class="about-card mb-49">
                                ...
                                <h3 class="fw-8 title mb-24">Mutual Respect</h3>
                                <p class="about-body">
                                    At Randhawa Marketing, we believe strong relationships are built on mutual respect. We value our clients’ time, opinions, and decisions, and in return, we expect honesty, trust, and open communication. This respect ensures smooth transactions, clear expectations, and a positive experience for both clients and our team. By fostering a relationship based on professionalism and understanding, we create lasting partnerships and successful real estate outcomes.
                                </p>
                            </div>
                            ...
                            <div class="about-card mb-49">
                                ...
                                <h3 class="fw-8 title mb-24">Investment Advisory</h3>
                                <p class="about-body">
                                    Randhawa Marketing helps clients make smart real estate investments with confidence. We analyze market trends, property values, and local developments to identify opportunities that match your goals. Our team provides personalized advice to maximize returns, minimize risks, and ensure your investments grow securely over time. We also guide clients on portfolio diversification, long-term planning, and high-demand property sectors. With our insights, you can make informed decisions and achieve sustainable growth in the real estate market.
                                </p>
                            </div>
            ...
            <style>
                ...
                .icon-box {
                    width: 60px;
                    height: 60px;
                    background: rgba(255, 102, 0, 0.1); /* Primary color light */
                    border-radius: 50%;
                    display: flex;
                    align-items: center;
                ...
                .text-primary {
                    color: #ff6600 !important; /* Adjust to match theme primary */
                }
            </style>
            <!-- section-faq -->
                ...
                <div class="tf-container">
                    <div class="row ">
                        <div class="col-12 ">
                            <div class="relative">
                                <div class="logo">
                                    <img src="<?php echo e(url('images/logo/logo-2@2x.png')); ?>" alt="">
                                </div>
                                <div class="image-wrap">
                                    <img class="lazyload" data-src="<?php echo e(url('images/section/section-contact.jpg')); ?>"
                                        src="<?php echo e(url('images/section/section-contact.jpg')); ?>" alt="">
                                </div>
                    ...
                    <div class="col-12">
                        <div class="footer-top">
                            <div class="footer-logo">
                                <a href="index">
                                    <img id="logo_footer" src="<?php echo e(url('images/logo/logo-2@2x.png')); ?>" alt="logo-footer">
                                </a>
                            </div>
            ...
            <div class="modal-content">
                <div class="flat-account">
                    <div class="banner-account">
                        <img src="<?php echo e(url('images/section/banner-login.jpg')); ?>" alt="banner">
                    </div>
    ...
    <div class="modal modal-account fade" id="modalRegister">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="flat-account">
                    <div class="banner-account">
                        <img src="<?php echo e(url('images/section/banner-register.jpg')); ?>" alt="banner">
                    </div>
                    <form class="form-account">
                        <div class="title-box">
                            <h4>Register</h4>
    ...
    <div class="offcanvas offcanvas-start mobile-nav-wrap " tabindex="-1" id="menu-mobile"
        ...
        <div class="offcanvas-header top-nav-mobile">
            <div class="offcanvas-title">
                <a href="index"><img src="<?php echo e(url('images/logo/logo@2x.png')); ?>" alt=""></a>
            </div>
                                ...
                                <li class="menu-item menu-item-has-children-mobile-2">
                                    ...
                                    <div id="sub-feaure" class="collapse" data-bs-parent="#dropdown-menu-two">
                                        <ul class="sub-mobile">
                                            ...
                                            <li class="menu-item ">
                                                <a href="property-filter-popup-left" class="item-menu-mobile ">Property
                                                    Filter Popup Left</a>
                                            </li>
                                            <li class="menu-item ">
    ...
    <script type="text/javascript" src="<?php echo e(url('js/lazysize.min.js')); ?>"></script>
...
</html><?php /**PATH C:\Users\AR\Desktop\RM_MainSite\resources\views/about.blade.php ENDPATH**/ ?>