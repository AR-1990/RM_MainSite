...
<link rel="stylesheet" href="<?php echo e(url('assets-admin/bundles/datatables/DataTables-1.10.16/css/dataTables.bootstrap4.min.css')); ?>">
<style>
.card-statistic-1 {
...
<!-- DEBUG: Page loaded at <?php echo e(now()); ?> -->
    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="<?php echo e(route('admin.index')); ?>">Dashboard</a></div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        ...
                        <div class="card-body">
                            <?php echo e($stats['high_priority']); ?>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a href="<?php echo e(route('admin.leads.create')); ?>" class="btn btn-primary">
                            ...
                            <div class="dropdown d-inline">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="<?php echo e(route('admin.leads.export')); ?>">Export All</a>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.leads.export')); ?>?status=open">Export Open</a>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.leads.export')); ?>?status=in_progress">Export In Progress</a>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.leads.export')); ?>?status=closed">Export Closed</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <form id="bulkActionForm" method="POST" action="<?php echo e(route('admin.leads.bulk-action')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <div class="form-inline">
...
if (typeof $ !== 'undefined' && typeof $.fn.DataTable !== 'undefined' && document.getElementById('leadsTable')) {
    if ($.fn.DataTable.isDataTable('#leadsTable')) {
        ...
        destroy: true,
        ajax: {
            url: "<?php echo e(route('admin.leads.index')); ?>",
            type: "GET",
            data: function(d) {
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\AR\Desktop\rm\resources\views/admin/leads/index.blade.php ENDPATH**/ ?>